...
import com.konfigthis.client.model.UsersGetUserResourceResponse;
...
public class UsersApiGenerated {
    ...
    private okhttp3.Call getUserResourceCall(String userId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v0/users/{user-id}"
    ...
    private okhttp3.Call getUserResourceValidateBeforeCall(String userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling getUserResource(Async)");
        }

        return getUserResourceCall(userId, _callback);

    }


    private ApiResponse<UsersGetUserResourceResponse> getUserResourceWithHttpInfo(String userId) throws ApiException {
        okhttp3.Call localVarCall = getUserResourceValidateBeforeCall(userId, null);
        Type localVarReturnType = new TypeToken<UsersGetUserResourceResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getUserResourceAsync(String userId, final ApiCallback<UsersGetUserResourceResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserResourceValidateBeforeCall(userId, _callback);
        Type localVarReturnType = new TypeToken<UsersGetUserResourceResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetUserResourceRequestBuilder {
        private final String userId;

        private GetUserResourceRequestBuilder(String userId) {
            this.userId = userId;
        }

        /**
         * Build call for getUserResource
        ...
        /**
         * Execute getUserResource request
         * @return UsersGetUserResourceResponse
         ...
         */
        public UsersGetUserResourceResponse execute() throws ApiException {
            ApiResponse<UsersGetUserResourceResponse> localVarResp = getUserResourceWithHttpInfo(userId);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getUserResource request with HTTP info returned
         * @return ApiResponse&lt;UsersGetUserResourceResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<UsersGetUserResourceResponse> executeWithHttpInfo() throws ApiException {
            return getUserResourceWithHttpInfo(userId);
        }

        /**
         * Execute getUserResource request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<UsersGetUserResourceResponse> _callback) throws ApiException {
            return getUserResourceAsync(userId, _callback);
        }
    }
     ...
     * @return GetUserResourceRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td>  </td><td>  -  </td></tr>
     ...
     */
    public GetUserResourceRequestBuilder getUserResource(String userId) throws IllegalArgumentException {
        if (userId == null) throw new IllegalArgumentException("\"userId\" is required but got null");
            

        return new GetUserResourceRequestBuilder(userId);
    }
}
