...
import com.konfigthis.client.model.OrganizationsGetDetailsResponse;
...
public class OrganizationsApiGenerated {
    ...
    private okhttp3.Call getDetailsCall(String organizationId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v0/organizations/{organization-id}"
    ...
    private okhttp3.Call getDetailsValidateBeforeCall(String organizationId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getDetails(Async)");
        }

        return getDetailsCall(organizationId, _callback);

    }


    private ApiResponse<OrganizationsGetDetailsResponse> getDetailsWithHttpInfo(String organizationId) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(organizationId, null);
        Type localVarReturnType = new TypeToken<OrganizationsGetDetailsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(String organizationId, final ApiCallback<OrganizationsGetDetailsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(organizationId, _callback);
        Type localVarReturnType = new TypeToken<OrganizationsGetDetailsResponse>(){}.getType();
    ...
    public class GetDetailsRequestBuilder {
        ...
        private GetDetailsRequestBuilder(String organizationId) {
         ...
         * @return OrganizationsGetDetailsResponse
         ...
         */
        public OrganizationsGetDetailsResponse execute() throws ApiException {
            ApiResponse<OrganizationsGetDetailsResponse> localVarResp = getDetailsWithHttpInfo(organizationId);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getDetails request with HTTP info returned
         * @return ApiResponse&lt;OrganizationsGetDetailsResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OrganizationsGetDetailsResponse> executeWithHttpInfo() throws ApiException {
            return getDetailsWithHttpInfo(organizationId);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OrganizationsGetDetailsResponse> _callback) throws ApiException {
            return getDetailsAsync(organizationId, _callback);
        }
    }
     ...
     */
    public GetDetailsRequestBuilder getDetails(String organizationId) throws IllegalArgumentException {
        if (organizationId == null) throw new IllegalArgumentException("\"organizationId\" is required but got null");
            

        return new GetDetailsRequestBuilder(organizationId);
    }
}
