...
import com.konfigthis.client.model.InvitationsSendEmailRequest;
...
public class InvitationsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public InvitationsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public InvitationsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call sendEmailCall(String organizationId, InvitationsSendEmailRequest invitationsSendEmailRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = invitationsSendEmailRequest;

        // create path and map variables
        String localVarPath = "/v0/organizations/{organization-id}/invitations"
    ...
    private okhttp3.Call sendEmailValidateBeforeCall(String organizationId, InvitationsSendEmailRequest invitationsSendEmailRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling sendEmail(Async)");
        }

        // verify the required parameter 'invitationsSendEmailRequest' is set
        if (invitationsSendEmailRequest == null) {
            throw new ApiException("Missing the required parameter 'invitationsSendEmailRequest' when calling sendEmail(Async)");
        }

        return sendEmailCall(organizationId, invitationsSendEmailRequest, _callback);

    }


    private ApiResponse<Void> sendEmailWithHttpInfo(String organizationId, InvitationsSendEmailRequest invitationsSendEmailRequest) throws ApiException {
        okhttp3.Call localVarCall = sendEmailValidateBeforeCall(organizationId, invitationsSendEmailRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call sendEmailAsync(String organizationId, InvitationsSendEmailRequest invitationsSendEmailRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendEmailValidateBeforeCall(organizationId, invitationsSendEmailRequest, _callback);
    ...
    public class SendEmailRequestBuilder {
        ...
        private SendEmailRequestBuilder(Object emailAddress, String organizationId) {
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            InvitationsSendEmailRequest invitationsSendEmailRequest = buildBodyParams();
            return sendEmailCall(organizationId, invitationsSendEmailRequest, _callback);
        }

        private InvitationsSendEmailRequest buildBodyParams() {
            InvitationsSendEmailRequest invitationsSendEmailRequest = new InvitationsSendEmailRequest();
            invitationsSendEmailRequest.emailAddress(this.emailAddress);
            return invitationsSendEmailRequest;
        }
        ...
        public void execute() throws ApiException {
            InvitationsSendEmailRequest invitationsSendEmailRequest = buildBodyParams();
            sendEmailWithHttpInfo(organizationId, invitationsSendEmailRequest);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            InvitationsSendEmailRequest invitationsSendEmailRequest = buildBodyParams();
            return sendEmailWithHttpInfo(organizationId, invitationsSendEmailRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            InvitationsSendEmailRequest invitationsSendEmailRequest = buildBodyParams();
            return sendEmailAsync(organizationId, invitationsSendEmailRequest, _callback);
        }
    }
     ...
     * @param invitationsSendEmailRequest  (required)
     ...
     */
    public SendEmailRequestBuilder sendEmail(Object emailAddress, String organizationId) throws IllegalArgumentException {
        
        if (organizationId == null) throw new IllegalArgumentException("\"organizationId\" is required but got null");
            

        return new SendEmailRequestBuilder(emailAddress, organizationId);
    }
}
