...
import com.konfigthis.client.model.CompaniesHouseGetCompanyDetailsResponse;
...
public class CompaniesHouseApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CompaniesHouseApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public CompaniesHouseApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getCompanyDetailsCall(String companyNumber, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v0/companies-house/companies/{company-number}"
            .replace("{" + "company-number" + "}", localVarApiClient.escapeString(companyNumber.toString()));
    ...
    private okhttp3.Call getCompanyDetailsValidateBeforeCall(String companyNumber, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyNumber' is set
        if (companyNumber == null) {
            throw new ApiException("Missing the required parameter 'companyNumber' when calling getCompanyDetails(Async)");
        }

        return getCompanyDetailsCall(companyNumber, _callback);

    }


    private ApiResponse<CompaniesHouseGetCompanyDetailsResponse> getCompanyDetailsWithHttpInfo(String companyNumber) throws ApiException {
        okhttp3.Call localVarCall = getCompanyDetailsValidateBeforeCall(companyNumber, null);
        Type localVarReturnType = new TypeToken<CompaniesHouseGetCompanyDetailsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getCompanyDetailsAsync(String companyNumber, final ApiCallback<CompaniesHouseGetCompanyDetailsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompanyDetailsValidateBeforeCall(companyNumber, _callback);
        Type localVarReturnType = new TypeToken<CompaniesHouseGetCompanyDetailsResponse>(){}.getType();
    ...
    public class GetCompanyDetailsRequestBuilder {
        ...
        private GetCompanyDetailsRequestBuilder(String companyNumber) {
         ...
         * @return CompaniesHouseGetCompanyDetailsResponse
         ...
         */
        public CompaniesHouseGetCompanyDetailsResponse execute() throws ApiException {
            ApiResponse<CompaniesHouseGetCompanyDetailsResponse> localVarResp = getCompanyDetailsWithHttpInfo(companyNumber);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getCompanyDetails request with HTTP info returned
         * @return ApiResponse&lt;CompaniesHouseGetCompanyDetailsResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<CompaniesHouseGetCompanyDetailsResponse> executeWithHttpInfo() throws ApiException {
            return getCompanyDetailsWithHttpInfo(companyNumber);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<CompaniesHouseGetCompanyDetailsResponse> _callback) throws ApiException {
            return getCompanyDetailsAsync(companyNumber, _callback);
        }
    }
     ...
     * @param companyNumber UK Companies House company number (required)
     ...
     */
    public GetCompanyDetailsRequestBuilder getCompanyDetails(String companyNumber) throws IllegalArgumentException {
        if (companyNumber == null) throw new IllegalArgumentException("\"companyNumber\" is required but got null");
            if (companyNumber != null && companyNumber.length() < 1) {
              throw new IllegalArgumentException("Invalid value for companyNumber. Length must be greater than or equal to 1.");
            }

        return new GetCompanyDetailsRequestBuilder(companyNumber);
    }
}
