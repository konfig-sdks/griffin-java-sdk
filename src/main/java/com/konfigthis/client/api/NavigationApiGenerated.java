...
import com.konfigthis.client.model.NavigationGlobalPathsFetchResponse;
...
public class NavigationApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public NavigationApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public NavigationApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call globalPathsFetchCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call globalPathsFetchValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return globalPathsFetchCall(_callback);

    }


    private ApiResponse<NavigationGlobalPathsFetchResponse> globalPathsFetchWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = globalPathsFetchValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<NavigationGlobalPathsFetchResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call globalPathsFetchAsync(final ApiCallback<NavigationGlobalPathsFetchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = globalPathsFetchValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<NavigationGlobalPathsFetchResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GlobalPathsFetchRequestBuilder {

        private GlobalPathsFetchRequestBuilder() {
        }

        /**
         * Build call for globalPathsFetch
        ...
        /**
         * Execute globalPathsFetch request
         * @return NavigationGlobalPathsFetchResponse
         ...
         */
        public NavigationGlobalPathsFetchResponse execute() throws ApiException {
            ApiResponse<NavigationGlobalPathsFetchResponse> localVarResp = globalPathsFetchWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute globalPathsFetch request with HTTP info returned
         * @return ApiResponse&lt;NavigationGlobalPathsFetchResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<NavigationGlobalPathsFetchResponse> executeWithHttpInfo() throws ApiException {
            return globalPathsFetchWithHttpInfo();
        }

        /**
         * Execute globalPathsFetch request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<NavigationGlobalPathsFetchResponse> _callback) throws ApiException {
            return globalPathsFetchAsync(_callback);
        }
    }
     ...
     * @return GlobalPathsFetchRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td>  </td><td>  -  </td></tr>
     ...
     */
    public GlobalPathsFetchRequestBuilder globalPathsFetch() throws IllegalArgumentException {
        return new GlobalPathsFetchRequestBuilder();
    }
}
