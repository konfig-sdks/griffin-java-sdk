...
import com.konfigthis.client.model.LegalPersonHistoryListEventsResponse;
...
public class LegalPersonHistoryApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LegalPersonHistoryApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LegalPersonHistoryApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listEventsCall(String legalPersonId, Long pageSize, byte[] pageAfter, byte[] pageBefore, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v0/legal-persons/{legal-person-id}/history"
    ...
    private okhttp3.Call listEventsValidateBeforeCall(String legalPersonId, Long pageSize, byte[] pageAfter, byte[] pageBefore, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'legalPersonId' is set
        if (legalPersonId == null) {
            throw new ApiException("Missing the required parameter 'legalPersonId' when calling listEvents(Async)");
        }

        return listEventsCall(legalPersonId, pageSize, pageAfter, pageBefore, _callback);

    }


    private ApiResponse<LegalPersonHistoryListEventsResponse> listEventsWithHttpInfo(String legalPersonId, Long pageSize, byte[] pageAfter, byte[] pageBefore) throws ApiException {
        okhttp3.Call localVarCall = listEventsValidateBeforeCall(legalPersonId, pageSize, pageAfter, pageBefore, null);
        Type localVarReturnType = new TypeToken<LegalPersonHistoryListEventsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listEventsAsync(String legalPersonId, Long pageSize, byte[] pageAfter, byte[] pageBefore, final ApiCallback<LegalPersonHistoryListEventsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listEventsValidateBeforeCall(legalPersonId, pageSize, pageAfter, pageBefore, _callback);
        Type localVarReturnType = new TypeToken<LegalPersonHistoryListEventsResponse>(){}.getType();
    ...
    public class ListEventsRequestBuilder {
        ...
        private ListEventsRequestBuilder(String legalPersonId) {
         ...
         */
        public ListEventsRequestBuilder pageSize(Long pageSize) {
         ...
         * @return ListEventsRequestBuilder
         */
        public ListEventsRequestBuilder pageAfter(byte[] pageAfter) {
         ...
         * @return ListEventsRequestBuilder
         */
        public ListEventsRequestBuilder pageBefore(byte[] pageBefore) {
         ...
         * @return LegalPersonHistoryListEventsResponse
         ...
         */
        public LegalPersonHistoryListEventsResponse execute() throws ApiException {
            ApiResponse<LegalPersonHistoryListEventsResponse> localVarResp = listEventsWithHttpInfo(legalPersonId, pageSize, pageAfter, pageBefore);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listEvents request with HTTP info returned
         * @return ApiResponse&lt;LegalPersonHistoryListEventsResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<LegalPersonHistoryListEventsResponse> executeWithHttpInfo() throws ApiException {
            return listEventsWithHttpInfo(legalPersonId, pageSize, pageAfter, pageBefore);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<LegalPersonHistoryListEventsResponse> _callback) throws ApiException {
            return listEventsAsync(legalPersonId, pageSize, pageAfter, pageBefore, _callback);
        }
    }
     ...
     */
    public ListEventsRequestBuilder listEvents(String legalPersonId) throws IllegalArgumentException {
        if (legalPersonId == null) throw new IllegalArgumentException("\"legalPersonId\" is required but got null");
            

        return new ListEventsRequestBuilder(legalPersonId);
    }
}
