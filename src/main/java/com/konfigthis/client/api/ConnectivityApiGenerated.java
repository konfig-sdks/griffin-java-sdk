...
public class ConnectivityApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ConnectivityApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ConnectivityApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call checkConnectionCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call checkConnectionValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return checkConnectionCall(_callback);

    }


    private ApiResponse<Void> checkConnectionWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = checkConnectionValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call checkConnectionAsync(final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkConnectionValidateBeforeCall(_callback);
    ...
    public class CheckConnectionRequestBuilder {
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return checkConnectionWithHttpInfo();
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return checkConnectionAsync(_callback);
        }
    }
