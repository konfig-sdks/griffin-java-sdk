 ...
 */
@ApiModel(description = "Shows the account [balance change](http://docs.griffin.com).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BalanceChangeProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public BalanceChangeProperty1() {
  }

  public BalanceChangeProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public BalanceChangeProperty1 value(String value) {
  ...
  **/
   ...
   * @return the BalanceChangeProperty1 instance itself
   */
  public BalanceChangeProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BalanceChangeProperty1 balanceChangeProperty1 = (BalanceChangeProperty1) o;
    return Objects.equals(this.currency, balanceChangeProperty1.currency) &&
        Objects.equals(this.value, balanceChangeProperty1.value)&&
        Objects.equals(this.additionalProperties, balanceChangeProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BalanceChangeProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BalanceChangeProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BalanceChangeProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalanceChangeProperty1 is not found in the empty JSON string", BalanceChangeProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BalanceChangeProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BalanceChangeProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BalanceChangeProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BalanceChangeProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BalanceChangeProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<BalanceChangeProperty1>() {
           @Override
           public void write(JsonWriter out, BalanceChangeProperty1 value) throws IOException {
           ...
           @Override
           public BalanceChangeProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BalanceChangeProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BalanceChangeProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BalanceChangeProperty1
  * @throws IOException if the JSON string is invalid with respect to BalanceChangeProperty1
  */
  public static BalanceChangeProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BalanceChangeProperty1.class);
  }

 /**
  * Convert an instance of BalanceChangeProperty1 to an JSON string
  *
  * @return JSON string
  */
