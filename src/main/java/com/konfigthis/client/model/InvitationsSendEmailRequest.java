...
public class InvitationsSendEmailRequest {
  public static final String SERIALIZED_NAME_EMAIL_ADDRESS = "email-address";
  @SerializedName(SERIALIZED_NAME_EMAIL_ADDRESS)
  private Object emailAddress = null;

  public InvitationsSendEmailRequest() {
  }

  public InvitationsSendEmailRequest emailAddress(Object emailAddress) {
  ...
  **/
   ...
   * @return the InvitationsSendEmailRequest instance itself
   */
  public InvitationsSendEmailRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvitationsSendEmailRequest invitationsSendEmailRequest = (InvitationsSendEmailRequest) o;
    return Objects.equals(this.emailAddress, invitationsSendEmailRequest.emailAddress)&&
        Objects.equals(this.additionalProperties, invitationsSendEmailRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvitationsSendEmailRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("email-address");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvitationsSendEmailRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvitationsSendEmailRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvitationsSendEmailRequest is not found in the empty JSON string", InvitationsSendEmailRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvitationsSendEmailRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvitationsSendEmailRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvitationsSendEmailRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvitationsSendEmailRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvitationsSendEmailRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<InvitationsSendEmailRequest>() {
           @Override
           public void write(JsonWriter out, InvitationsSendEmailRequest value) throws IOException {
           ...
           @Override
           public InvitationsSendEmailRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvitationsSendEmailRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvitationsSendEmailRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvitationsSendEmailRequest
  * @throws IOException if the JSON string is invalid with respect to InvitationsSendEmailRequest
  */
  public static InvitationsSendEmailRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvitationsSendEmailRequest.class);
  }

 /**
  * Convert an instance of InvitationsSendEmailRequest to an JSON string
  *
  * @return JSON string
  */
