...
public class VerificationsInitiateVerificationRequest {
  public static final String SERIALIZED_NAME_WORKFLOW_URL = "workflow-url";
  @SerializedName(SERIALIZED_NAME_WORKFLOW_URL)
  private String workflowUrl;

  public VerificationsInitiateVerificationRequest() {
  }

  public VerificationsInitiateVerificationRequest workflowUrl(String workflowUrl) {
  ...
  **/
   ...
   * @return the VerificationsInitiateVerificationRequest instance itself
   */
  public VerificationsInitiateVerificationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VerificationsInitiateVerificationRequest verificationsInitiateVerificationRequest = (VerificationsInitiateVerificationRequest) o;
    return Objects.equals(this.workflowUrl, verificationsInitiateVerificationRequest.workflowUrl)&&
        Objects.equals(this.additionalProperties, verificationsInitiateVerificationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflowUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerificationsInitiateVerificationRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VerificationsInitiateVerificationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VerificationsInitiateVerificationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationsInitiateVerificationRequest is not found in the empty JSON string", VerificationsInitiateVerificationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerificationsInitiateVerificationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerificationsInitiateVerificationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerificationsInitiateVerificationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerificationsInitiateVerificationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerificationsInitiateVerificationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerificationsInitiateVerificationRequest>() {
           @Override
           public void write(JsonWriter out, VerificationsInitiateVerificationRequest value) throws IOException {
           ...
           @Override
           public VerificationsInitiateVerificationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VerificationsInitiateVerificationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VerificationsInitiateVerificationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VerificationsInitiateVerificationRequest
  * @throws IOException if the JSON string is invalid with respect to VerificationsInitiateVerificationRequest
  */
  public static VerificationsInitiateVerificationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerificationsInitiateVerificationRequest.class);
  }

 /**
  * Convert an instance of VerificationsInitiateVerificationRequest to an JSON string
  *
  * @return JSON string
  */
