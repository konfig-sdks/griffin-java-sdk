...
public class Role5 {
  ...
  public Role5 description(String description) {
  ...
  **/
  ...
  public Role5 displayName(String displayName) {
  ...
  **/
  ...
  public Role5 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role5 instance itself
   */
  public Role5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role5 role5 = (Role5) o;
    return Objects.equals(this.description, role5.description) &&
        Objects.equals(this.displayName, role5.displayName) &&
        Objects.equals(this.roleUrl, role5.roleUrl)&&
        Objects.equals(this.additionalProperties, role5.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role5 is not found in the empty JSON string", Role5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role5.class));

       return (TypeAdapter<T>) new TypeAdapter<Role5>() {
           @Override
           public void write(JsonWriter out, Role5 value) throws IOException {
           ...
           @Override
           public Role5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role5
  * @throws IOException if the JSON string is invalid with respect to Role5
  */
  public static Role5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role5.class);
  }

 /**
  * Convert an instance of Role5 to an JSON string
  *
  * @return JSON string
  */
