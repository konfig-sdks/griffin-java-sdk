...
public class PaymentsSubmitPaymentSubmissionRequest {
  /**
 ...
 public enum PaymentSchemeEnum {
  ...
  public PaymentsSubmitPaymentSubmissionRequest() {
  }

  public PaymentsSubmitPaymentSubmissionRequest paymentScheme(PaymentSchemeEnum paymentScheme) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Specifies the scheme over which a payment is executed.")
   ...
   * @return the PaymentsSubmitPaymentSubmissionRequest instance itself
   */
  public PaymentsSubmitPaymentSubmissionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsSubmitPaymentSubmissionRequest paymentsSubmitPaymentSubmissionRequest = (PaymentsSubmitPaymentSubmissionRequest) o;
    return Objects.equals(this.paymentScheme, paymentsSubmitPaymentSubmissionRequest.paymentScheme)&&
        Objects.equals(this.additionalProperties, paymentsSubmitPaymentSubmissionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentScheme, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsSubmitPaymentSubmissionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsSubmitPaymentSubmissionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsSubmitPaymentSubmissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsSubmitPaymentSubmissionRequest is not found in the empty JSON string", PaymentsSubmitPaymentSubmissionRequest.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("payment-scheme") != null && !jsonObj.get("payment-scheme").isJsonNull()) && !jsonObj.get("payment-scheme").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsSubmitPaymentSubmissionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsSubmitPaymentSubmissionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsSubmitPaymentSubmissionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsSubmitPaymentSubmissionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsSubmitPaymentSubmissionRequest>() {
           @Override
           public void write(JsonWriter out, PaymentsSubmitPaymentSubmissionRequest value) throws IOException {
           ...
           @Override
           public PaymentsSubmitPaymentSubmissionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsSubmitPaymentSubmissionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsSubmitPaymentSubmissionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsSubmitPaymentSubmissionRequest
  * @throws IOException if the JSON string is invalid with respect to PaymentsSubmitPaymentSubmissionRequest
  */
  public static PaymentsSubmitPaymentSubmissionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsSubmitPaymentSubmissionRequest.class);
  }

 /**
  * Convert an instance of PaymentsSubmitPaymentSubmissionRequest to an JSON string
  *
  * @return JSON string
  */
