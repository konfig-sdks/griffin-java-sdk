...
import com.konfigthis.client.model.Role2;
...
public class RolesGetMembershipRolesResponse {
  public static final String SERIALIZED_NAME_ROLES = "roles";
  @SerializedName(SERIALIZED_NAME_ROLES)
  private List<Role2> roles = new ArrayList<>();

  public RolesGetMembershipRolesResponse() {
  }

  public RolesGetMembershipRolesResponse roles(List<Role2> roles) {
  ...
  public RolesGetMembershipRolesResponse addRolesItem(Role2 rolesItem) {
  ...
  **/
   ...
   * @return the RolesGetMembershipRolesResponse instance itself
   */
  public RolesGetMembershipRolesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RolesGetMembershipRolesResponse rolesGetMembershipRolesResponse = (RolesGetMembershipRolesResponse) o;
    return Objects.equals(this.roles, rolesGetMembershipRolesResponse.roles)&&
        Objects.equals(this.additionalProperties, rolesGetMembershipRolesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RolesGetMembershipRolesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RolesGetMembershipRolesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RolesGetMembershipRolesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RolesGetMembershipRolesResponse is not found in the empty JSON string", RolesGetMembershipRolesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RolesGetMembershipRolesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayroles.size(); i++) {
        Role2.validateJsonObject(jsonArrayroles.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RolesGetMembershipRolesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RolesGetMembershipRolesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RolesGetMembershipRolesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RolesGetMembershipRolesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RolesGetMembershipRolesResponse>() {
           @Override
           public void write(JsonWriter out, RolesGetMembershipRolesResponse value) throws IOException {
           ...
           @Override
           public RolesGetMembershipRolesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RolesGetMembershipRolesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RolesGetMembershipRolesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RolesGetMembershipRolesResponse
  * @throws IOException if the JSON string is invalid with respect to RolesGetMembershipRolesResponse
  */
  public static RolesGetMembershipRolesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RolesGetMembershipRolesResponse.class);
  }

 /**
  * Convert an instance of RolesGetMembershipRolesResponse to an JSON string
  *
  * @return JSON string
  */
