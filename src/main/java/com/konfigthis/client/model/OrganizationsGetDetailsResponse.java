...
import com.konfigthis.client.model.Role4;
...
public class OrganizationsGetDetailsResponse {
 ...
 public enum OrganizationModeEnum {
  ...
  private List<Role4> availableRoles = new ArrayList<>();
  ...
  public OrganizationsGetDetailsResponse() {
  }

  public OrganizationsGetDetailsResponse ownLegalPersonUrl(String ownLegalPersonUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationMode(OrganizationModeEnum organizationMode) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationMembershipsUrl(String organizationMembershipsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationInvitationsUrl(String organizationInvitationsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationOnboardingApplicationsUrl(String organizationOnboardingApplicationsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse displayName(String displayName) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationApiKeysUrl(String organizationApiKeysUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationLiveAccessUrl(String organizationLiveAccessUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationWebhooksUrl(String organizationWebhooksUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationWorkflowsUrl(String organizationWorkflowsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationBankAccountsUrl(String organizationBankAccountsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse availableRoles(List<Role4> availableRoles) {
  ...
  public OrganizationsGetDetailsResponse addAvailableRolesItem(Role4 availableRolesItem) {
  ...
  **/
  ...
  public List<Role4> getAvailableRoles() {
    return availableRoles;
  }


  public void setAvailableRoles(List<Role4> availableRoles) {
  ...
  public OrganizationsGetDetailsResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationIndividualsUrl(String organizationIndividualsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationCorporationsUrl(String organizationCorporationsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationLegalPersonsUrl(String organizationLegalPersonsUrl) {
  ...
  **/
  ...
  public OrganizationsGetDetailsResponse organizationEventsUrl(String organizationEventsUrl) {
  ...
  **/
   ...
   * @return the OrganizationsGetDetailsResponse instance itself
   */
  public OrganizationsGetDetailsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationsGetDetailsResponse organizationsGetDetailsResponse = (OrganizationsGetDetailsResponse) o;
    return Objects.equals(this.ownLegalPersonUrl, organizationsGetDetailsResponse.ownLegalPersonUrl) &&
        Objects.equals(this.organizationMode, organizationsGetDetailsResponse.organizationMode) &&
        Objects.equals(this.organizationMembershipsUrl, organizationsGetDetailsResponse.organizationMembershipsUrl) &&
        Objects.equals(this.organizationInvitationsUrl, organizationsGetDetailsResponse.organizationInvitationsUrl) &&
        Objects.equals(this.organizationOnboardingApplicationsUrl, organizationsGetDetailsResponse.organizationOnboardingApplicationsUrl) &&
        Objects.equals(this.displayName, organizationsGetDetailsResponse.displayName) &&
        Objects.equals(this.organizationApiKeysUrl, organizationsGetDetailsResponse.organizationApiKeysUrl) &&
        Objects.equals(this.organizationLiveAccessUrl, organizationsGetDetailsResponse.organizationLiveAccessUrl) &&
        Objects.equals(this.organizationWebhooksUrl, organizationsGetDetailsResponse.organizationWebhooksUrl) &&
        Objects.equals(this.organizationWorkflowsUrl, organizationsGetDetailsResponse.organizationWorkflowsUrl) &&
        Objects.equals(this.organizationBankAccountsUrl, organizationsGetDetailsResponse.organizationBankAccountsUrl) &&
        Objects.equals(this.availableRoles, organizationsGetDetailsResponse.availableRoles) &&
        Objects.equals(this.organizationUrl, organizationsGetDetailsResponse.organizationUrl) &&
        Objects.equals(this.organizationIndividualsUrl, organizationsGetDetailsResponse.organizationIndividualsUrl) &&
        Objects.equals(this.organizationCorporationsUrl, organizationsGetDetailsResponse.organizationCorporationsUrl) &&
        Objects.equals(this.organizationLegalPersonsUrl, organizationsGetDetailsResponse.organizationLegalPersonsUrl) &&
        Objects.equals(this.organizationEventsUrl, organizationsGetDetailsResponse.organizationEventsUrl)&&
        Objects.equals(this.additionalProperties, organizationsGetDetailsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ownLegalPersonUrl, organizationMode, organizationMembershipsUrl, organizationInvitationsUrl, organizationOnboardingApplicationsUrl, displayName, organizationApiKeysUrl, organizationLiveAccessUrl, organizationWebhooksUrl, organizationWorkflowsUrl, organizationBankAccountsUrl, availableRoles, organizationUrl, organizationIndividualsUrl, organizationCorporationsUrl, organizationLegalPersonsUrl, organizationEventsUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationsGetDetailsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrganizationsGetDetailsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrganizationsGetDetailsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationsGetDetailsResponse is not found in the empty JSON string", OrganizationsGetDetailsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrganizationsGetDetailsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayavailableRoles.size(); i++) {
        Role4.validateJsonObject(jsonArrayavailableRoles.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationsGetDetailsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationsGetDetailsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationsGetDetailsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationsGetDetailsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationsGetDetailsResponse>() {
           @Override
           public void write(JsonWriter out, OrganizationsGetDetailsResponse value) throws IOException {
           ...
           @Override
           public OrganizationsGetDetailsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrganizationsGetDetailsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrganizationsGetDetailsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationsGetDetailsResponse
  * @throws IOException if the JSON string is invalid with respect to OrganizationsGetDetailsResponse
  */
  public static OrganizationsGetDetailsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationsGetDetailsResponse.class);
  }

 /**
  * Convert an instance of OrganizationsGetDetailsResponse to an JSON string
  *
  * @return JSON string
  */
