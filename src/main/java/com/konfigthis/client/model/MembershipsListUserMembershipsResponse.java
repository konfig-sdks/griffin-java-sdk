...
import com.konfigthis.client.model.Membership1;
...
public class MembershipsListUserMembershipsResponse {
  public static final String SERIALIZED_NAME_MEMBERSHIPS = "memberships";
  @SerializedName(SERIALIZED_NAME_MEMBERSHIPS)
  private List<Membership1> memberships = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private LinksProperty links;

  public MembershipsListUserMembershipsResponse() {
  }

  public MembershipsListUserMembershipsResponse memberships(List<Membership1> memberships) {
  ...
  public MembershipsListUserMembershipsResponse addMembershipsItem(Membership1 membershipsItem) {
  ...
  **/
  ...
  public List<Membership1> getMemberships() {
    return memberships;
  }


  public void setMemberships(List<Membership1> memberships) {
  ...
  public MembershipsListUserMembershipsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the MembershipsListUserMembershipsResponse instance itself
   */
  public MembershipsListUserMembershipsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MembershipsListUserMembershipsResponse membershipsListUserMembershipsResponse = (MembershipsListUserMembershipsResponse) o;
    return Objects.equals(this.memberships, membershipsListUserMembershipsResponse.memberships) &&
        Objects.equals(this.links, membershipsListUserMembershipsResponse.links)&&
        Objects.equals(this.additionalProperties, membershipsListUserMembershipsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MembershipsListUserMembershipsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MembershipsListUserMembershipsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MembershipsListUserMembershipsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MembershipsListUserMembershipsResponse is not found in the empty JSON string", MembershipsListUserMembershipsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MembershipsListUserMembershipsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymemberships.size(); i++) {
        Membership1.validateJsonObject(jsonArraymemberships.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipsListUserMembershipsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipsListUserMembershipsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipsListUserMembershipsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipsListUserMembershipsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipsListUserMembershipsResponse>() {
           @Override
           public void write(JsonWriter out, MembershipsListUserMembershipsResponse value) throws IOException {
           ...
           @Override
           public MembershipsListUserMembershipsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MembershipsListUserMembershipsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MembershipsListUserMembershipsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MembershipsListUserMembershipsResponse
  * @throws IOException if the JSON string is invalid with respect to MembershipsListUserMembershipsResponse
  */
  public static MembershipsListUserMembershipsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipsListUserMembershipsResponse.class);
  }

 /**
  * Convert an instance of MembershipsListUserMembershipsResponse to an JSON string
  *
  * @return JSON string
  */
