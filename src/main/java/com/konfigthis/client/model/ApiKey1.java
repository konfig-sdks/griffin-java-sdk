...
public class ApiKey1 {
  ...
  public ApiKey1 apiKeyUrl(String apiKeyUrl) {
  ...
  **/
  ...
  public ApiKey1 apiKeyName(Object apiKeyName) {
  ...
  **/
  ...
  public ApiKey1 apiKeyLiveQuestionMark(Boolean apiKeyLiveQuestionMark) {
  ...
  **/
  ...
  public ApiKey1 organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public ApiKey1 userUrl(String userUrl) {
  ...
  **/
  ...
  public ApiKey1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the ApiKey1 instance itself
   */
  public ApiKey1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKey1 apiKey1 = (ApiKey1) o;
    return Objects.equals(this.apiKeyUrl, apiKey1.apiKeyUrl) &&
        Objects.equals(this.apiKeyName, apiKey1.apiKeyName) &&
        Objects.equals(this.apiKeyLiveQuestionMark, apiKey1.apiKeyLiveQuestionMark) &&
        Objects.equals(this.organizationUrl, apiKey1.organizationUrl) &&
        Objects.equals(this.userUrl, apiKey1.userUrl) &&
        Objects.equals(this.createdAt, apiKey1.createdAt)&&
        Objects.equals(this.additionalProperties, apiKey1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKey1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKey1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKey1 is not found in the empty JSON string", ApiKey1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKey1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKey1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKey1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKey1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKey1.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKey1>() {
           @Override
           public void write(JsonWriter out, ApiKey1 value) throws IOException {
           ...
           @Override
           public ApiKey1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKey1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKey1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKey1
  * @throws IOException if the JSON string is invalid with respect to ApiKey1
  */
  public static ApiKey1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKey1.class);
  }

 /**
  * Convert an instance of ApiKey1 to an JSON string
  *
  * @return JSON string
  */
