...
public class IncomeProperty {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty() {
  }

  public IncomeProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty instance itself
   */
  public IncomeProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty incomeProperty = (IncomeProperty) o;
    return Objects.equals(this.currency, incomeProperty.currency) &&
        Objects.equals(this.value, incomeProperty.value)&&
        Objects.equals(this.additionalProperties, incomeProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty is not found in the empty JSON string", IncomeProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty>() {
           @Override
           public void write(JsonWriter out, IncomeProperty value) throws IOException {
           ...
           @Override
           public IncomeProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty
  */
  public static IncomeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty.class);
  }

 /**
  * Convert an instance of IncomeProperty to an JSON string
  *
  * @return JSON string
  */
