...
import com.konfigthis.client.model.DebtorProperty;
import com.konfigthis.client.model.PayeeProperty1;
import com.konfigthis.client.model.PaymentAmountProperty1;
import com.konfigthis.client.model.UltimateDebtorProperty;
...
public class Payment {
  ...
  private PayeeProperty1 creditor;
 ...
 public enum PaymentDirectionEnum {
  ...
  private DebtorProperty debtor;

  public Payment() {
  }

  public Payment creditor(PayeeProperty1 creditor) {
  ...
  **/
  ...
  public PayeeProperty1 getCreditor() {
    return creditor;
  }


  public void setCreditor(PayeeProperty1 creditor) {
  ...
  public Payment paymentDirection(PaymentDirectionEnum paymentDirection) {
  ...
  **/
  ...
  public Payment paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public Payment paymentAmount(PaymentAmountProperty1 paymentAmount) {
  ...
  **/
  ...
  public PaymentAmountProperty1 getPaymentAmount() {
    return paymentAmount;
  }


  public void setPaymentAmount(PaymentAmountProperty1 paymentAmount) {
  ...
  public Payment ultimateDebtor(UltimateDebtorProperty ultimateDebtor) {
  ...
  **/
  ...
  public UltimateDebtorProperty getUltimateDebtor() {
    return ultimateDebtor;
  }


  public void setUltimateDebtor(UltimateDebtorProperty ultimateDebtor) {
  ...
  public Payment paymentAdmissionsUrl(String paymentAdmissionsUrl) {
  ...
  **/
  ...
  public Payment paymentSubmissionsUrl(String paymentSubmissionsUrl) {
  ...
  **/
  ...
  public Payment debtor(DebtorProperty debtor) {
  ...
  **/
  ...
  public DebtorProperty getDebtor() {
    return debtor;
  }


  public void setDebtor(DebtorProperty debtor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creditor, payment.creditor) &&
        Objects.equals(this.paymentDirection, payment.paymentDirection) &&
        Objects.equals(this.createdAt, payment.createdAt) &&
        Objects.equals(this.paymentUrl, payment.paymentUrl) &&
        Objects.equals(this.paymentReference, payment.paymentReference) &&
        Objects.equals(this.paymentAmount, payment.paymentAmount) &&
        Objects.equals(this.ultimateDebtor, payment.ultimateDebtor) &&
        Objects.equals(this.paymentAdmissionsUrl, payment.paymentAdmissionsUrl) &&
        Objects.equals(this.paymentSubmissionsUrl, payment.paymentSubmissionsUrl) &&
        Objects.equals(this.debtor, payment.debtor)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      PayeeProperty1.validateJsonObject(jsonObj.getAsJsonObject("creditor"));
      ...
      PaymentAmountProperty1.validateJsonObject(jsonObj.getAsJsonObject("payment-amount"));
      // validate the optional field `ultimate-debtor`
      if (jsonObj.get("ultimate-debtor") != null && !jsonObj.get("ultimate-debtor").isJsonNull()) {
        UltimateDebtorProperty.validateJsonObject(jsonObj.getAsJsonObject("ultimate-debtor"));
      }
      ...
      DebtorProperty.validateJsonObject(jsonObj.getAsJsonObject("debtor"));
  }
