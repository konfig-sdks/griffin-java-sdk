...
import com.konfigthis.client.model.OrganizationProperty2;
import com.konfigthis.client.model.Role9;
import com.konfigthis.client.model.UserProperty2;
...
public class Membership1 {
  ...
  private OrganizationProperty2 organization;

  public static final String SERIALIZED_NAME_ROLES = "roles";
  @SerializedName(SERIALIZED_NAME_ROLES)
  private List<Role9> roles = new ArrayList<>();

  public static final String SERIALIZED_NAME_USER = "user";
  @SerializedName(SERIALIZED_NAME_USER)
  private UserProperty2 user;
  ...
  public Membership1 membershipUrl(String membershipUrl) {
  ...
  **/
  ...
  public Membership1 membershipRolesUrl(String membershipRolesUrl) {
  ...
  **/
  ...
  public Membership1 organization(OrganizationProperty2 organization) {
  ...
  **/
  ...
  public OrganizationProperty2 getOrganization() {
    return organization;
  }


  public void setOrganization(OrganizationProperty2 organization) {
  ...
  public Membership1 roles(List<Role9> roles) {
  ...
  public Membership1 addRolesItem(Role9 rolesItem) {
  ...
  **/
  ...
  public List<Role9> getRoles() {
    return roles;
  }


  public void setRoles(List<Role9> roles) {
  ...
  public Membership1 user(UserProperty2 user) {
  ...
  **/
  ...
  public UserProperty2 getUser() {
    return user;
  }


  public void setUser(UserProperty2 user) {
  ...
  public Membership1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the Membership1 instance itself
   */
  public Membership1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Membership1 membership1 = (Membership1) o;
    return Objects.equals(this.membershipUrl, membership1.membershipUrl) &&
        Objects.equals(this.membershipRolesUrl, membership1.membershipRolesUrl) &&
        Objects.equals(this.organization, membership1.organization) &&
        Objects.equals(this.roles, membership1.roles) &&
        Objects.equals(this.user, membership1.user) &&
        Objects.equals(this.createdAt, membership1.createdAt)&&
        Objects.equals(this.additionalProperties, membership1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Membership1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Membership1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Membership1 is not found in the empty JSON string", Membership1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Membership1.openapiRequiredFields) {
      ...
      OrganizationProperty2.validateJsonObject(jsonObj.getAsJsonObject("organization"));
      ...
      for (int i = 0; i < jsonArrayroles.size(); i++) {
        Role9.validateJsonObject(jsonArrayroles.get(i).getAsJsonObject());
      };
      // validate the required field `user`
      UserProperty2.validateJsonObject(jsonObj.getAsJsonObject("user"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Membership1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Membership1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Membership1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Membership1.class));

       return (TypeAdapter<T>) new TypeAdapter<Membership1>() {
           @Override
           public void write(JsonWriter out, Membership1 value) throws IOException {
           ...
           @Override
           public Membership1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Membership1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Membership1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Membership1
  * @throws IOException if the JSON string is invalid with respect to Membership1
  */
  public static Membership1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Membership1.class);
  }

 /**
  * Convert an instance of Membership1 to an JSON string
  *
  * @return JSON string
  */
