...
import com.konfigthis.client.model.ApiKey1;
...
public class ApiKeysListActiveKeys200Response {
  public static final String SERIALIZED_NAME_API_KEYS = "api-keys";
  @SerializedName(SERIALIZED_NAME_API_KEYS)
  private List<ApiKey1> apiKeys = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private LinksProperty links;

  public ApiKeysListActiveKeys200Response() {
  }

  public ApiKeysListActiveKeys200Response apiKeys(List<ApiKey1> apiKeys) {
  ...
  public ApiKeysListActiveKeys200Response addApiKeysItem(ApiKey1 apiKeysItem) {
  ...
  **/
  ...
  public List<ApiKey1> getApiKeys() {
    return apiKeys;
  }


  public void setApiKeys(List<ApiKey1> apiKeys) {
  ...
  public ApiKeysListActiveKeys200Response links(LinksProperty links) {
  ...
  **/
   ...
   * @return the ApiKeysListActiveKeys200Response instance itself
   */
  public ApiKeysListActiveKeys200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeysListActiveKeys200Response apiKeysListActiveKeys200Response = (ApiKeysListActiveKeys200Response) o;
    return Objects.equals(this.apiKeys, apiKeysListActiveKeys200Response.apiKeys) &&
        Objects.equals(this.links, apiKeysListActiveKeys200Response.links)&&
        Objects.equals(this.additionalProperties, apiKeysListActiveKeys200Response.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKeys, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiKeysListActiveKeys200Response {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("api-keys");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKeysListActiveKeys200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeysListActiveKeys200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeysListActiveKeys200Response is not found in the empty JSON string", ApiKeysListActiveKeys200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeysListActiveKeys200Response.openapiRequiredFields) {
      ...
      // validate the required field `api-keys` (array)
      for (int i = 0; i < jsonArrayapiKeys.size(); i++) {
        ApiKey1.validateJsonObject(jsonArrayapiKeys.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeysListActiveKeys200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeysListActiveKeys200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeysListActiveKeys200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeysListActiveKeys200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeysListActiveKeys200Response>() {
           @Override
           public void write(JsonWriter out, ApiKeysListActiveKeys200Response value) throws IOException {
           ...
           @Override
           public ApiKeysListActiveKeys200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKeysListActiveKeys200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKeysListActiveKeys200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKeysListActiveKeys200Response
  * @throws IOException if the JSON string is invalid with respect to ApiKeysListActiveKeys200Response
  */
  public static ApiKeysListActiveKeys200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeysListActiveKeys200Response.class);
  }

 /**
  * Convert an instance of ApiKeysListActiveKeys200Response to an JSON string
  *
  * @return JSON string
  */
