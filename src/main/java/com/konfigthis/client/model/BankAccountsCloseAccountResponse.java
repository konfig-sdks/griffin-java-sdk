...
import com.konfigthis.client.model.AccountBalanceProperty2;
import com.konfigthis.client.model.AvailableBalanceProperty2;
import com.konfigthis.client.model.BankAddress2;
...
public class BankAccountsCloseAccountResponse {
 ...
 public enum ClientMoneyTypeEnum {
  ...
  private AvailableBalanceProperty2 availableBalance;
  ...
  private List<BankAddress2> bankAddresses = null;
  ...
  private AccountBalanceProperty2 accountBalance;
 ...
 public enum SavingsTypeEnum {
  ...
  public BankAccountsCloseAccountResponse() {
  }

  public BankAccountsCloseAccountResponse accountSubmissionsUrl(String accountSubmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountRestricted(Boolean accountRestricted) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountPaymentsUrl(String accountPaymentsUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse pooledAccountMembershipsUrl(String pooledAccountMembershipsUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountAdmissionsUrl(String accountAdmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse bankProductType(BankProductTypeEnum bankProductType) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse displayName(String displayName) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse controllerUrl(String controllerUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse pooledFunds(Boolean pooledFunds) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountStatus(AccountStatusEnum accountStatus) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse clientMoneyType(ClientMoneyTypeEnum clientMoneyType) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse ownerUrl(String ownerUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse closeAccountUrl(String closeAccountUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse availableBalance(AvailableBalanceProperty2 availableBalance) {
  ...
  **/
  ...
  public AvailableBalanceProperty2 getAvailableBalance() {
    return availableBalance;
  }


  public void setAvailableBalance(AvailableBalanceProperty2 availableBalance) {
  ...
  public BankAccountsCloseAccountResponse pooledAccountMembershipUpdatesUrl(String pooledAccountMembershipUpdatesUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse bankAddresses(List<BankAddress2> bankAddresses) {
  ...
  public BankAccountsCloseAccountResponse addBankAddressesItem(BankAddress2 bankAddressesItem) {
  ...
  **/
  ...
  public List<BankAddress2> getBankAddresses() {
    return bankAddresses;
  }


  public void setBankAddresses(List<BankAddress2> bankAddresses) {
  ...
  public BankAccountsCloseAccountResponse accountTransactionsUrl(String accountTransactionsUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountUrl(String accountUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse beneficiaryUrl(String beneficiaryUrl) {
  ...
  **/
  ...
  public BankAccountsCloseAccountResponse accountBalance(AccountBalanceProperty2 accountBalance) {
  ...
  **/
  ...
  public AccountBalanceProperty2 getAccountBalance() {
    return accountBalance;
  }


  public void setAccountBalance(AccountBalanceProperty2 accountBalance) {
  ...
  public BankAccountsCloseAccountResponse savingsType(SavingsTypeEnum savingsType) {
  ...
  **/
   ...
   * @return the BankAccountsCloseAccountResponse instance itself
   */
  public BankAccountsCloseAccountResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsCloseAccountResponse bankAccountsCloseAccountResponse = (BankAccountsCloseAccountResponse) o;
    return Objects.equals(this.accountSubmissionsUrl, bankAccountsCloseAccountResponse.accountSubmissionsUrl) &&
        Objects.equals(this.accountRestricted, bankAccountsCloseAccountResponse.accountRestricted) &&
        Objects.equals(this.accountPaymentsUrl, bankAccountsCloseAccountResponse.accountPaymentsUrl) &&
        Objects.equals(this.pooledAccountMembershipsUrl, bankAccountsCloseAccountResponse.pooledAccountMembershipsUrl) &&
        Objects.equals(this.accountAdmissionsUrl, bankAccountsCloseAccountResponse.accountAdmissionsUrl) &&
        Objects.equals(this.bankProductType, bankAccountsCloseAccountResponse.bankProductType) &&
        Objects.equals(this.displayName, bankAccountsCloseAccountResponse.displayName) &&
        Objects.equals(this.controllerUrl, bankAccountsCloseAccountResponse.controllerUrl) &&
        Objects.equals(this.pooledFunds, bankAccountsCloseAccountResponse.pooledFunds) &&
        Objects.equals(this.accountStatus, bankAccountsCloseAccountResponse.accountStatus) &&
        Objects.equals(this.clientMoneyType, bankAccountsCloseAccountResponse.clientMoneyType) &&
        Objects.equals(this.ownerUrl, bankAccountsCloseAccountResponse.ownerUrl) &&
        Objects.equals(this.createdAt, bankAccountsCloseAccountResponse.createdAt) &&
        Objects.equals(this.closeAccountUrl, bankAccountsCloseAccountResponse.closeAccountUrl) &&
        Objects.equals(this.availableBalance, bankAccountsCloseAccountResponse.availableBalance) &&
        Objects.equals(this.pooledAccountMembershipUpdatesUrl, bankAccountsCloseAccountResponse.pooledAccountMembershipUpdatesUrl) &&
        Objects.equals(this.bankAddresses, bankAccountsCloseAccountResponse.bankAddresses) &&
        Objects.equals(this.accountTransactionsUrl, bankAccountsCloseAccountResponse.accountTransactionsUrl) &&
        Objects.equals(this.accountUrl, bankAccountsCloseAccountResponse.accountUrl) &&
        Objects.equals(this.beneficiaryUrl, bankAccountsCloseAccountResponse.beneficiaryUrl) &&
        Objects.equals(this.accountBalance, bankAccountsCloseAccountResponse.accountBalance) &&
        Objects.equals(this.savingsType, bankAccountsCloseAccountResponse.savingsType)&&
        Objects.equals(this.additionalProperties, bankAccountsCloseAccountResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankAccountsCloseAccountResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsCloseAccountResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsCloseAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsCloseAccountResponse is not found in the empty JSON string", BankAccountsCloseAccountResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsCloseAccountResponse.openapiRequiredFields) {
      ...
      AvailableBalanceProperty2.validateJsonObject(jsonObj.getAsJsonObject("available-balance"));
      ...
      if (jsonObj.get("bank-addresses") != null && !jsonObj.get("bank-addresses").isJsonNull()) {
        ...
        if (jsonArraybankAddresses != null) {
          ...
          for (int i = 0; i < jsonArraybankAddresses.size(); i++) {
            BankAddress2.validateJsonObject(jsonArraybankAddresses.get(i).getAsJsonObject());
          };
        }
      }
      ...
      AccountBalanceProperty2.validateJsonObject(jsonObj.getAsJsonObject("account-balance"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsCloseAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsCloseAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsCloseAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsCloseAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsCloseAccountResponse>() {
           @Override
           public void write(JsonWriter out, BankAccountsCloseAccountResponse value) throws IOException {
           ...
           @Override
           public BankAccountsCloseAccountResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsCloseAccountResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsCloseAccountResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsCloseAccountResponse
  * @throws IOException if the JSON string is invalid with respect to BankAccountsCloseAccountResponse
  */
  public static BankAccountsCloseAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsCloseAccountResponse.class);
  }

 /**
  * Convert an instance of BankAccountsCloseAccountResponse to an JSON string
  *
  * @return JSON string
  */
