...
public class Verification1 {
 ...
 public enum VerificationStatusEnum {
  ...
  public Verification1 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public Verification1 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Verification1 legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public Verification1 workflowUrl(String workflowUrl) {
  ...
  **/
  ...
  public Verification1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Verification1 verificationChecksUrl(String verificationChecksUrl) {
  ...
  **/
  ...
  public Verification1 riskRating(RiskRatingEnum riskRating) {
  ...
  **/
  ...
  public Verification1 verificationStatus(VerificationStatusEnum verificationStatus) {
  ...
  **/
  ...
  public Verification1 verificationRiskAssessmentsUrl(String verificationRiskAssessmentsUrl) {
  ...
  **/
   ...
   * @return the Verification1 instance itself
   */
  public Verification1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Verification1 verification1 = (Verification1) o;
    return Objects.equals(this.verificationUrl, verification1.verificationUrl) &&
        Objects.equals(this.updatedAt, verification1.updatedAt) &&
        Objects.equals(this.legalPersonUrl, verification1.legalPersonUrl) &&
        Objects.equals(this.workflowUrl, verification1.workflowUrl) &&
        Objects.equals(this.createdAt, verification1.createdAt) &&
        Objects.equals(this.verificationChecksUrl, verification1.verificationChecksUrl) &&
        Objects.equals(this.riskRating, verification1.riskRating) &&
        Objects.equals(this.verificationStatus, verification1.verificationStatus) &&
        Objects.equals(this.verificationRiskAssessmentsUrl, verification1.verificationRiskAssessmentsUrl)&&
        Objects.equals(this.additionalProperties, verification1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Verification1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Verification1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Verification1 is not found in the empty JSON string", Verification1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Verification1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Verification1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Verification1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Verification1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Verification1.class));

       return (TypeAdapter<T>) new TypeAdapter<Verification1>() {
           @Override
           public void write(JsonWriter out, Verification1 value) throws IOException {
           ...
           @Override
           public Verification1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Verification1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Verification1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Verification1
  * @throws IOException if the JSON string is invalid with respect to Verification1
  */
  public static Verification1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Verification1.class);
  }

 /**
  * Convert an instance of Verification1 to an JSON string
  *
  * @return JSON string
  */
