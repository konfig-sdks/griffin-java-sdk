...
public class ApiKeysCreateKeyRequest {
  ...
  public ApiKeysCreateKeyRequest() {
  }

  public ApiKeysCreateKeyRequest apiKeyName(Object apiKeyName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the API Key. Cannot contain whitespace.")
   ...
   * @return the ApiKeysCreateKeyRequest instance itself
   */
  public ApiKeysCreateKeyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeysCreateKeyRequest apiKeysCreateKeyRequest = (ApiKeysCreateKeyRequest) o;
    return Objects.equals(this.apiKeyName, apiKeysCreateKeyRequest.apiKeyName)&&
        Objects.equals(this.additionalProperties, apiKeysCreateKeyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKeyName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiKeysCreateKeyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKeysCreateKeyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeysCreateKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeysCreateKeyRequest is not found in the empty JSON string", ApiKeysCreateKeyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeysCreateKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeysCreateKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeysCreateKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeysCreateKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeysCreateKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeysCreateKeyRequest>() {
           @Override
           public void write(JsonWriter out, ApiKeysCreateKeyRequest value) throws IOException {
           ...
           @Override
           public ApiKeysCreateKeyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKeysCreateKeyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKeysCreateKeyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKeysCreateKeyRequest
  * @throws IOException if the JSON string is invalid with respect to ApiKeysCreateKeyRequest
  */
  public static ApiKeysCreateKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeysCreateKeyRequest.class);
  }

 /**
  * Convert an instance of ApiKeysCreateKeyRequest to an JSON string
  *
  * @return JSON string
  */
