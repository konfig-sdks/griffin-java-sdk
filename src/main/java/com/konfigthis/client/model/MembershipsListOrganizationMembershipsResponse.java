...
public class MembershipsListOrganizationMembershipsResponse {
  ...
  public MembershipsListOrganizationMembershipsResponse() {
  }

  public MembershipsListOrganizationMembershipsResponse memberships(List<Membership> memberships) {
  ...
  public MembershipsListOrganizationMembershipsResponse addMembershipsItem(Membership membershipsItem) {
  ...
  **/
  ...
  public MembershipsListOrganizationMembershipsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the MembershipsListOrganizationMembershipsResponse instance itself
   */
  public MembershipsListOrganizationMembershipsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MembershipsListOrganizationMembershipsResponse membershipsListOrganizationMembershipsResponse = (MembershipsListOrganizationMembershipsResponse) o;
    return Objects.equals(this.memberships, membershipsListOrganizationMembershipsResponse.memberships) &&
        Objects.equals(this.links, membershipsListOrganizationMembershipsResponse.links)&&
        Objects.equals(this.additionalProperties, membershipsListOrganizationMembershipsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memberships, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MembershipsListOrganizationMembershipsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MembershipsListOrganizationMembershipsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MembershipsListOrganizationMembershipsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MembershipsListOrganizationMembershipsResponse is not found in the empty JSON string", MembershipsListOrganizationMembershipsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MembershipsListOrganizationMembershipsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipsListOrganizationMembershipsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipsListOrganizationMembershipsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipsListOrganizationMembershipsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipsListOrganizationMembershipsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipsListOrganizationMembershipsResponse>() {
           @Override
           public void write(JsonWriter out, MembershipsListOrganizationMembershipsResponse value) throws IOException {
           ...
           @Override
           public MembershipsListOrganizationMembershipsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MembershipsListOrganizationMembershipsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MembershipsListOrganizationMembershipsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MembershipsListOrganizationMembershipsResponse
  * @throws IOException if the JSON string is invalid with respect to MembershipsListOrganizationMembershipsResponse
  */
  public static MembershipsListOrganizationMembershipsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipsListOrganizationMembershipsResponse.class);
  }

 /**
  * Convert an instance of MembershipsListOrganizationMembershipsResponse to an JSON string
  *
  * @return JSON string
  */
