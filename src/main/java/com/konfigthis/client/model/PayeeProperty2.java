...
public class PayeeProperty2 {
 ...
 public enum BankIdCodeEnum {
  ...
  public PayeeProperty2() {
  }

  public PayeeProperty2 payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeeProperty2 creditorType(CreditorTypeEnum creditorType) {
  ...
  **/
  ...
  public PayeeProperty2 accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeeProperty2 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeeProperty2 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeeProperty2 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public PayeeProperty2 bankId(String bankId) {
  ...
  **/
  ...
  public PayeeProperty2 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
   ...
   * @return the PayeeProperty2 instance itself
   */
  public PayeeProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeeProperty2 payeeProperty2 = (PayeeProperty2) o;
    return Objects.equals(this.payeeUrl, payeeProperty2.payeeUrl) &&
        Objects.equals(this.creditorType, payeeProperty2.creditorType) &&
        Objects.equals(this.accountUrl, payeeProperty2.accountUrl) &&
        Objects.equals(this.accountHolder, payeeProperty2.accountHolder) &&
        Objects.equals(this.accountNumber, payeeProperty2.accountNumber) &&
        Objects.equals(this.accountNumberCode, payeeProperty2.accountNumberCode) &&
        Objects.equals(this.bankId, payeeProperty2.bankId) &&
        Objects.equals(this.bankIdCode, payeeProperty2.bankIdCode)&&
        Objects.equals(this.additionalProperties, payeeProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayeeProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeeProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeeProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeeProperty2 is not found in the empty JSON string", PayeeProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeeProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeeProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeeProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeeProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeeProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeeProperty2>() {
           @Override
           public void write(JsonWriter out, PayeeProperty2 value) throws IOException {
           ...
           @Override
           public PayeeProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeeProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeeProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeeProperty2
  * @throws IOException if the JSON string is invalid with respect to PayeeProperty2
  */
  public static PayeeProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeeProperty2.class);
  }

 /**
  * Convert an instance of PayeeProperty2 to an JSON string
  *
  * @return JSON string
  */
