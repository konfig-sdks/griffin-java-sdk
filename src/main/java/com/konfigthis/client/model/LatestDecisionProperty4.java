...
public class LatestDecisionProperty4 {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public LatestDecisionProperty4() {
  }

  public LatestDecisionProperty4 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public LatestDecisionProperty4 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public LatestDecisionProperty4 decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the LatestDecisionProperty4 instance itself
   */
  public LatestDecisionProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LatestDecisionProperty4 latestDecisionProperty4 = (LatestDecisionProperty4) o;
    return Objects.equals(this.verificationUrl, latestDecisionProperty4.verificationUrl) &&
        Objects.equals(this.decisionOutcome, latestDecisionProperty4.decisionOutcome) &&
        Objects.equals(this.decisionMaker, latestDecisionProperty4.decisionMaker) &&
        Objects.equals(this.decisionNotes, latestDecisionProperty4.decisionNotes) &&
        Objects.equals(this.createdAt, latestDecisionProperty4.createdAt) &&
        Objects.equals(this.decisionUserUrl, latestDecisionProperty4.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, latestDecisionProperty4.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, latestDecisionProperty4.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, latestDecisionProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LatestDecisionProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LatestDecisionProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LatestDecisionProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatestDecisionProperty4 is not found in the empty JSON string", LatestDecisionProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LatestDecisionProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatestDecisionProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatestDecisionProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatestDecisionProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatestDecisionProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<LatestDecisionProperty4>() {
           @Override
           public void write(JsonWriter out, LatestDecisionProperty4 value) throws IOException {
           ...
           @Override
           public LatestDecisionProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LatestDecisionProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LatestDecisionProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LatestDecisionProperty4
  * @throws IOException if the JSON string is invalid with respect to LatestDecisionProperty4
  */
  public static LatestDecisionProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatestDecisionProperty4.class);
  }

 /**
  * Convert an instance of LatestDecisionProperty4 to an JSON string
  *
  * @return JSON string
  */
