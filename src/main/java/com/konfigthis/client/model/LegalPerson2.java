...
import com.konfigthis.client.model.LatestDecisionProperty4;
...
public class LegalPerson2 {
 ...
 public enum ApplicationStatusEnum {
  ...
  public LegalPerson2 latestDecision(LatestDecisionProperty4 latestDecision) {
  ...
  **/
  ...
  public LatestDecisionProperty4 getLatestDecision() {
    return latestDecision;
  }


  public void setLatestDecision(LatestDecisionProperty4 latestDecision) {
  ...
  public LegalPerson2 legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPerson2 latestRiskRatingUrl(String latestRiskRatingUrl) {
  ...
  **/
  ...
  public LegalPerson2 displayName(String displayName) {
  ...
  **/
  ...
  public LegalPerson2 applicationStatus(ApplicationStatusEnum applicationStatus) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonDecisionsUrl(String legalPersonDecisionsUrl) {
  ...
  **/
  ...
  public LegalPerson2 statusChangedAt(OffsetDateTime statusChangedAt) {
  ...
  **/
  ...
  public LegalPerson2 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonClaimsUrl(String legalPersonClaimsUrl) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonBankPayeesUrl(String legalPersonBankPayeesUrl) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonVerificationsUrl(String legalPersonVerificationsUrl) {
  ...
  **/
  ...
  public LegalPerson2 legalPersonDocumentsUrl(String legalPersonDocumentsUrl) {
  ...
  **/
   ...
   * @return the LegalPerson2 instance itself
   */
  public LegalPerson2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPerson2 legalPerson2 = (LegalPerson2) o;
    return Objects.equals(this.latestDecision, legalPerson2.latestDecision) &&
        Objects.equals(this.legalPersonType, legalPerson2.legalPersonType) &&
        Objects.equals(this.latestRiskRatingUrl, legalPerson2.latestRiskRatingUrl) &&
        Objects.equals(this.displayName, legalPerson2.displayName) &&
        Objects.equals(this.applicationStatus, legalPerson2.applicationStatus) &&
        Objects.equals(this.legalPersonUrl, legalPerson2.legalPersonUrl) &&
        Objects.equals(this.legalPersonDecisionsUrl, legalPerson2.legalPersonDecisionsUrl) &&
        Objects.equals(this.statusChangedAt, legalPerson2.statusChangedAt) &&
        Objects.equals(this.createdAt, legalPerson2.createdAt) &&
        Objects.equals(this.legalPersonClaimsUrl, legalPerson2.legalPersonClaimsUrl) &&
        Objects.equals(this.legalPersonBankPayeesUrl, legalPerson2.legalPersonBankPayeesUrl) &&
        Objects.equals(this.legalPersonVerificationsUrl, legalPerson2.legalPersonVerificationsUrl) &&
        Objects.equals(this.legalPersonDocumentsUrl, legalPerson2.legalPersonDocumentsUrl)&&
        Objects.equals(this.additionalProperties, legalPerson2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPerson2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPerson2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPerson2 is not found in the empty JSON string", LegalPerson2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPerson2.openapiRequiredFields) {
      ...
      if (jsonObj.get("latest-decision") != null && !jsonObj.get("latest-decision").isJsonNull()) {
        LatestDecisionProperty4.validateJsonObject(jsonObj.getAsJsonObject("latest-decision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPerson2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPerson2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPerson2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPerson2.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPerson2>() {
           @Override
           public void write(JsonWriter out, LegalPerson2 value) throws IOException {
           ...
           @Override
           public LegalPerson2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPerson2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPerson2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPerson2
  * @throws IOException if the JSON string is invalid with respect to LegalPerson2
  */
  public static LegalPerson2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPerson2.class);
  }

 /**
  * Convert an instance of LegalPerson2 to an JSON string
  *
  * @return JSON string
  */
