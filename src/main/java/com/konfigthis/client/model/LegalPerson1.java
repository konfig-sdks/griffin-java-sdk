...
import com.konfigthis.client.model.LatestDecisionProperty3;
...
public class LegalPerson1 {
 ...
 public enum ApplicationStatusEnum {
  ...
  public LegalPerson1 latestDecision(LatestDecisionProperty3 latestDecision) {
  ...
  **/
  ...
  public LatestDecisionProperty3 getLatestDecision() {
    return latestDecision;
  }


  public void setLatestDecision(LatestDecisionProperty3 latestDecision) {
  ...
  public LegalPerson1 legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPerson1 latestRiskRatingUrl(String latestRiskRatingUrl) {
  ...
  **/
  ...
  public LegalPerson1 displayName(String displayName) {
  ...
  **/
  ...
  public LegalPerson1 applicationStatus(ApplicationStatusEnum applicationStatus) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonDecisionsUrl(String legalPersonDecisionsUrl) {
  ...
  **/
  ...
  public LegalPerson1 statusChangedAt(OffsetDateTime statusChangedAt) {
  ...
  **/
  ...
  public LegalPerson1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonClaimsUrl(String legalPersonClaimsUrl) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonBankPayeesUrl(String legalPersonBankPayeesUrl) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonVerificationsUrl(String legalPersonVerificationsUrl) {
  ...
  **/
  ...
  public LegalPerson1 legalPersonDocumentsUrl(String legalPersonDocumentsUrl) {
  ...
  **/
   ...
   * @return the LegalPerson1 instance itself
   */
  public LegalPerson1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPerson1 legalPerson1 = (LegalPerson1) o;
    return Objects.equals(this.latestDecision, legalPerson1.latestDecision) &&
        Objects.equals(this.legalPersonType, legalPerson1.legalPersonType) &&
        Objects.equals(this.latestRiskRatingUrl, legalPerson1.latestRiskRatingUrl) &&
        Objects.equals(this.displayName, legalPerson1.displayName) &&
        Objects.equals(this.applicationStatus, legalPerson1.applicationStatus) &&
        Objects.equals(this.legalPersonUrl, legalPerson1.legalPersonUrl) &&
        Objects.equals(this.legalPersonDecisionsUrl, legalPerson1.legalPersonDecisionsUrl) &&
        Objects.equals(this.statusChangedAt, legalPerson1.statusChangedAt) &&
        Objects.equals(this.createdAt, legalPerson1.createdAt) &&
        Objects.equals(this.legalPersonClaimsUrl, legalPerson1.legalPersonClaimsUrl) &&
        Objects.equals(this.legalPersonBankPayeesUrl, legalPerson1.legalPersonBankPayeesUrl) &&
        Objects.equals(this.legalPersonVerificationsUrl, legalPerson1.legalPersonVerificationsUrl) &&
        Objects.equals(this.legalPersonDocumentsUrl, legalPerson1.legalPersonDocumentsUrl)&&
        Objects.equals(this.additionalProperties, legalPerson1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPerson1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPerson1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPerson1 is not found in the empty JSON string", LegalPerson1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPerson1.openapiRequiredFields) {
      ...
      if (jsonObj.get("latest-decision") != null && !jsonObj.get("latest-decision").isJsonNull()) {
        LatestDecisionProperty3.validateJsonObject(jsonObj.getAsJsonObject("latest-decision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPerson1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPerson1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPerson1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPerson1.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPerson1>() {
           @Override
           public void write(JsonWriter out, LegalPerson1 value) throws IOException {
           ...
           @Override
           public LegalPerson1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPerson1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPerson1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPerson1
  * @throws IOException if the JSON string is invalid with respect to LegalPerson1
  */
  public static LegalPerson1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPerson1.class);
  }

 /**
  * Convert an instance of LegalPerson1 to an JSON string
  *
  * @return JSON string
  */
