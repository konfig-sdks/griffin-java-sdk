...
import com.konfigthis.client.model.AccountBalanceProperty3;
import com.konfigthis.client.model.BalanceChangeProperty;
...
public class AccountTransaction {
 ...
 public enum TransactionOriginTypeEnum {
  ...
  private BalanceChangeProperty balanceChange;

  public static final String SERIALIZED_NAME_ACCOUNT_BALANCE = "account-balance";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_BALANCE)
  private AccountBalanceProperty3 accountBalance;

  public AccountTransaction() {
  }

  public AccountTransaction accountTransactionUrl(String accountTransactionUrl) {
  ...
  **/
  ...
  public AccountTransaction postDatetime(OffsetDateTime postDatetime) {
  ...
  **/
  ...
  public AccountTransaction balanceChangeDirection(BalanceChangeDirectionEnum balanceChangeDirection) {
  ...
  **/
  ...
  public AccountTransaction transactionOriginType(TransactionOriginTypeEnum transactionOriginType) {
  ...
  **/
  ...
  public AccountTransaction paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public AccountTransaction reference(String reference) {
  ...
  **/
  ...
  public AccountTransaction accountUrl(String accountUrl) {
  ...
  **/
  ...
  public AccountTransaction balanceChange(BalanceChangeProperty balanceChange) {
  ...
  **/
  ...
  public BalanceChangeProperty getBalanceChange() {
    return balanceChange;
  }


  public void setBalanceChange(BalanceChangeProperty balanceChange) {
  ...
  public AccountTransaction accountBalance(AccountBalanceProperty3 accountBalance) {
  ...
  **/
  ...
  public AccountBalanceProperty3 getAccountBalance() {
    return accountBalance;
  }


  public void setAccountBalance(AccountBalanceProperty3 accountBalance) {
   ...
   * @return the AccountTransaction instance itself
   */
  public AccountTransaction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountTransactionUrl, accountTransaction.accountTransactionUrl) &&
        Objects.equals(this.postDatetime, accountTransaction.postDatetime) &&
        Objects.equals(this.balanceChangeDirection, accountTransaction.balanceChangeDirection) &&
        Objects.equals(this.transactionOriginType, accountTransaction.transactionOriginType) &&
        Objects.equals(this.paymentUrl, accountTransaction.paymentUrl) &&
        Objects.equals(this.reference, accountTransaction.reference) &&
        Objects.equals(this.accountUrl, accountTransaction.accountUrl) &&
        Objects.equals(this.balanceChange, accountTransaction.balanceChange) &&
        Objects.equals(this.accountBalance, accountTransaction.accountBalance)&&
        Objects.equals(this.additionalProperties, accountTransaction.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountTransaction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountTransaction is not found in the empty JSON string", AccountTransaction.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountTransaction.openapiRequiredFields) {
      ...
      BalanceChangeProperty.validateJsonObject(jsonObj.getAsJsonObject("balance-change"));
      // validate the required field `account-balance`
      AccountBalanceProperty3.validateJsonObject(jsonObj.getAsJsonObject("account-balance"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountTransaction>() {
           @Override
           public void write(JsonWriter out, AccountTransaction value) throws IOException {
           ...
           @Override
           public AccountTransaction read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountTransaction instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountTransaction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountTransaction
  * @throws IOException if the JSON string is invalid with respect to AccountTransaction
  */
  public static AccountTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountTransaction.class);
  }

 /**
  * Convert an instance of AccountTransaction to an JSON string
  *
  * @return JSON string
  */
