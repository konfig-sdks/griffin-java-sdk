...
import com.konfigthis.client.model.Admission1;
...
public class PaymentsListAdmissionsResponse {
  public static final String SERIALIZED_NAME_ADMISSIONS = "admissions";
  @SerializedName(SERIALIZED_NAME_ADMISSIONS)
  private List<Admission1> admissions = new ArrayList<>();

  public PaymentsListAdmissionsResponse() {
  }

  public PaymentsListAdmissionsResponse admissions(List<Admission1> admissions) {
  ...
  public PaymentsListAdmissionsResponse addAdmissionsItem(Admission1 admissionsItem) {
  ...
  **/
  ...
  public List<Admission1> getAdmissions() {
    return admissions;
  }


  public void setAdmissions(List<Admission1> admissions) {
   ...
   * @return the PaymentsListAdmissionsResponse instance itself
   */
  public PaymentsListAdmissionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsListAdmissionsResponse paymentsListAdmissionsResponse = (PaymentsListAdmissionsResponse) o;
    return Objects.equals(this.admissions, paymentsListAdmissionsResponse.admissions)&&
        Objects.equals(this.additionalProperties, paymentsListAdmissionsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(admissions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsListAdmissionsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsListAdmissionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsListAdmissionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsListAdmissionsResponse is not found in the empty JSON string", PaymentsListAdmissionsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsListAdmissionsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayadmissions.size(); i++) {
        Admission1.validateJsonObject(jsonArrayadmissions.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsListAdmissionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsListAdmissionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsListAdmissionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsListAdmissionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsListAdmissionsResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsListAdmissionsResponse value) throws IOException {
           ...
           @Override
           public PaymentsListAdmissionsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsListAdmissionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsListAdmissionsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsListAdmissionsResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsListAdmissionsResponse
  */
  public static PaymentsListAdmissionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsListAdmissionsResponse.class);
  }

 /**
  * Convert an instance of PaymentsListAdmissionsResponse to an JSON string
  *
  * @return JSON string
  */
