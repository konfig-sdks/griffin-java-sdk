...
public class AccountBalanceProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty() {
  }

  public AccountBalanceProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty instance itself
   */
  public AccountBalanceProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty accountBalanceProperty = (AccountBalanceProperty) o;
    return Objects.equals(this.currency, accountBalanceProperty.currency) &&
        Objects.equals(this.value, accountBalanceProperty.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty is not found in the empty JSON string", AccountBalanceProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty
  */
  public static AccountBalanceProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty to an JSON string
  *
  * @return JSON string
  */
