...
import com.konfigthis.client.model.MobileNumber1;
 ...
 */
@ApiModel(description = "The subject profile to be onboarded.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SubjectProfileProperty {
  ...
  private List<MobileNumber1> claims = new ArrayList<>();

  public SubjectProfileProperty() {
  }

  public SubjectProfileProperty displayName(String displayName) {
  ...
  **/
  ...
  public SubjectProfileProperty claims(List<MobileNumber1> claims) {
  ...
  public SubjectProfileProperty addClaimsItem(MobileNumber1 claimsItem) {
  ...
  **/
  ...
  public List<MobileNumber1> getClaims() {
    return claims;
  }


  public void setClaims(List<MobileNumber1> claims) {
   ...
   * @return the SubjectProfileProperty instance itself
   */
  public SubjectProfileProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubjectProfileProperty subjectProfileProperty = (SubjectProfileProperty) o;
    return Objects.equals(this.displayName, subjectProfileProperty.displayName) &&
        Objects.equals(this.claims, subjectProfileProperty.claims)&&
        Objects.equals(this.additionalProperties, subjectProfileProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, claims, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubjectProfileProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubjectProfileProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubjectProfileProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubjectProfileProperty is not found in the empty JSON string", SubjectProfileProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubjectProfileProperty.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayclaims.size(); i++) {
        MobileNumber1.validateJsonObject(jsonArrayclaims.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubjectProfileProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubjectProfileProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubjectProfileProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubjectProfileProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<SubjectProfileProperty>() {
           @Override
           public void write(JsonWriter out, SubjectProfileProperty value) throws IOException {
           ...
           @Override
           public SubjectProfileProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubjectProfileProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubjectProfileProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubjectProfileProperty
  * @throws IOException if the JSON string is invalid with respect to SubjectProfileProperty
  */
  public static SubjectProfileProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubjectProfileProperty.class);
  }

 /**
  * Convert an instance of SubjectProfileProperty to an JSON string
  *
  * @return JSON string
  */
