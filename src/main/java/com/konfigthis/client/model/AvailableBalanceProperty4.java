...
public class AvailableBalanceProperty4 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AvailableBalanceProperty4() {
  }

  public AvailableBalanceProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AvailableBalanceProperty4 value(String value) {
  ...
  **/
   ...
   * @return the AvailableBalanceProperty4 instance itself
   */
  public AvailableBalanceProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailableBalanceProperty4 availableBalanceProperty4 = (AvailableBalanceProperty4) o;
    return Objects.equals(this.currency, availableBalanceProperty4.currency) &&
        Objects.equals(this.value, availableBalanceProperty4.value)&&
        Objects.equals(this.additionalProperties, availableBalanceProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableBalanceProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailableBalanceProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailableBalanceProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailableBalanceProperty4 is not found in the empty JSON string", AvailableBalanceProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailableBalanceProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailableBalanceProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailableBalanceProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailableBalanceProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailableBalanceProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailableBalanceProperty4>() {
           @Override
           public void write(JsonWriter out, AvailableBalanceProperty4 value) throws IOException {
           ...
           @Override
           public AvailableBalanceProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailableBalanceProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailableBalanceProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailableBalanceProperty4
  * @throws IOException if the JSON string is invalid with respect to AvailableBalanceProperty4
  */
  public static AvailableBalanceProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailableBalanceProperty4.class);
  }

 /**
  * Convert an instance of AvailableBalanceProperty4 to an JSON string
  *
  * @return JSON string
  */
