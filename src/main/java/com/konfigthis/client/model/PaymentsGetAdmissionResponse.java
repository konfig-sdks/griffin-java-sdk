...
import com.konfigthis.client.model.FpsProperty;
...
public class PaymentsGetAdmissionResponse {
  /**
   * Specifies the progress of the inbound payment.
   */
  @JsonAdapter(AdmissionStatusEnum.Adapter.class)
 public enum AdmissionStatusEnum {
    ...
    AdmissionStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static AdmissionStatusEnum fromValue(String value) {
      for (AdmissionStatusEnum b : AdmissionStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AdmissionStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AdmissionStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AdmissionStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AdmissionStatusEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_ADMISSION_STATUS = "admission-status";
  @SerializedName(SERIALIZED_NAME_ADMISSION_STATUS)
  private AdmissionStatusEnum admissionStatus;

  public static final String SERIALIZED_NAME_ADMISSION_SCHEME_INFORMATION = "admission-scheme-information";
  @SerializedName(SERIALIZED_NAME_ADMISSION_SCHEME_INFORMATION)
  private FpsProperty admissionSchemeInformation;
  ...
  public static final String SERIALIZED_NAME_ADMISSION_URL = "admission-url";
  @SerializedName(SERIALIZED_NAME_ADMISSION_URL)
  private String admissionUrl;

  public PaymentsGetAdmissionResponse() {
  }

  public PaymentsGetAdmissionResponse admissionStatus(AdmissionStatusEnum admissionStatus) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Specifies the progress of the inbound payment.")
  ...
  public PaymentsGetAdmissionResponse admissionSchemeInformation(FpsProperty admissionSchemeInformation) {
    
    
    
    
    this.admissionSchemeInformation = admissionSchemeInformation;
    return this;
  }

   /**
   * Get admissionSchemeInformation
   * @return admissionSchemeInformation
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public FpsProperty getAdmissionSchemeInformation() {
    return admissionSchemeInformation;
  }


  public void setAdmissionSchemeInformation(FpsProperty admissionSchemeInformation) {
  ...
  public PaymentsGetAdmissionResponse paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public PaymentsGetAdmissionResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PaymentsGetAdmissionResponse admissionUrl(String admissionUrl) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/v0/admissions/pa.ICAgIGFkbWlzc2lvbi1pZA", required = true, value = "")
   ...
   * @return the PaymentsGetAdmissionResponse instance itself
   */
  public PaymentsGetAdmissionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsGetAdmissionResponse paymentsGetAdmissionResponse = (PaymentsGetAdmissionResponse) o;
    return Objects.equals(this.admissionStatus, paymentsGetAdmissionResponse.admissionStatus) &&
        Objects.equals(this.admissionSchemeInformation, paymentsGetAdmissionResponse.admissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, paymentsGetAdmissionResponse.paymentUrl) &&
        Objects.equals(this.createdAt, paymentsGetAdmissionResponse.createdAt) &&
        Objects.equals(this.admissionUrl, paymentsGetAdmissionResponse.admissionUrl)&&
        Objects.equals(this.additionalProperties, paymentsGetAdmissionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(admissionStatus, admissionSchemeInformation, paymentUrl, createdAt, admissionUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsGetAdmissionResponse {\n");
    sb.append("    admissionStatus: ").append(toIndentedString(admissionStatus)).append("\n");
    sb.append("    admissionSchemeInformation: ").append(toIndentedString(admissionSchemeInformation)).append("\n");
    sb.append("    paymentUrl: ").append(toIndentedString(paymentUrl)).append("\n");
    sb.append("    createdAt: ").append(toIndentedString(createdAt)).append("\n");
    sb.append("    admissionUrl: ").append(toIndentedString(admissionUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("admission-status");
    openapiFields.add("admission-scheme-information");
    openapiFields.add("payment-url");
    openapiFields.add("created-at");
    openapiFields.add("admission-url");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("admission-status");
    openapiRequiredFields.add("admission-scheme-information");
    openapiRequiredFields.add("payment-url");
    openapiRequiredFields.add("created-at");
    openapiRequiredFields.add("admission-url");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsGetAdmissionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsGetAdmissionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsGetAdmissionResponse is not found in the empty JSON string", PaymentsGetAdmissionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsGetAdmissionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("admission-status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `admission-status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("admission-status").toString()));
      }
      // validate the required field `admission-scheme-information`
      FpsProperty.validateJsonObject(jsonObj.getAsJsonObject("admission-scheme-information"));
      ...
      if (!jsonObj.get("admission-url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `admission-url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("admission-url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsGetAdmissionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsGetAdmissionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsGetAdmissionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsGetAdmissionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsGetAdmissionResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsGetAdmissionResponse value) throws IOException {
           ...
           @Override
           public PaymentsGetAdmissionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsGetAdmissionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsGetAdmissionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsGetAdmissionResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsGetAdmissionResponse
  */
  public static PaymentsGetAdmissionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsGetAdmissionResponse.class);
  }

 /**
  * Convert an instance of PaymentsGetAdmissionResponse to an JSON string
  *
  * @return JSON string
  */
