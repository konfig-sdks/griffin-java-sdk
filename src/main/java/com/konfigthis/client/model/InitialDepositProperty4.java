...
public class InitialDepositProperty4 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty4() {
  }

  public InitialDepositProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty4 value(String value) {
  ...
  **/
   ...
   * @return the InitialDepositProperty4 instance itself
   */
  public InitialDepositProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty4 initialDepositProperty4 = (InitialDepositProperty4) o;
    return Objects.equals(this.currency, initialDepositProperty4.currency) &&
        Objects.equals(this.value, initialDepositProperty4.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty4 is not found in the empty JSON string", InitialDepositProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty4>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty4 value) throws IOException {
           ...
           @Override
           public InitialDepositProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty4
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty4
  */
  public static InitialDepositProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty4.class);
  }

 /**
  * Convert an instance of InitialDepositProperty4 to an JSON string
  *
  * @return JSON string
  */
