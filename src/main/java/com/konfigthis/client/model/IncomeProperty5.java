...
public class IncomeProperty5 {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty5() {
  }

  public IncomeProperty5 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty5 value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty5 instance itself
   */
  public IncomeProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty5 incomeProperty5 = (IncomeProperty5) o;
    return Objects.equals(this.currency, incomeProperty5.currency) &&
        Objects.equals(this.value, incomeProperty5.value)&&
        Objects.equals(this.additionalProperties, incomeProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty5 is not found in the empty JSON string", IncomeProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty5>() {
           @Override
           public void write(JsonWriter out, IncomeProperty5 value) throws IOException {
           ...
           @Override
           public IncomeProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty5
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty5
  */
  public static IncomeProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty5.class);
  }

 /**
  * Convert an instance of IncomeProperty5 to an JSON string
  *
  * @return JSON string
  */
