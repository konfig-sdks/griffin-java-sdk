...
/**
 * InitialDepositProperty
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InitialDepositProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty() {
  }

  public InitialDepositProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty value(String value) {
  ...
  **/
   ...
   * @return the InitialDepositProperty instance itself
   */
  public InitialDepositProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty initialDepositProperty = (InitialDepositProperty) o;
    return Objects.equals(this.currency, initialDepositProperty.currency) &&
        Objects.equals(this.value, initialDepositProperty.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty is not found in the empty JSON string", InitialDepositProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty value) throws IOException {
           ...
           @Override
           public InitialDepositProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty
  */
  public static InitialDepositProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty.class);
  }

 /**
  * Convert an instance of InitialDepositProperty to an JSON string
  *
  * @return JSON string
  */
