...
public class WebhooksGetAllResponse {
  public static final String SERIALIZED_NAME_ORGANIZATION_WEBHOOKS = "organization-webhooks";
  @SerializedName(SERIALIZED_NAME_ORGANIZATION_WEBHOOKS)
  private List<Webhook> organizationWebhooks = new ArrayList<>();

  public WebhooksGetAllResponse() {
  }

  public WebhooksGetAllResponse organizationWebhooks(List<Webhook> organizationWebhooks) {
    
    
    
    
    this.organizationWebhooks = organizationWebhooks;
    return this;
  }

  public WebhooksGetAllResponse addOrganizationWebhooksItem(Webhook organizationWebhooksItem) {
    this.organizationWebhooks.add(organizationWebhooksItem);
    return this;
  }

   /**
   * Get organizationWebhooks
   * @return organizationWebhooks
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public List<Webhook> getOrganizationWebhooks() {
    return organizationWebhooks;
  }


  public void setOrganizationWebhooks(List<Webhook> organizationWebhooks) {
   ...
   * @return the WebhooksGetAllResponse instance itself
   */
  public WebhooksGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksGetAllResponse webhooksGetAllResponse = (WebhooksGetAllResponse) o;
    return Objects.equals(this.organizationWebhooks, webhooksGetAllResponse.organizationWebhooks)&&
        Objects.equals(this.additionalProperties, webhooksGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organizationWebhooks, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhooksGetAllResponse {\n");
    sb.append("    organizationWebhooks: ").append(toIndentedString(organizationWebhooks)).append("\n");
  ...
  static {
    ...
    openapiFields.add("organization-webhooks");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("organization-webhooks");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksGetAllResponse is not found in the empty JSON string", WebhooksGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksGetAllResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("organization-webhooks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `organization-webhooks` to be an array in the JSON string but got `%s`", jsonObj.get("organization-webhooks").toString()));
      }

      JsonArray jsonArrayorganizationWebhooks = jsonObj.getAsJsonArray("organization-webhooks");
      // validate the required field `organization-webhooks` (array)
      for (int i = 0; i < jsonArrayorganizationWebhooks.size(); i++) {
        Webhook.validateJsonObject(jsonArrayorganizationWebhooks.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksGetAllResponse>() {
           @Override
           public void write(JsonWriter out, WebhooksGetAllResponse value) throws IOException {
           ...
           @Override
           public WebhooksGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to WebhooksGetAllResponse
  */
  public static WebhooksGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksGetAllResponse.class);
  }

 /**
  * Convert an instance of WebhooksGetAllResponse to an JSON string
  *
  * @return JSON string
  */
