...
import com.konfigthis.client.model.AccountBalanceProperty1;
import com.konfigthis.client.model.AvailableBalanceProperty1;
import com.konfigthis.client.model.BankAddress1;
...
public class BankAccountsUpdateBankAccountResponse {
 ...
 public enum ClientMoneyTypeEnum {
  ...
  private AvailableBalanceProperty1 availableBalance;
  ...
  private List<BankAddress1> bankAddresses = null;
  ...
  private AccountBalanceProperty1 accountBalance;
 ...
 public enum SavingsTypeEnum {
  ...
  public BankAccountsUpdateBankAccountResponse() {
  }

  public BankAccountsUpdateBankAccountResponse accountSubmissionsUrl(String accountSubmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountRestricted(Boolean accountRestricted) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountPaymentsUrl(String accountPaymentsUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse pooledAccountMembershipsUrl(String pooledAccountMembershipsUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountAdmissionsUrl(String accountAdmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse bankProductType(BankProductTypeEnum bankProductType) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse displayName(String displayName) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse controllerUrl(String controllerUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse pooledFunds(Boolean pooledFunds) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountStatus(AccountStatusEnum accountStatus) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse clientMoneyType(ClientMoneyTypeEnum clientMoneyType) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse ownerUrl(String ownerUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse closeAccountUrl(String closeAccountUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse availableBalance(AvailableBalanceProperty1 availableBalance) {
  ...
  **/
  ...
  public AvailableBalanceProperty1 getAvailableBalance() {
    return availableBalance;
  }


  public void setAvailableBalance(AvailableBalanceProperty1 availableBalance) {
  ...
  public BankAccountsUpdateBankAccountResponse pooledAccountMembershipUpdatesUrl(String pooledAccountMembershipUpdatesUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse bankAddresses(List<BankAddress1> bankAddresses) {
  ...
  public BankAccountsUpdateBankAccountResponse addBankAddressesItem(BankAddress1 bankAddressesItem) {
  ...
  **/
  ...
  public List<BankAddress1> getBankAddresses() {
    return bankAddresses;
  }


  public void setBankAddresses(List<BankAddress1> bankAddresses) {
  ...
  public BankAccountsUpdateBankAccountResponse accountTransactionsUrl(String accountTransactionsUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountUrl(String accountUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse beneficiaryUrl(String beneficiaryUrl) {
  ...
  **/
  ...
  public BankAccountsUpdateBankAccountResponse accountBalance(AccountBalanceProperty1 accountBalance) {
  ...
  **/
  ...
  public AccountBalanceProperty1 getAccountBalance() {
    return accountBalance;
  }


  public void setAccountBalance(AccountBalanceProperty1 accountBalance) {
  ...
  public BankAccountsUpdateBankAccountResponse savingsType(SavingsTypeEnum savingsType) {
  ...
  **/
   ...
   * @return the BankAccountsUpdateBankAccountResponse instance itself
   */
  public BankAccountsUpdateBankAccountResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsUpdateBankAccountResponse bankAccountsUpdateBankAccountResponse = (BankAccountsUpdateBankAccountResponse) o;
    return Objects.equals(this.accountSubmissionsUrl, bankAccountsUpdateBankAccountResponse.accountSubmissionsUrl) &&
        Objects.equals(this.accountRestricted, bankAccountsUpdateBankAccountResponse.accountRestricted) &&
        Objects.equals(this.accountPaymentsUrl, bankAccountsUpdateBankAccountResponse.accountPaymentsUrl) &&
        Objects.equals(this.pooledAccountMembershipsUrl, bankAccountsUpdateBankAccountResponse.pooledAccountMembershipsUrl) &&
        Objects.equals(this.accountAdmissionsUrl, bankAccountsUpdateBankAccountResponse.accountAdmissionsUrl) &&
        Objects.equals(this.bankProductType, bankAccountsUpdateBankAccountResponse.bankProductType) &&
        Objects.equals(this.displayName, bankAccountsUpdateBankAccountResponse.displayName) &&
        Objects.equals(this.controllerUrl, bankAccountsUpdateBankAccountResponse.controllerUrl) &&
        Objects.equals(this.pooledFunds, bankAccountsUpdateBankAccountResponse.pooledFunds) &&
        Objects.equals(this.accountStatus, bankAccountsUpdateBankAccountResponse.accountStatus) &&
        Objects.equals(this.clientMoneyType, bankAccountsUpdateBankAccountResponse.clientMoneyType) &&
        Objects.equals(this.ownerUrl, bankAccountsUpdateBankAccountResponse.ownerUrl) &&
        Objects.equals(this.createdAt, bankAccountsUpdateBankAccountResponse.createdAt) &&
        Objects.equals(this.closeAccountUrl, bankAccountsUpdateBankAccountResponse.closeAccountUrl) &&
        Objects.equals(this.availableBalance, bankAccountsUpdateBankAccountResponse.availableBalance) &&
        Objects.equals(this.pooledAccountMembershipUpdatesUrl, bankAccountsUpdateBankAccountResponse.pooledAccountMembershipUpdatesUrl) &&
        Objects.equals(this.bankAddresses, bankAccountsUpdateBankAccountResponse.bankAddresses) &&
        Objects.equals(this.accountTransactionsUrl, bankAccountsUpdateBankAccountResponse.accountTransactionsUrl) &&
        Objects.equals(this.accountUrl, bankAccountsUpdateBankAccountResponse.accountUrl) &&
        Objects.equals(this.beneficiaryUrl, bankAccountsUpdateBankAccountResponse.beneficiaryUrl) &&
        Objects.equals(this.accountBalance, bankAccountsUpdateBankAccountResponse.accountBalance) &&
        Objects.equals(this.savingsType, bankAccountsUpdateBankAccountResponse.savingsType)&&
        Objects.equals(this.additionalProperties, bankAccountsUpdateBankAccountResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankAccountsUpdateBankAccountResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsUpdateBankAccountResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsUpdateBankAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsUpdateBankAccountResponse is not found in the empty JSON string", BankAccountsUpdateBankAccountResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsUpdateBankAccountResponse.openapiRequiredFields) {
      ...
      AvailableBalanceProperty1.validateJsonObject(jsonObj.getAsJsonObject("available-balance"));
      ...
      if (jsonObj.get("bank-addresses") != null && !jsonObj.get("bank-addresses").isJsonNull()) {
        ...
        if (jsonArraybankAddresses != null) {
          ...
          for (int i = 0; i < jsonArraybankAddresses.size(); i++) {
            BankAddress1.validateJsonObject(jsonArraybankAddresses.get(i).getAsJsonObject());
          };
        }
      }
      ...
      AccountBalanceProperty1.validateJsonObject(jsonObj.getAsJsonObject("account-balance"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsUpdateBankAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsUpdateBankAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsUpdateBankAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsUpdateBankAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsUpdateBankAccountResponse>() {
           @Override
           public void write(JsonWriter out, BankAccountsUpdateBankAccountResponse value) throws IOException {
           ...
           @Override
           public BankAccountsUpdateBankAccountResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsUpdateBankAccountResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsUpdateBankAccountResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsUpdateBankAccountResponse
  * @throws IOException if the JSON string is invalid with respect to BankAccountsUpdateBankAccountResponse
  */
  public static BankAccountsUpdateBankAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsUpdateBankAccountResponse.class);
  }

 /**
  * Convert an instance of BankAccountsUpdateBankAccountResponse to an JSON string
  *
  * @return JSON string
  */
