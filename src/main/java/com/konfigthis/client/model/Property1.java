...
import com.konfigthis.client.model.Payment1;
...
public class Property1 {
  ...
  private List<Payment1> payments = null;

  public Property1() {
  }

  public Property1 payments(List<Payment1> payments) {
  ...
  public Property1 addPaymentsItem(Payment1 paymentsItem) {
  ...
  **/
   ...
   * @return the Property1 instance itself
   */
  public Property1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payments, property1.payments)&&
        Objects.equals(this.additionalProperties, property1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Property1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Property1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("payments") != null && !jsonObj.get("payments").isJsonNull()) {
        ...
        if (jsonArraypayments != null) {
          ...
          for (int i = 0; i < jsonArraypayments.size(); i++) {
            Payment1.validateJsonObject(jsonArraypayments.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Property1>() {
           ...
           public Property1 read(JsonReader in) throws IOException {
             ...
             Property1 instance = thisAdapter.fromJsonTree(jsonObj);
