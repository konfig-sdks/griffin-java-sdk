...
public class WorkflowsListOrganizationWorkflowsResponse {
  ...
  public WorkflowsListOrganizationWorkflowsResponse() {
  }

  public WorkflowsListOrganizationWorkflowsResponse workflows(List<Workflow> workflows) {
  ...
  public WorkflowsListOrganizationWorkflowsResponse addWorkflowsItem(Workflow workflowsItem) {
  ...
  **/
  ...
  public WorkflowsListOrganizationWorkflowsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the WorkflowsListOrganizationWorkflowsResponse instance itself
   */
  public WorkflowsListOrganizationWorkflowsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowsListOrganizationWorkflowsResponse workflowsListOrganizationWorkflowsResponse = (WorkflowsListOrganizationWorkflowsResponse) o;
    return Objects.equals(this.workflows, workflowsListOrganizationWorkflowsResponse.workflows) &&
        Objects.equals(this.links, workflowsListOrganizationWorkflowsResponse.links)&&
        Objects.equals(this.additionalProperties, workflowsListOrganizationWorkflowsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflows, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkflowsListOrganizationWorkflowsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowsListOrganizationWorkflowsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowsListOrganizationWorkflowsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowsListOrganizationWorkflowsResponse is not found in the empty JSON string", WorkflowsListOrganizationWorkflowsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowsListOrganizationWorkflowsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowsListOrganizationWorkflowsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowsListOrganizationWorkflowsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowsListOrganizationWorkflowsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowsListOrganizationWorkflowsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowsListOrganizationWorkflowsResponse>() {
           @Override
           public void write(JsonWriter out, WorkflowsListOrganizationWorkflowsResponse value) throws IOException {
           ...
           @Override
           public WorkflowsListOrganizationWorkflowsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkflowsListOrganizationWorkflowsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkflowsListOrganizationWorkflowsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowsListOrganizationWorkflowsResponse
  * @throws IOException if the JSON string is invalid with respect to WorkflowsListOrganizationWorkflowsResponse
  */
  public static WorkflowsListOrganizationWorkflowsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowsListOrganizationWorkflowsResponse.class);
  }

 /**
  * Convert an instance of WorkflowsListOrganizationWorkflowsResponse to an JSON string
  *
  * @return JSON string
  */
