...
public class DecisionsListForLegalPersonResponse {
  ...
  public DecisionsListForLegalPersonResponse() {
  }

  public DecisionsListForLegalPersonResponse decisions(List<Decision> decisions) {
  ...
  public DecisionsListForLegalPersonResponse addDecisionsItem(Decision decisionsItem) {
  ...
  **/
  ...
  public DecisionsListForLegalPersonResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the DecisionsListForLegalPersonResponse instance itself
   */
  public DecisionsListForLegalPersonResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DecisionsListForLegalPersonResponse decisionsListForLegalPersonResponse = (DecisionsListForLegalPersonResponse) o;
    return Objects.equals(this.decisions, decisionsListForLegalPersonResponse.decisions) &&
        Objects.equals(this.links, decisionsListForLegalPersonResponse.links)&&
        Objects.equals(this.additionalProperties, decisionsListForLegalPersonResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(decisions, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DecisionsListForLegalPersonResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecisionsListForLegalPersonResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DecisionsListForLegalPersonResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DecisionsListForLegalPersonResponse is not found in the empty JSON string", DecisionsListForLegalPersonResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DecisionsListForLegalPersonResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DecisionsListForLegalPersonResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DecisionsListForLegalPersonResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DecisionsListForLegalPersonResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DecisionsListForLegalPersonResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DecisionsListForLegalPersonResponse>() {
           @Override
           public void write(JsonWriter out, DecisionsListForLegalPersonResponse value) throws IOException {
           ...
           @Override
           public DecisionsListForLegalPersonResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DecisionsListForLegalPersonResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DecisionsListForLegalPersonResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecisionsListForLegalPersonResponse
  * @throws IOException if the JSON string is invalid with respect to DecisionsListForLegalPersonResponse
  */
  public static DecisionsListForLegalPersonResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecisionsListForLegalPersonResponse.class);
  }

 /**
  * Convert an instance of DecisionsListForLegalPersonResponse to an JSON string
  *
  * @return JSON string
  */
