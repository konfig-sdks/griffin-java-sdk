...
public class AccountBalanceProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty1() {
  }

  public AccountBalanceProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty1 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty1 instance itself
   */
  public AccountBalanceProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty1 accountBalanceProperty1 = (AccountBalanceProperty1) o;
    return Objects.equals(this.currency, accountBalanceProperty1.currency) &&
        Objects.equals(this.value, accountBalanceProperty1.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty1 is not found in the empty JSON string", AccountBalanceProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty1>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty1 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty1
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty1
  */
  public static AccountBalanceProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty1.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty1 to an JSON string
  *
  * @return JSON string
  */
