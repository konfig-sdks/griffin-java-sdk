...
public class Director {
  ...
  public Director companiesHouseUrl(String companiesHouseUrl) {
  ...
  **/
   ...
   * @return the Director instance itself
   */
  public Director putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.companiesHouseUrl, director.companiesHouseUrl)&&
        Objects.equals(this.additionalProperties, director.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Director
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Director.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Director>() {
           ...
           public Director read(JsonReader in) throws IOException {
             ...
             Director instance = thisAdapter.fromJsonTree(jsonObj);
