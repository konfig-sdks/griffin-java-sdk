...
public class UltimateDebtorProperty3 {
 ...
 public enum BankIdCodeEnum {
  ...
  public UltimateDebtorProperty3() {
  }

  public UltimateDebtorProperty3 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 bankId(String bankId) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the UltimateDebtorProperty3 instance itself
   */
  public UltimateDebtorProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UltimateDebtorProperty3 ultimateDebtorProperty3 = (UltimateDebtorProperty3) o;
    return Objects.equals(this.accountNumber, ultimateDebtorProperty3.accountNumber) &&
        Objects.equals(this.accountNumberCode, ultimateDebtorProperty3.accountNumberCode) &&
        Objects.equals(this.bankId, ultimateDebtorProperty3.bankId) &&
        Objects.equals(this.bankIdCode, ultimateDebtorProperty3.bankIdCode) &&
        Objects.equals(this.accountHolder, ultimateDebtorProperty3.accountHolder) &&
        Objects.equals(this.accountUrl, ultimateDebtorProperty3.accountUrl)&&
        Objects.equals(this.additionalProperties, ultimateDebtorProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UltimateDebtorProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UltimateDebtorProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UltimateDebtorProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UltimateDebtorProperty3 is not found in the empty JSON string", UltimateDebtorProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UltimateDebtorProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UltimateDebtorProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UltimateDebtorProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UltimateDebtorProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UltimateDebtorProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<UltimateDebtorProperty3>() {
           @Override
           public void write(JsonWriter out, UltimateDebtorProperty3 value) throws IOException {
           ...
           @Override
           public UltimateDebtorProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UltimateDebtorProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UltimateDebtorProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UltimateDebtorProperty3
  * @throws IOException if the JSON string is invalid with respect to UltimateDebtorProperty3
  */
  public static UltimateDebtorProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UltimateDebtorProperty3.class);
  }

 /**
  * Convert an instance of UltimateDebtorProperty3 to an JSON string
  *
  * @return JSON string
  */
