...
public class WebhooksDeactivateActionResponse {
  ...
  public WebhooksDeactivateActionResponse() {
  }

  public WebhooksDeactivateActionResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse webhookDestinationUrl(String webhookDestinationUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse testWebhookUrl(String testWebhookUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse activateWebhookUrl(String activateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse deactivateWebhookUrl(String deactivateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksDeactivateActionResponse webhookDescription(String webhookDescription) {
  ...
  **/
   ...
   * @return the WebhooksDeactivateActionResponse instance itself
   */
  public WebhooksDeactivateActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksDeactivateActionResponse webhooksDeactivateActionResponse = (WebhooksDeactivateActionResponse) o;
    return Objects.equals(this.organizationUrl, webhooksDeactivateActionResponse.organizationUrl) &&
        Objects.equals(this.webhookUrl, webhooksDeactivateActionResponse.webhookUrl) &&
        Objects.equals(this.webhookDestinationUrl, webhooksDeactivateActionResponse.webhookDestinationUrl) &&
        Objects.equals(this.testWebhookUrl, webhooksDeactivateActionResponse.testWebhookUrl) &&
        Objects.equals(this.activateWebhookUrl, webhooksDeactivateActionResponse.activateWebhookUrl) &&
        Objects.equals(this.deactivateWebhookUrl, webhooksDeactivateActionResponse.deactivateWebhookUrl) &&
        Objects.equals(this.webhookDescription, webhooksDeactivateActionResponse.webhookDescription)&&
        Objects.equals(this.additionalProperties, webhooksDeactivateActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksDeactivateActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksDeactivateActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksDeactivateActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksDeactivateActionResponse is not found in the empty JSON string", WebhooksDeactivateActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksDeactivateActionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksDeactivateActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksDeactivateActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksDeactivateActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksDeactivateActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksDeactivateActionResponse>() {
           @Override
           public void write(JsonWriter out, WebhooksDeactivateActionResponse value) throws IOException {
           ...
           @Override
           public WebhooksDeactivateActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksDeactivateActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksDeactivateActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksDeactivateActionResponse
  * @throws IOException if the JSON string is invalid with respect to WebhooksDeactivateActionResponse
  */
  public static WebhooksDeactivateActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksDeactivateActionResponse.class);
  }

 /**
  * Convert an instance of WebhooksDeactivateActionResponse to an JSON string
  *
  * @return JSON string
  */
