...
public class PooledAccountMembershipManageLegalPersonsResponse {
  ...
  public PooledAccountMembershipManageLegalPersonsResponse() {
  }

  public PooledAccountMembershipManageLegalPersonsResponse pooledAccountMembershipsUrl(String pooledAccountMembershipsUrl) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/v0/bank/accounts/ba.IGJhbmstYWNjb3VudC1pZA/membership", required = true, value = "Link to the list of [pool members](http://docs.griffin.com) associated with this account.")
   ...
   * @return the PooledAccountMembershipManageLegalPersonsResponse instance itself
   */
  public PooledAccountMembershipManageLegalPersonsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PooledAccountMembershipManageLegalPersonsResponse pooledAccountMembershipManageLegalPersonsResponse = (PooledAccountMembershipManageLegalPersonsResponse) o;
    return Objects.equals(this.pooledAccountMembershipsUrl, pooledAccountMembershipManageLegalPersonsResponse.pooledAccountMembershipsUrl)&&
        Objects.equals(this.additionalProperties, pooledAccountMembershipManageLegalPersonsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pooledAccountMembershipsUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PooledAccountMembershipManageLegalPersonsResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("pooled-account-memberships-url");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PooledAccountMembershipManageLegalPersonsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PooledAccountMembershipManageLegalPersonsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PooledAccountMembershipManageLegalPersonsResponse is not found in the empty JSON string", PooledAccountMembershipManageLegalPersonsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PooledAccountMembershipManageLegalPersonsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("pooled-account-memberships-url").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PooledAccountMembershipManageLegalPersonsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PooledAccountMembershipManageLegalPersonsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PooledAccountMembershipManageLegalPersonsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PooledAccountMembershipManageLegalPersonsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PooledAccountMembershipManageLegalPersonsResponse>() {
           @Override
           public void write(JsonWriter out, PooledAccountMembershipManageLegalPersonsResponse value) throws IOException {
           ...
           @Override
           public PooledAccountMembershipManageLegalPersonsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PooledAccountMembershipManageLegalPersonsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PooledAccountMembershipManageLegalPersonsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PooledAccountMembershipManageLegalPersonsResponse
  * @throws IOException if the JSON string is invalid with respect to PooledAccountMembershipManageLegalPersonsResponse
  */
  public static PooledAccountMembershipManageLegalPersonsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PooledAccountMembershipManageLegalPersonsResponse.class);
  }

 /**
  * Convert an instance of PooledAccountMembershipManageLegalPersonsResponse to an JSON string
  *
  * @return JSON string
  */
