...
/**
 * AnnualTurnoverProperty2
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AnnualTurnoverProperty2 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty2() {
  }

  public AnnualTurnoverProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty2 value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty2 instance itself
   */
  public AnnualTurnoverProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty2 annualTurnoverProperty2 = (AnnualTurnoverProperty2) o;
    return Objects.equals(this.currency, annualTurnoverProperty2.currency) &&
        Objects.equals(this.value, annualTurnoverProperty2.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty2 is not found in the empty JSON string", AnnualTurnoverProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty2>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty2 value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty2
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty2
  */
  public static AnnualTurnoverProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty2.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty2 to an JSON string
  *
  * @return JSON string
  */
