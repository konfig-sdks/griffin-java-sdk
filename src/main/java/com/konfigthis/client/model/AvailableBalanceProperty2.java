 ...
 */
@ApiModel(description = "Shows the [available balance](http://docs.griffin.com).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AvailableBalanceProperty2 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  private String value = "1.00";

  public AvailableBalanceProperty2() {
  }

  public AvailableBalanceProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AvailableBalanceProperty2 value(String value) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1000.00", required = true, value = "The value as a decimal-formatted string")
   ...
   * @return the AvailableBalanceProperty2 instance itself
   */
  public AvailableBalanceProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailableBalanceProperty2 availableBalanceProperty2 = (AvailableBalanceProperty2) o;
    return Objects.equals(this.currency, availableBalanceProperty2.currency) &&
        Objects.equals(this.value, availableBalanceProperty2.value)&&
        Objects.equals(this.additionalProperties, availableBalanceProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableBalanceProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailableBalanceProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailableBalanceProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailableBalanceProperty2 is not found in the empty JSON string", AvailableBalanceProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailableBalanceProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailableBalanceProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailableBalanceProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailableBalanceProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailableBalanceProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailableBalanceProperty2>() {
           @Override
           public void write(JsonWriter out, AvailableBalanceProperty2 value) throws IOException {
           ...
           @Override
           public AvailableBalanceProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailableBalanceProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailableBalanceProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailableBalanceProperty2
  * @throws IOException if the JSON string is invalid with respect to AvailableBalanceProperty2
  */
  public static AvailableBalanceProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailableBalanceProperty2.class);
  }

 /**
  * Convert an instance of AvailableBalanceProperty2 to an JSON string
  *
  * @return JSON string
  */
