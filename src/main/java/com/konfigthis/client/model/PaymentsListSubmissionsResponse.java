...
import com.konfigthis.client.model.Submission;
...
public class PaymentsListSubmissionsResponse {
  ...
  public PaymentsListSubmissionsResponse() {
  }

  public PaymentsListSubmissionsResponse submissions(List<Submission> submissions) {
  ...
  public PaymentsListSubmissionsResponse addSubmissionsItem(Submission submissionsItem) {
  ...
  **/
  ...
  public PaymentsListSubmissionsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the PaymentsListSubmissionsResponse instance itself
   */
  public PaymentsListSubmissionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsListSubmissionsResponse paymentsListSubmissionsResponse = (PaymentsListSubmissionsResponse) o;
    return Objects.equals(this.submissions, paymentsListSubmissionsResponse.submissions) &&
        Objects.equals(this.links, paymentsListSubmissionsResponse.links)&&
        Objects.equals(this.additionalProperties, paymentsListSubmissionsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(submissions, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsListSubmissionsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsListSubmissionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsListSubmissionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsListSubmissionsResponse is not found in the empty JSON string", PaymentsListSubmissionsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsListSubmissionsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsListSubmissionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsListSubmissionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsListSubmissionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsListSubmissionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsListSubmissionsResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsListSubmissionsResponse value) throws IOException {
           ...
           @Override
           public PaymentsListSubmissionsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsListSubmissionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsListSubmissionsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsListSubmissionsResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsListSubmissionsResponse
  */
  public static PaymentsListSubmissionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsListSubmissionsResponse.class);
  }

 /**
  * Convert an instance of PaymentsListSubmissionsResponse to an JSON string
  *
  * @return JSON string
  */
