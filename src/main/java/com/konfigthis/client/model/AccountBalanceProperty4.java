...
public class AccountBalanceProperty4 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty4() {
  }

  public AccountBalanceProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty4 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty4 instance itself
   */
  public AccountBalanceProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty4 accountBalanceProperty4 = (AccountBalanceProperty4) o;
    return Objects.equals(this.currency, accountBalanceProperty4.currency) &&
        Objects.equals(this.value, accountBalanceProperty4.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty4 is not found in the empty JSON string", AccountBalanceProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty4>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty4 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty4
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty4
  */
  public static AccountBalanceProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty4.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty4 to an JSON string
  *
  * @return JSON string
  */
