...
public class EventsGetAllOrganizationEventsResponse {
  ...
  public EventsGetAllOrganizationEventsResponse() {
  }

  public EventsGetAllOrganizationEventsResponse events(List<Event> events) {
  ...
  public EventsGetAllOrganizationEventsResponse addEventsItem(Event eventsItem) {
  ...
  **/
  ...
  public EventsGetAllOrganizationEventsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the EventsGetAllOrganizationEventsResponse instance itself
   */
  public EventsGetAllOrganizationEventsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsGetAllOrganizationEventsResponse eventsGetAllOrganizationEventsResponse = (EventsGetAllOrganizationEventsResponse) o;
    return Objects.equals(this.events, eventsGetAllOrganizationEventsResponse.events) &&
        Objects.equals(this.links, eventsGetAllOrganizationEventsResponse.links)&&
        Objects.equals(this.additionalProperties, eventsGetAllOrganizationEventsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventsGetAllOrganizationEventsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsGetAllOrganizationEventsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsGetAllOrganizationEventsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsGetAllOrganizationEventsResponse is not found in the empty JSON string", EventsGetAllOrganizationEventsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsGetAllOrganizationEventsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsGetAllOrganizationEventsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsGetAllOrganizationEventsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsGetAllOrganizationEventsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsGetAllOrganizationEventsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsGetAllOrganizationEventsResponse>() {
           @Override
           public void write(JsonWriter out, EventsGetAllOrganizationEventsResponse value) throws IOException {
           ...
           @Override
           public EventsGetAllOrganizationEventsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsGetAllOrganizationEventsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsGetAllOrganizationEventsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsGetAllOrganizationEventsResponse
  * @throws IOException if the JSON string is invalid with respect to EventsGetAllOrganizationEventsResponse
  */
  public static EventsGetAllOrganizationEventsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsGetAllOrganizationEventsResponse.class);
  }

 /**
  * Convert an instance of EventsGetAllOrganizationEventsResponse to an JSON string
  *
  * @return JSON string
  */
