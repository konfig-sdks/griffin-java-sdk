...
public class ApiKeysGetKeyDetailsResponse {
  ...
  public ApiKeysGetKeyDetailsResponse() {
  }

  public ApiKeysGetKeyDetailsResponse apiKeyUrl(String apiKeyUrl) {
  ...
  **/
  ...
  public ApiKeysGetKeyDetailsResponse apiKeyName(Object apiKeyName) {
  ...
  **/
  ...
  public ApiKeysGetKeyDetailsResponse apiKeyLiveQuestionMark(Boolean apiKeyLiveQuestionMark) {
  ...
  **/
  ...
  public ApiKeysGetKeyDetailsResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public ApiKeysGetKeyDetailsResponse userUrl(String userUrl) {
  ...
  **/
  ...
  public ApiKeysGetKeyDetailsResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the ApiKeysGetKeyDetailsResponse instance itself
   */
  public ApiKeysGetKeyDetailsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeysGetKeyDetailsResponse apiKeysGetKeyDetailsResponse = (ApiKeysGetKeyDetailsResponse) o;
    return Objects.equals(this.apiKeyUrl, apiKeysGetKeyDetailsResponse.apiKeyUrl) &&
        Objects.equals(this.apiKeyName, apiKeysGetKeyDetailsResponse.apiKeyName) &&
        Objects.equals(this.apiKeyLiveQuestionMark, apiKeysGetKeyDetailsResponse.apiKeyLiveQuestionMark) &&
        Objects.equals(this.organizationUrl, apiKeysGetKeyDetailsResponse.organizationUrl) &&
        Objects.equals(this.userUrl, apiKeysGetKeyDetailsResponse.userUrl) &&
        Objects.equals(this.createdAt, apiKeysGetKeyDetailsResponse.createdAt)&&
        Objects.equals(this.additionalProperties, apiKeysGetKeyDetailsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKeyUrl, apiKeyName, apiKeyLiveQuestionMark, organizationUrl, userUrl, createdAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiKeysGetKeyDetailsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKeysGetKeyDetailsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeysGetKeyDetailsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeysGetKeyDetailsResponse is not found in the empty JSON string", ApiKeysGetKeyDetailsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeysGetKeyDetailsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeysGetKeyDetailsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeysGetKeyDetailsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeysGetKeyDetailsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeysGetKeyDetailsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeysGetKeyDetailsResponse>() {
           @Override
           public void write(JsonWriter out, ApiKeysGetKeyDetailsResponse value) throws IOException {
           ...
           @Override
           public ApiKeysGetKeyDetailsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKeysGetKeyDetailsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKeysGetKeyDetailsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKeysGetKeyDetailsResponse
  * @throws IOException if the JSON string is invalid with respect to ApiKeysGetKeyDetailsResponse
  */
  public static ApiKeysGetKeyDetailsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeysGetKeyDetailsResponse.class);
  }

 /**
  * Convert an instance of ApiKeysGetKeyDetailsResponse to an JSON string
  *
  * @return JSON string
  */
