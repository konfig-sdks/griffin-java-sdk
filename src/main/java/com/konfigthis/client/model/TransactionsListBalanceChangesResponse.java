...
import com.konfigthis.client.model.AccountTransaction;
import com.konfigthis.client.model.LinksProperty;
import com.konfigthis.client.model.Property1;
...
public class TransactionsListBalanceChangesResponse {
  public static final String SERIALIZED_NAME_ACCOUNT_TRANSACTIONS = "account-transactions";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_TRANSACTIONS)
  ...
  private Property1 included;

  public TransactionsListBalanceChangesResponse() {
  }

  public TransactionsListBalanceChangesResponse accountTransactions(List<AccountTransaction> accountTransactions) {
  ...
  public TransactionsListBalanceChangesResponse addAccountTransactionsItem(AccountTransaction accountTransactionsItem) {
  ...
  **/
  ...
  public TransactionsListBalanceChangesResponse links(LinksProperty links) {
  ...
  **/
  ...
  public TransactionsListBalanceChangesResponse included(Property1 included) {
  ...
  **/
  ...
  public Property1 getIncluded() {
    return included;
  }


  public void setIncluded(Property1 included) {
   ...
   * @return the TransactionsListBalanceChangesResponse instance itself
   */
  public TransactionsListBalanceChangesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionsListBalanceChangesResponse transactionsListBalanceChangesResponse = (TransactionsListBalanceChangesResponse) o;
    return Objects.equals(this.accountTransactions, transactionsListBalanceChangesResponse.accountTransactions) &&
        Objects.equals(this.links, transactionsListBalanceChangesResponse.links) &&
        Objects.equals(this.included, transactionsListBalanceChangesResponse.included)&&
        Objects.equals(this.additionalProperties, transactionsListBalanceChangesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountTransactions, links, included, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TransactionsListBalanceChangesResponse {\n");
  ...
  static {
    ...
    openapiFields.add("account-transactions");
    openapiFields.add("links");
    openapiFields.add("included");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("account-transactions");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionsListBalanceChangesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionsListBalanceChangesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionsListBalanceChangesResponse is not found in the empty JSON string", TransactionsListBalanceChangesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionsListBalanceChangesResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("account-transactions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `account-transactions` to be an array in the JSON string but got `%s`", jsonObj.get("account-transactions").toString()));
      }

      JsonArray jsonArrayaccountTransactions = jsonObj.getAsJsonArray("account-transactions");
      // validate the required field `account-transactions` (array)
      for (int i = 0; i < jsonArrayaccountTransactions.size(); i++) {
        AccountTransaction.validateJsonObject(jsonArrayaccountTransactions.get(i).getAsJsonObject());
      };
      ...
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        Property1.validateJsonObject(jsonObj.getAsJsonObject("included"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionsListBalanceChangesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionsListBalanceChangesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionsListBalanceChangesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionsListBalanceChangesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionsListBalanceChangesResponse>() {
           @Override
           public void write(JsonWriter out, TransactionsListBalanceChangesResponse value) throws IOException {
           ...
           @Override
           public TransactionsListBalanceChangesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionsListBalanceChangesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionsListBalanceChangesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionsListBalanceChangesResponse
  * @throws IOException if the JSON string is invalid with respect to TransactionsListBalanceChangesResponse
  */
  public static TransactionsListBalanceChangesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionsListBalanceChangesResponse.class);
  }

 /**
  * Convert an instance of TransactionsListBalanceChangesResponse to an JSON string
  *
  * @return JSON string
  */
