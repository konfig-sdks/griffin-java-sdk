...
public class BankAddress3 {
 ...
 public enum AccountNumberCodeEnum {
  ...
  public BankAddress3 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public BankAddress3 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public BankAddress3 bankId(String bankId) {
  ...
  **/
  ...
  public BankAddress3 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public BankAddress3 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
   ...
   * @return the BankAddress3 instance itself
   */
  public BankAddress3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAddress3 bankAddress3 = (BankAddress3) o;
    return Objects.equals(this.accountHolder, bankAddress3.accountHolder) &&
        Objects.equals(this.bankIdCode, bankAddress3.bankIdCode) &&
        Objects.equals(this.bankId, bankAddress3.bankId) &&
        Objects.equals(this.accountNumber, bankAddress3.accountNumber) &&
        Objects.equals(this.accountNumberCode, bankAddress3.accountNumberCode)&&
        Objects.equals(this.additionalProperties, bankAddress3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAddress3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAddress3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAddress3 is not found in the empty JSON string", BankAddress3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAddress3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAddress3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAddress3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAddress3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAddress3.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAddress3>() {
           @Override
           public void write(JsonWriter out, BankAddress3 value) throws IOException {
           ...
           @Override
           public BankAddress3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAddress3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAddress3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAddress3
  * @throws IOException if the JSON string is invalid with respect to BankAddress3
  */
  public static BankAddress3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAddress3.class);
  }

 /**
  * Convert an instance of BankAddress3 to an JSON string
  *
  * @return JSON string
  */
