...
public class PaymentsCreateRequestRequest {
  ...
  public PaymentsCreateRequestRequest() {
  }

  public PaymentsCreateRequestRequest creditor(PayeeProperty creditor) {
  ...
  **/
  ...
  public PayeeProperty getCreditor() {
    return creditor;
  }


  public void setCreditor(PayeeProperty creditor) {
  ...
  public PaymentsCreateRequestRequest paymentAmount(PaymentAmountProperty paymentAmount) {
  ...
  **/
  ...
  public PaymentAmountProperty getPaymentAmount() {
    return paymentAmount;
  }


  public void setPaymentAmount(PaymentAmountProperty paymentAmount) {
  ...
  public PaymentsCreateRequestRequest paymentReference(String paymentReference) {
  ...
  **/
   ...
   * @return the PaymentsCreateRequestRequest instance itself
   */
  public PaymentsCreateRequestRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsCreateRequestRequest paymentsCreateRequestRequest = (PaymentsCreateRequestRequest) o;
    return Objects.equals(this.creditor, paymentsCreateRequestRequest.creditor) &&
        Objects.equals(this.paymentAmount, paymentsCreateRequestRequest.paymentAmount) &&
        Objects.equals(this.paymentReference, paymentsCreateRequestRequest.paymentReference)&&
        Objects.equals(this.additionalProperties, paymentsCreateRequestRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creditor, paymentAmount, paymentReference, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsCreateRequestRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsCreateRequestRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsCreateRequestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsCreateRequestRequest is not found in the empty JSON string", PaymentsCreateRequestRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsCreateRequestRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `creditor`
      PayeeProperty.validateJsonObject(jsonObj.getAsJsonObject("creditor"));
      // validate the required field `payment-amount`
      PaymentAmountProperty.validateJsonObject(jsonObj.getAsJsonObject("payment-amount"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsCreateRequestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsCreateRequestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsCreateRequestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsCreateRequestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsCreateRequestRequest>() {
           @Override
           public void write(JsonWriter out, PaymentsCreateRequestRequest value) throws IOException {
           ...
           @Override
           public PaymentsCreateRequestRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsCreateRequestRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsCreateRequestRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsCreateRequestRequest
  * @throws IOException if the JSON string is invalid with respect to PaymentsCreateRequestRequest
  */
  public static PaymentsCreateRequestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsCreateRequestRequest.class);
  }

 /**
  * Convert an instance of PaymentsCreateRequestRequest to an JSON string
  *
  * @return JSON string
  */
