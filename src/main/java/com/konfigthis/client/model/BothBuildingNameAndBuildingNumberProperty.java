...
public class BothBuildingNameAndBuildingNumberProperty {
  ...
  public BothBuildingNameAndBuildingNumberProperty() {
  }

  public BothBuildingNameAndBuildingNumberProperty buildingName(String buildingName) {
  ...
  **/
  ...
  public BothBuildingNameAndBuildingNumberProperty buildingNumber(String buildingNumber) {
  ...
  **/
   ...
   * @return the BothBuildingNameAndBuildingNumberProperty instance itself
   */
  public BothBuildingNameAndBuildingNumberProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BothBuildingNameAndBuildingNumberProperty bothBuildingNameAndBuildingNumberProperty = (BothBuildingNameAndBuildingNumberProperty) o;
    return Objects.equals(this.buildingName, bothBuildingNameAndBuildingNumberProperty.buildingName) &&
        Objects.equals(this.buildingNumber, bothBuildingNameAndBuildingNumberProperty.buildingNumber)&&
        Objects.equals(this.additionalProperties, bothBuildingNameAndBuildingNumberProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buildingName, buildingNumber, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BothBuildingNameAndBuildingNumberProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BothBuildingNameAndBuildingNumberProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BothBuildingNameAndBuildingNumberProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BothBuildingNameAndBuildingNumberProperty is not found in the empty JSON string", BothBuildingNameAndBuildingNumberProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BothBuildingNameAndBuildingNumberProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BothBuildingNameAndBuildingNumberProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BothBuildingNameAndBuildingNumberProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BothBuildingNameAndBuildingNumberProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<BothBuildingNameAndBuildingNumberProperty>() {
           @Override
           public void write(JsonWriter out, BothBuildingNameAndBuildingNumberProperty value) throws IOException {
           ...
           @Override
           public BothBuildingNameAndBuildingNumberProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BothBuildingNameAndBuildingNumberProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BothBuildingNameAndBuildingNumberProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BothBuildingNameAndBuildingNumberProperty
  * @throws IOException if the JSON string is invalid with respect to BothBuildingNameAndBuildingNumberProperty
  */
  public static BothBuildingNameAndBuildingNumberProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BothBuildingNameAndBuildingNumberProperty.class);
  }

 /**
  * Convert an instance of BothBuildingNameAndBuildingNumberProperty to an JSON string
  *
  * @return JSON string
  */
