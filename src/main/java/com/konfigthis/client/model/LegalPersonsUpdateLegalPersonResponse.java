...
import com.konfigthis.client.model.LatestDecisionProperty2;
...
public class LegalPersonsUpdateLegalPersonResponse {
 ...
 public enum ApplicationStatusEnum {
  ...
  public LegalPersonsUpdateLegalPersonResponse() {
  }

  public LegalPersonsUpdateLegalPersonResponse latestDecision(LatestDecisionProperty2 latestDecision) {
  ...
  **/
  ...
  public LatestDecisionProperty2 getLatestDecision() {
    return latestDecision;
  }


  public void setLatestDecision(LatestDecisionProperty2 latestDecision) {
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse latestRiskRatingUrl(String latestRiskRatingUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse displayName(String displayName) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse applicationStatus(ApplicationStatusEnum applicationStatus) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonDecisionsUrl(String legalPersonDecisionsUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse statusChangedAt(OffsetDateTime statusChangedAt) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonClaimsUrl(String legalPersonClaimsUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonBankPayeesUrl(String legalPersonBankPayeesUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonVerificationsUrl(String legalPersonVerificationsUrl) {
  ...
  **/
  ...
  public LegalPersonsUpdateLegalPersonResponse legalPersonDocumentsUrl(String legalPersonDocumentsUrl) {
  ...
  **/
   ...
   * @return the LegalPersonsUpdateLegalPersonResponse instance itself
   */
  public LegalPersonsUpdateLegalPersonResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonsUpdateLegalPersonResponse legalPersonsUpdateLegalPersonResponse = (LegalPersonsUpdateLegalPersonResponse) o;
    return Objects.equals(this.latestDecision, legalPersonsUpdateLegalPersonResponse.latestDecision) &&
        Objects.equals(this.legalPersonType, legalPersonsUpdateLegalPersonResponse.legalPersonType) &&
        Objects.equals(this.latestRiskRatingUrl, legalPersonsUpdateLegalPersonResponse.latestRiskRatingUrl) &&
        Objects.equals(this.displayName, legalPersonsUpdateLegalPersonResponse.displayName) &&
        Objects.equals(this.applicationStatus, legalPersonsUpdateLegalPersonResponse.applicationStatus) &&
        Objects.equals(this.legalPersonUrl, legalPersonsUpdateLegalPersonResponse.legalPersonUrl) &&
        Objects.equals(this.legalPersonDecisionsUrl, legalPersonsUpdateLegalPersonResponse.legalPersonDecisionsUrl) &&
        Objects.equals(this.statusChangedAt, legalPersonsUpdateLegalPersonResponse.statusChangedAt) &&
        Objects.equals(this.createdAt, legalPersonsUpdateLegalPersonResponse.createdAt) &&
        Objects.equals(this.legalPersonClaimsUrl, legalPersonsUpdateLegalPersonResponse.legalPersonClaimsUrl) &&
        Objects.equals(this.legalPersonBankPayeesUrl, legalPersonsUpdateLegalPersonResponse.legalPersonBankPayeesUrl) &&
        Objects.equals(this.legalPersonVerificationsUrl, legalPersonsUpdateLegalPersonResponse.legalPersonVerificationsUrl) &&
        Objects.equals(this.legalPersonDocumentsUrl, legalPersonsUpdateLegalPersonResponse.legalPersonDocumentsUrl)&&
        Objects.equals(this.additionalProperties, legalPersonsUpdateLegalPersonResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegalPersonsUpdateLegalPersonResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonsUpdateLegalPersonResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonsUpdateLegalPersonResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonsUpdateLegalPersonResponse is not found in the empty JSON string", LegalPersonsUpdateLegalPersonResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonsUpdateLegalPersonResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("latest-decision") != null && !jsonObj.get("latest-decision").isJsonNull()) {
        LatestDecisionProperty2.validateJsonObject(jsonObj.getAsJsonObject("latest-decision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonsUpdateLegalPersonResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonsUpdateLegalPersonResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonsUpdateLegalPersonResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonsUpdateLegalPersonResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonsUpdateLegalPersonResponse>() {
           @Override
           public void write(JsonWriter out, LegalPersonsUpdateLegalPersonResponse value) throws IOException {
           ...
           @Override
           public LegalPersonsUpdateLegalPersonResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonsUpdateLegalPersonResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonsUpdateLegalPersonResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonsUpdateLegalPersonResponse
  * @throws IOException if the JSON string is invalid with respect to LegalPersonsUpdateLegalPersonResponse
  */
  public static LegalPersonsUpdateLegalPersonResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonsUpdateLegalPersonResponse.class);
  }

 /**
  * Convert an instance of LegalPersonsUpdateLegalPersonResponse to an JSON string
  *
  * @return JSON string
  */
