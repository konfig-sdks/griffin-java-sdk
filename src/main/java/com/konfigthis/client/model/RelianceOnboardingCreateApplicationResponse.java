...
public class RelianceOnboardingCreateApplicationResponse {
 ...
 public enum OnboardingApplicationStatusEnum {
  ...
  public RelianceOnboardingCreateApplicationResponse() {
  }

  public RelianceOnboardingCreateApplicationResponse onboardingApplicationUrl(String onboardingApplicationUrl) {
  ...
  **/
  ...
  public RelianceOnboardingCreateApplicationResponse onboardingApplicationStatus(OnboardingApplicationStatusEnum onboardingApplicationStatus) {
  ...
  **/
   ...
   * @return the RelianceOnboardingCreateApplicationResponse instance itself
   */
  public RelianceOnboardingCreateApplicationResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelianceOnboardingCreateApplicationResponse relianceOnboardingCreateApplicationResponse = (RelianceOnboardingCreateApplicationResponse) o;
    return Objects.equals(this.onboardingApplicationUrl, relianceOnboardingCreateApplicationResponse.onboardingApplicationUrl) &&
        Objects.equals(this.onboardingApplicationStatus, relianceOnboardingCreateApplicationResponse.onboardingApplicationStatus)&&
        Objects.equals(this.additionalProperties, relianceOnboardingCreateApplicationResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(onboardingApplicationUrl, onboardingApplicationStatus, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RelianceOnboardingCreateApplicationResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RelianceOnboardingCreateApplicationResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RelianceOnboardingCreateApplicationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RelianceOnboardingCreateApplicationResponse is not found in the empty JSON string", RelianceOnboardingCreateApplicationResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelianceOnboardingCreateApplicationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelianceOnboardingCreateApplicationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelianceOnboardingCreateApplicationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelianceOnboardingCreateApplicationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelianceOnboardingCreateApplicationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RelianceOnboardingCreateApplicationResponse>() {
           @Override
           public void write(JsonWriter out, RelianceOnboardingCreateApplicationResponse value) throws IOException {
           ...
           @Override
           public RelianceOnboardingCreateApplicationResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RelianceOnboardingCreateApplicationResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RelianceOnboardingCreateApplicationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RelianceOnboardingCreateApplicationResponse
  * @throws IOException if the JSON string is invalid with respect to RelianceOnboardingCreateApplicationResponse
  */
  public static RelianceOnboardingCreateApplicationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelianceOnboardingCreateApplicationResponse.class);
  }

 /**
  * Convert an instance of RelianceOnboardingCreateApplicationResponse to an JSON string
  *
  * @return JSON string
  */
