...
public class AvailableBalanceProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AvailableBalanceProperty1() {
  }

  public AvailableBalanceProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AvailableBalanceProperty1 value(String value) {
  ...
  **/
   ...
   * @return the AvailableBalanceProperty1 instance itself
   */
  public AvailableBalanceProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailableBalanceProperty1 availableBalanceProperty1 = (AvailableBalanceProperty1) o;
    return Objects.equals(this.currency, availableBalanceProperty1.currency) &&
        Objects.equals(this.value, availableBalanceProperty1.value)&&
        Objects.equals(this.additionalProperties, availableBalanceProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableBalanceProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailableBalanceProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailableBalanceProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailableBalanceProperty1 is not found in the empty JSON string", AvailableBalanceProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailableBalanceProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailableBalanceProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailableBalanceProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailableBalanceProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailableBalanceProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailableBalanceProperty1>() {
           @Override
           public void write(JsonWriter out, AvailableBalanceProperty1 value) throws IOException {
           ...
           @Override
           public AvailableBalanceProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailableBalanceProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailableBalanceProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailableBalanceProperty1
  * @throws IOException if the JSON string is invalid with respect to AvailableBalanceProperty1
  */
  public static AvailableBalanceProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailableBalanceProperty1.class);
  }

 /**
  * Convert an instance of AvailableBalanceProperty1 to an JSON string
  *
  * @return JSON string
  */
