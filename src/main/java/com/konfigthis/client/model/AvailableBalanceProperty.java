...
public class AvailableBalanceProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AvailableBalanceProperty() {
  }

  public AvailableBalanceProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AvailableBalanceProperty value(String value) {
  ...
  **/
   ...
   * @return the AvailableBalanceProperty instance itself
   */
  public AvailableBalanceProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailableBalanceProperty availableBalanceProperty = (AvailableBalanceProperty) o;
    return Objects.equals(this.currency, availableBalanceProperty.currency) &&
        Objects.equals(this.value, availableBalanceProperty.value)&&
        Objects.equals(this.additionalProperties, availableBalanceProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableBalanceProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailableBalanceProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailableBalanceProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailableBalanceProperty is not found in the empty JSON string", AvailableBalanceProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailableBalanceProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailableBalanceProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailableBalanceProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailableBalanceProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailableBalanceProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailableBalanceProperty>() {
           @Override
           public void write(JsonWriter out, AvailableBalanceProperty value) throws IOException {
           ...
           @Override
           public AvailableBalanceProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailableBalanceProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailableBalanceProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailableBalanceProperty
  * @throws IOException if the JSON string is invalid with respect to AvailableBalanceProperty
  */
  public static AvailableBalanceProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailableBalanceProperty.class);
  }

 /**
  * Convert an instance of AvailableBalanceProperty to an JSON string
  *
  * @return JSON string
  */
