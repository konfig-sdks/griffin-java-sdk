...
public class DecisionsCreateDecisionRequest {
 ...
 public enum DecisionOutcomeEnum {
  ...
  public DecisionsCreateDecisionRequest() {
  }

  public DecisionsCreateDecisionRequest verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public DecisionsCreateDecisionRequest decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public DecisionsCreateDecisionRequest decisionNotes(String decisionNotes) {
  ...
  **/
   ...
   * @return the DecisionsCreateDecisionRequest instance itself
   */
  public DecisionsCreateDecisionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DecisionsCreateDecisionRequest decisionsCreateDecisionRequest = (DecisionsCreateDecisionRequest) o;
    return Objects.equals(this.verificationUrl, decisionsCreateDecisionRequest.verificationUrl) &&
        Objects.equals(this.decisionOutcome, decisionsCreateDecisionRequest.decisionOutcome) &&
        Objects.equals(this.decisionNotes, decisionsCreateDecisionRequest.decisionNotes)&&
        Objects.equals(this.additionalProperties, decisionsCreateDecisionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verificationUrl, decisionOutcome, decisionNotes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DecisionsCreateDecisionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecisionsCreateDecisionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DecisionsCreateDecisionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DecisionsCreateDecisionRequest is not found in the empty JSON string", DecisionsCreateDecisionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DecisionsCreateDecisionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DecisionsCreateDecisionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DecisionsCreateDecisionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DecisionsCreateDecisionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DecisionsCreateDecisionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DecisionsCreateDecisionRequest>() {
           @Override
           public void write(JsonWriter out, DecisionsCreateDecisionRequest value) throws IOException {
           ...
           @Override
           public DecisionsCreateDecisionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DecisionsCreateDecisionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DecisionsCreateDecisionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecisionsCreateDecisionRequest
  * @throws IOException if the JSON string is invalid with respect to DecisionsCreateDecisionRequest
  */
  public static DecisionsCreateDecisionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecisionsCreateDecisionRequest.class);
  }

 /**
  * Convert an instance of DecisionsCreateDecisionRequest to an JSON string
  *
  * @return JSON string
  */
