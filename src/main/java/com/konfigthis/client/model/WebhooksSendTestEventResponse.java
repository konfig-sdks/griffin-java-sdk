...
public class WebhooksSendTestEventResponse {
  /**
 ...
 public enum WebhookErrorCodeEnum {
  ...
  public WebhooksSendTestEventResponse() {
  }

  public WebhooksSendTestEventResponse webhookRequestStatus(WebhookRequestStatusEnum webhookRequestStatus) {
  ...
  **/
  ...
  public WebhooksSendTestEventResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public WebhooksSendTestEventResponse webhookHttpStatus(Long webhookHttpStatus) {
  ...
  **/
  ...
  public WebhooksSendTestEventResponse webhookErrorCode(WebhookErrorCodeEnum webhookErrorCode) {
  ...
  **/
   ...
   * @return the WebhooksSendTestEventResponse instance itself
   */
  public WebhooksSendTestEventResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksSendTestEventResponse webhooksSendTestEventResponse = (WebhooksSendTestEventResponse) o;
    return Objects.equals(this.webhookRequestStatus, webhooksSendTestEventResponse.webhookRequestStatus) &&
        Objects.equals(this.updatedAt, webhooksSendTestEventResponse.updatedAt) &&
        Objects.equals(this.webhookHttpStatus, webhooksSendTestEventResponse.webhookHttpStatus) &&
        Objects.equals(this.webhookErrorCode, webhooksSendTestEventResponse.webhookErrorCode)&&
        Objects.equals(this.additionalProperties, webhooksSendTestEventResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksSendTestEventResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksSendTestEventResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksSendTestEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksSendTestEventResponse is not found in the empty JSON string", WebhooksSendTestEventResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksSendTestEventResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksSendTestEventResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksSendTestEventResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksSendTestEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksSendTestEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksSendTestEventResponse>() {
           @Override
           public void write(JsonWriter out, WebhooksSendTestEventResponse value) throws IOException {
           ...
           @Override
           public WebhooksSendTestEventResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksSendTestEventResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksSendTestEventResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksSendTestEventResponse
  * @throws IOException if the JSON string is invalid with respect to WebhooksSendTestEventResponse
  */
  public static WebhooksSendTestEventResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksSendTestEventResponse.class);
  }

 /**
  * Convert an instance of WebhooksSendTestEventResponse to an JSON string
  *
  * @return JSON string
  */
