...
import com.konfigthis.client.model.Verification1;
...
public class VerificationsListForLegalPersonResponse {
  public static final String SERIALIZED_NAME_VERIFICATIONS = "verifications";
  @SerializedName(SERIALIZED_NAME_VERIFICATIONS)
  private List<Verification1> verifications = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private LinksProperty links;

  public VerificationsListForLegalPersonResponse() {
  }

  public VerificationsListForLegalPersonResponse verifications(List<Verification1> verifications) {
  ...
  public VerificationsListForLegalPersonResponse addVerificationsItem(Verification1 verificationsItem) {
  ...
  **/
  ...
  public List<Verification1> getVerifications() {
    return verifications;
  }


  public void setVerifications(List<Verification1> verifications) {
  ...
  public VerificationsListForLegalPersonResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the VerificationsListForLegalPersonResponse instance itself
   */
  public VerificationsListForLegalPersonResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VerificationsListForLegalPersonResponse verificationsListForLegalPersonResponse = (VerificationsListForLegalPersonResponse) o;
    return Objects.equals(this.verifications, verificationsListForLegalPersonResponse.verifications) &&
        Objects.equals(this.links, verificationsListForLegalPersonResponse.links)&&
        Objects.equals(this.additionalProperties, verificationsListForLegalPersonResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verifications, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerificationsListForLegalPersonResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VerificationsListForLegalPersonResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VerificationsListForLegalPersonResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationsListForLegalPersonResponse is not found in the empty JSON string", VerificationsListForLegalPersonResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerificationsListForLegalPersonResponse.openapiRequiredFields) {
      ...
      // validate the required field `verifications` (array)
      for (int i = 0; i < jsonArrayverifications.size(); i++) {
        Verification1.validateJsonObject(jsonArrayverifications.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerificationsListForLegalPersonResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerificationsListForLegalPersonResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerificationsListForLegalPersonResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerificationsListForLegalPersonResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VerificationsListForLegalPersonResponse>() {
           @Override
           public void write(JsonWriter out, VerificationsListForLegalPersonResponse value) throws IOException {
           ...
           @Override
           public VerificationsListForLegalPersonResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VerificationsListForLegalPersonResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VerificationsListForLegalPersonResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VerificationsListForLegalPersonResponse
  * @throws IOException if the JSON string is invalid with respect to VerificationsListForLegalPersonResponse
  */
  public static VerificationsListForLegalPersonResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerificationsListForLegalPersonResponse.class);
  }

 /**
  * Convert an instance of VerificationsListForLegalPersonResponse to an JSON string
  *
  * @return JSON string
  */
