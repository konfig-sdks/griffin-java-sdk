...
public class AccountBalanceProperty3 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty3() {
  }

  public AccountBalanceProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty3 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty3 instance itself
   */
  public AccountBalanceProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty3 accountBalanceProperty3 = (AccountBalanceProperty3) o;
    return Objects.equals(this.currency, accountBalanceProperty3.currency) &&
        Objects.equals(this.value, accountBalanceProperty3.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty3 is not found in the empty JSON string", AccountBalanceProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty3>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty3 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty3
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty3
  */
  public static AccountBalanceProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty3.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty3 to an JSON string
  *
  * @return JSON string
  */
