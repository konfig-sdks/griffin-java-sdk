...
public class EventsGetEventResponse {
 ...
 public enum EventTypeEnum {
  ...
  public EventsGetEventResponse() {
  }

  public EventsGetEventResponse eventUrl(String eventUrl) {
  ...
  **/
  ...
  public EventsGetEventResponse eventType(EventTypeEnum eventType) {
  ...
  **/
  ...
  public EventsGetEventResponse eventPayload(Object eventPayload) {
  ...
  **/
  ...
  public EventsGetEventResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the EventsGetEventResponse instance itself
   */
  public EventsGetEventResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsGetEventResponse eventsGetEventResponse = (EventsGetEventResponse) o;
    return Objects.equals(this.eventUrl, eventsGetEventResponse.eventUrl) &&
        Objects.equals(this.eventType, eventsGetEventResponse.eventType) &&
        Objects.equals(this.eventPayload, eventsGetEventResponse.eventPayload) &&
        Objects.equals(this.createdAt, eventsGetEventResponse.createdAt)&&
        Objects.equals(this.additionalProperties, eventsGetEventResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsGetEventResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsGetEventResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsGetEventResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsGetEventResponse is not found in the empty JSON string", EventsGetEventResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsGetEventResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsGetEventResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsGetEventResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsGetEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsGetEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsGetEventResponse>() {
           @Override
           public void write(JsonWriter out, EventsGetEventResponse value) throws IOException {
           ...
           @Override
           public EventsGetEventResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsGetEventResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsGetEventResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsGetEventResponse
  * @throws IOException if the JSON string is invalid with respect to EventsGetEventResponse
  */
  public static EventsGetEventResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsGetEventResponse.class);
  }

 /**
  * Convert an instance of EventsGetEventResponse to an JSON string
  *
  * @return JSON string
  */
