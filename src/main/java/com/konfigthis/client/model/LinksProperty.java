...
public class LinksProperty {
  ...
  public LinksProperty prev(String prev) {
  ...
  **/
  ...
  public LinksProperty next(String next) {
  ...
  **/
   ...
   * @return the LinksProperty instance itself
   */
  public LinksProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LinksProperty linksProperty = (LinksProperty) o;
    return Objects.equals(this.prev, linksProperty.prev) &&
        Objects.equals(this.next, linksProperty.next)&&
        Objects.equals(this.additionalProperties, linksProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prev, next, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinksProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinksProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinksProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinksProperty is not found in the empty JSON string", LinksProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinksProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinksProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinksProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinksProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinksProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LinksProperty>() {
           @Override
           public void write(JsonWriter out, LinksProperty value) throws IOException {
           ...
           @Override
           public LinksProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinksProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LinksProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinksProperty
  * @throws IOException if the JSON string is invalid with respect to LinksProperty
  */
  public static LinksProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinksProperty.class);
  }

 /**
  * Convert an instance of LinksProperty to an JSON string
  *
  * @return JSON string
  */
