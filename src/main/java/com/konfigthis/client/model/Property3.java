...
import com.konfigthis.client.model.RiskRatingEntry1;
import com.konfigthis.client.model.Verification2;
 ...
 */
@ApiModel(description = "Present only when the request uses the `include` parameter.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Property3 {
  ...
  private List<Verification2> verifications = null;

  public static final String SERIALIZED_NAME_RISK_RATING_ENTRIES = "risk-rating-entries";
  @SerializedName(SERIALIZED_NAME_RISK_RATING_ENTRIES)
  private List<RiskRatingEntry1> riskRatingEntries = null;

  public Property3() {
  }

  public Property3 verifications(List<Verification2> verifications) {
  ...
  public Property3 addVerificationsItem(Verification2 verificationsItem) {
  ...
  **/
  ...
  public List<Verification2> getVerifications() {
    return verifications;
  }


  public void setVerifications(List<Verification2> verifications) {
  ...
  public Property3 riskRatingEntries(List<RiskRatingEntry1> riskRatingEntries) {
    
    
    
    
    this.riskRatingEntries = riskRatingEntries;
    return this;
  }

  public Property3 addRiskRatingEntriesItem(RiskRatingEntry1 riskRatingEntriesItem) {
    if (this.riskRatingEntries == null) {
      this.riskRatingEntries = new ArrayList<>();
    }
    this.riskRatingEntries.add(riskRatingEntriesItem);
    return this;
  }

   /**
   * Get riskRatingEntries
   * @return riskRatingEntries
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<RiskRatingEntry1> getRiskRatingEntries() {
    return riskRatingEntries;
  }


  public void setRiskRatingEntries(List<RiskRatingEntry1> riskRatingEntries) {
   ...
   * @return the Property3 instance itself
   */
  public Property3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Property3 property3 = (Property3) o;
    return Objects.equals(this.verifications, property3.verifications) &&
        Objects.equals(this.riskRatingEntries, property3.riskRatingEntries)&&
        Objects.equals(this.additionalProperties, property3.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verifications, riskRatingEntries, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Property3 {\n");
    sb.append("    verifications: ").append(toIndentedString(verifications)).append("\n");
    sb.append("    riskRatingEntries: ").append(toIndentedString(riskRatingEntries)).append("\n");
  ...
  static {
    ...
    openapiFields.add("risk-rating-entries");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Property3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Property3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Property3 is not found in the empty JSON string", Property3.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("verifications") != null && !jsonObj.get("verifications").isJsonNull()) {
        ...
        if (jsonArrayverifications != null) {
          ...
          for (int i = 0; i < jsonArrayverifications.size(); i++) {
            Verification2.validateJsonObject(jsonArrayverifications.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("risk-rating-entries") != null && !jsonObj.get("risk-rating-entries").isJsonNull()) {
        JsonArray jsonArrayriskRatingEntries = jsonObj.getAsJsonArray("risk-rating-entries");
        if (jsonArrayriskRatingEntries != null) {
          // ensure the json data is an array
          if (!jsonObj.get("risk-rating-entries").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `risk-rating-entries` to be an array in the JSON string but got `%s`", jsonObj.get("risk-rating-entries").toString()));
          }

          // validate the optional field `risk-rating-entries` (array)
          for (int i = 0; i < jsonArrayriskRatingEntries.size(); i++) {
            RiskRatingEntry1.validateJsonObject(jsonArrayriskRatingEntries.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Property3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Property3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Property3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Property3.class));

       return (TypeAdapter<T>) new TypeAdapter<Property3>() {
           @Override
           public void write(JsonWriter out, Property3 value) throws IOException {
           ...
           @Override
           public Property3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Property3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Property3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Property3
  * @throws IOException if the JSON string is invalid with respect to Property3
  */
  public static Property3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Property3.class);
  }

 /**
  * Convert an instance of Property3 to an JSON string
  *
  * @return JSON string
  */
