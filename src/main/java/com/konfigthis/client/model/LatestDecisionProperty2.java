...
public class LatestDecisionProperty2 {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public LatestDecisionProperty2() {
  }

  public LatestDecisionProperty2 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public LatestDecisionProperty2 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public LatestDecisionProperty2 decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the LatestDecisionProperty2 instance itself
   */
  public LatestDecisionProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LatestDecisionProperty2 latestDecisionProperty2 = (LatestDecisionProperty2) o;
    return Objects.equals(this.verificationUrl, latestDecisionProperty2.verificationUrl) &&
        Objects.equals(this.decisionOutcome, latestDecisionProperty2.decisionOutcome) &&
        Objects.equals(this.decisionMaker, latestDecisionProperty2.decisionMaker) &&
        Objects.equals(this.decisionNotes, latestDecisionProperty2.decisionNotes) &&
        Objects.equals(this.createdAt, latestDecisionProperty2.createdAt) &&
        Objects.equals(this.decisionUserUrl, latestDecisionProperty2.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, latestDecisionProperty2.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, latestDecisionProperty2.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, latestDecisionProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LatestDecisionProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LatestDecisionProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LatestDecisionProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatestDecisionProperty2 is not found in the empty JSON string", LatestDecisionProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LatestDecisionProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatestDecisionProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatestDecisionProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatestDecisionProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatestDecisionProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<LatestDecisionProperty2>() {
           @Override
           public void write(JsonWriter out, LatestDecisionProperty2 value) throws IOException {
           ...
           @Override
           public LatestDecisionProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LatestDecisionProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LatestDecisionProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LatestDecisionProperty2
  * @throws IOException if the JSON string is invalid with respect to LatestDecisionProperty2
  */
  public static LatestDecisionProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatestDecisionProperty2.class);
  }

 /**
  * Convert an instance of LatestDecisionProperty2 to an JSON string
  *
  * @return JSON string
  */
