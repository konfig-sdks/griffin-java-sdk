...
public class DebtorProperty {
 ...
 public enum BankIdCodeEnum {
  ...
  public DebtorProperty() {
  }

  public DebtorProperty accountNumber(String accountNumber) {
  ...
  **/
  ...
  public DebtorProperty accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public DebtorProperty bankId(String bankId) {
  ...
  **/
  ...
  public DebtorProperty bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public DebtorProperty accountHolder(String accountHolder) {
  ...
  **/
  ...
  public DebtorProperty accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the DebtorProperty instance itself
   */
  public DebtorProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DebtorProperty debtorProperty = (DebtorProperty) o;
    return Objects.equals(this.accountNumber, debtorProperty.accountNumber) &&
        Objects.equals(this.accountNumberCode, debtorProperty.accountNumberCode) &&
        Objects.equals(this.bankId, debtorProperty.bankId) &&
        Objects.equals(this.bankIdCode, debtorProperty.bankIdCode) &&
        Objects.equals(this.accountHolder, debtorProperty.accountHolder) &&
        Objects.equals(this.accountUrl, debtorProperty.accountUrl)&&
        Objects.equals(this.additionalProperties, debtorProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtorProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DebtorProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DebtorProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DebtorProperty is not found in the empty JSON string", DebtorProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DebtorProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DebtorProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DebtorProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DebtorProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebtorProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<DebtorProperty>() {
           @Override
           public void write(JsonWriter out, DebtorProperty value) throws IOException {
           ...
           @Override
           public DebtorProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DebtorProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DebtorProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DebtorProperty
  * @throws IOException if the JSON string is invalid with respect to DebtorProperty
  */
  public static DebtorProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DebtorProperty.class);
  }

 /**
  * Convert an instance of DebtorProperty to an JSON string
  *
  * @return JSON string
  */
