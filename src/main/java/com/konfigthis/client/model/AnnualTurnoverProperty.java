...
/**
 * AnnualTurnoverProperty
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AnnualTurnoverProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty() {
  }

  public AnnualTurnoverProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty instance itself
   */
  public AnnualTurnoverProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty annualTurnoverProperty = (AnnualTurnoverProperty) o;
    return Objects.equals(this.currency, annualTurnoverProperty.currency) &&
        Objects.equals(this.value, annualTurnoverProperty.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty is not found in the empty JSON string", AnnualTurnoverProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty
  */
  public static AnnualTurnoverProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty to an JSON string
  *
  * @return JSON string
  */
