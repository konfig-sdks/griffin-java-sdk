...
public class Verification2 {
 ...
 public enum VerificationStatusEnum {
  ...
  public Verification2 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public Verification2 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Verification2 legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public Verification2 workflowUrl(String workflowUrl) {
  ...
  **/
  ...
  public Verification2 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Verification2 verificationChecksUrl(String verificationChecksUrl) {
  ...
  **/
  ...
  public Verification2 riskRating(RiskRatingEnum riskRating) {
  ...
  **/
  ...
  public Verification2 verificationStatus(VerificationStatusEnum verificationStatus) {
  ...
  **/
  ...
  public Verification2 verificationRiskAssessmentsUrl(String verificationRiskAssessmentsUrl) {
  ...
  **/
   ...
   * @return the Verification2 instance itself
   */
  public Verification2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Verification2 verification2 = (Verification2) o;
    return Objects.equals(this.verificationUrl, verification2.verificationUrl) &&
        Objects.equals(this.updatedAt, verification2.updatedAt) &&
        Objects.equals(this.legalPersonUrl, verification2.legalPersonUrl) &&
        Objects.equals(this.workflowUrl, verification2.workflowUrl) &&
        Objects.equals(this.createdAt, verification2.createdAt) &&
        Objects.equals(this.verificationChecksUrl, verification2.verificationChecksUrl) &&
        Objects.equals(this.riskRating, verification2.riskRating) &&
        Objects.equals(this.verificationStatus, verification2.verificationStatus) &&
        Objects.equals(this.verificationRiskAssessmentsUrl, verification2.verificationRiskAssessmentsUrl)&&
        Objects.equals(this.additionalProperties, verification2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Verification2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Verification2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Verification2 is not found in the empty JSON string", Verification2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Verification2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Verification2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Verification2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Verification2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Verification2.class));

       return (TypeAdapter<T>) new TypeAdapter<Verification2>() {
           @Override
           public void write(JsonWriter out, Verification2 value) throws IOException {
           ...
           @Override
           public Verification2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Verification2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Verification2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Verification2
  * @throws IOException if the JSON string is invalid with respect to Verification2
  */
  public static Verification2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Verification2.class);
  }

 /**
  * Convert an instance of Verification2 to an JSON string
  *
  * @return JSON string
  */
