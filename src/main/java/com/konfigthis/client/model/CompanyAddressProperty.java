...
public class CompanyAddressProperty {
  ...
  public CompanyAddressProperty() {
  }

  public CompanyAddressProperty buildingNumber(String buildingNumber) {
  ...
  **/
  ...
  public CompanyAddressProperty streetName(String streetName) {
  ...
  **/
  ...
  public CompanyAddressProperty city(String city) {
  ...
  **/
  ...
  public CompanyAddressProperty postalCode(String postalCode) {
  ...
  **/
  ...
  public CompanyAddressProperty countryCode(Object countryCode) {
  ...
  **/
   ...
   * @return the CompanyAddressProperty instance itself
   */
  public CompanyAddressProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyAddressProperty companyAddressProperty = (CompanyAddressProperty) o;
    return Objects.equals(this.buildingNumber, companyAddressProperty.buildingNumber) &&
        Objects.equals(this.streetName, companyAddressProperty.streetName) &&
        Objects.equals(this.city, companyAddressProperty.city) &&
        Objects.equals(this.postalCode, companyAddressProperty.postalCode) &&
        Objects.equals(this.countryCode, companyAddressProperty.countryCode)&&
        Objects.equals(this.additionalProperties, companyAddressProperty.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildingNumber, streetName, city, postalCode, countryCode, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyAddressProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyAddressProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyAddressProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyAddressProperty is not found in the empty JSON string", CompanyAddressProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyAddressProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyAddressProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyAddressProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyAddressProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyAddressProperty>() {
           @Override
           public void write(JsonWriter out, CompanyAddressProperty value) throws IOException {
           ...
           @Override
           public CompanyAddressProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyAddressProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyAddressProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyAddressProperty
  * @throws IOException if the JSON string is invalid with respect to CompanyAddressProperty
  */
  public static CompanyAddressProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyAddressProperty.class);
  }

 /**
  * Convert an instance of CompanyAddressProperty to an JSON string
  *
  * @return JSON string
  */
