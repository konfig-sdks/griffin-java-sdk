...
public class RolesAssignMembershipRolesRequest {
  public static final String SERIALIZED_NAME_ROLE_URLS = "role-urls";
  @SerializedName(SERIALIZED_NAME_ROLE_URLS)
  private List<String> roleUrls = new ArrayList<>();

  public RolesAssignMembershipRolesRequest() {
  }

  public RolesAssignMembershipRolesRequest roleUrls(List<String> roleUrls) {
  ...
  public RolesAssignMembershipRolesRequest addRoleUrlsItem(String roleUrlsItem) {
    this.roleUrls.add(roleUrlsItem);
    return this;
  }
  ...
  **/
  ...
  public void setRoleUrls(List<String> roleUrls) {
   ...
   * @return the RolesAssignMembershipRolesRequest instance itself
   */
  public RolesAssignMembershipRolesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RolesAssignMembershipRolesRequest rolesAssignMembershipRolesRequest = (RolesAssignMembershipRolesRequest) o;
    return Objects.equals(this.roleUrls, rolesAssignMembershipRolesRequest.roleUrls)&&
        Objects.equals(this.additionalProperties, rolesAssignMembershipRolesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(roleUrls, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RolesAssignMembershipRolesRequest {\n");
    sb.append("    roleUrls: ").append(toIndentedString(roleUrls)).append("\n");
  ...
  static {
    ...
    openapiFields.add("role-urls");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("role-urls");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RolesAssignMembershipRolesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RolesAssignMembershipRolesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RolesAssignMembershipRolesRequest is not found in the empty JSON string", RolesAssignMembershipRolesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RolesAssignMembershipRolesRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the required json array is present
      if (jsonObj.get("role-urls") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("role-urls").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `role-urls` to be an array in the JSON string but got `%s`", jsonObj.get("role-urls").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RolesAssignMembershipRolesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RolesAssignMembershipRolesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RolesAssignMembershipRolesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RolesAssignMembershipRolesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RolesAssignMembershipRolesRequest>() {
           @Override
           public void write(JsonWriter out, RolesAssignMembershipRolesRequest value) throws IOException {
           ...
           @Override
           public RolesAssignMembershipRolesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RolesAssignMembershipRolesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RolesAssignMembershipRolesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RolesAssignMembershipRolesRequest
  * @throws IOException if the JSON string is invalid with respect to RolesAssignMembershipRolesRequest
  */
  public static RolesAssignMembershipRolesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RolesAssignMembershipRolesRequest.class);
  }

 /**
  * Convert an instance of RolesAssignMembershipRolesRequest to an JSON string
  *
  * @return JSON string
  */
