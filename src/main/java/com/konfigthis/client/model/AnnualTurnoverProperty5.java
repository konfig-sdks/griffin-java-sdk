...
/**
 * AnnualTurnoverProperty5
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AnnualTurnoverProperty5 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty5() {
  }

  public AnnualTurnoverProperty5 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty5 value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty5 instance itself
   */
  public AnnualTurnoverProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty5 annualTurnoverProperty5 = (AnnualTurnoverProperty5) o;
    return Objects.equals(this.currency, annualTurnoverProperty5.currency) &&
        Objects.equals(this.value, annualTurnoverProperty5.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty5 is not found in the empty JSON string", AnnualTurnoverProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty5>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty5 value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty5
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty5
  */
  public static AnnualTurnoverProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty5.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty5 to an JSON string
  *
  * @return JSON string
  */
