...
public class PaymentAmountProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public PaymentAmountProperty() {
  }

  public PaymentAmountProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public PaymentAmountProperty value(String value) {
  ...
  **/
   ...
   * @return the PaymentAmountProperty instance itself
   */
  public PaymentAmountProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentAmountProperty paymentAmountProperty = (PaymentAmountProperty) o;
    return Objects.equals(this.currency, paymentAmountProperty.currency) &&
        Objects.equals(this.value, paymentAmountProperty.value)&&
        Objects.equals(this.additionalProperties, paymentAmountProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAmountProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAmountProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAmountProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountProperty is not found in the empty JSON string", PaymentAmountProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountProperty>() {
           @Override
           public void write(JsonWriter out, PaymentAmountProperty value) throws IOException {
           ...
           @Override
           public PaymentAmountProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentAmountProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentAmountProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAmountProperty
  * @throws IOException if the JSON string is invalid with respect to PaymentAmountProperty
  */
  public static PaymentAmountProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountProperty.class);
  }

 /**
  * Convert an instance of PaymentAmountProperty to an JSON string
  *
  * @return JSON string
  */
