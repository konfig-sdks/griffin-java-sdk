...
public class PayeesRegisterNewPayeeResponse {
 ...
 public enum PayeeStatusEnum {
  ...
  public PayeesRegisterNewPayeeResponse() {
  }

  public PayeesRegisterNewPayeeResponse payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse bankId(String bankId) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse payeeStatus(PayeeStatusEnum payeeStatus) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeResponse countryCode(Object countryCode) {
  ...
  **/
   ...
   * @return the PayeesRegisterNewPayeeResponse instance itself
   */
  public PayeesRegisterNewPayeeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeesRegisterNewPayeeResponse payeesRegisterNewPayeeResponse = (PayeesRegisterNewPayeeResponse) o;
    return Objects.equals(this.payeeUrl, payeesRegisterNewPayeeResponse.payeeUrl) &&
        Objects.equals(this.accountNumber, payeesRegisterNewPayeeResponse.accountNumber) &&
        Objects.equals(this.accountHolder, payeesRegisterNewPayeeResponse.accountHolder) &&
        Objects.equals(this.legalPersonUrl, payeesRegisterNewPayeeResponse.legalPersonUrl) &&
        Objects.equals(this.bankId, payeesRegisterNewPayeeResponse.bankId) &&
        Objects.equals(this.createdAt, payeesRegisterNewPayeeResponse.createdAt) &&
        Objects.equals(this.accountUrl, payeesRegisterNewPayeeResponse.accountUrl) &&
        Objects.equals(this.payeeStatus, payeesRegisterNewPayeeResponse.payeeStatus) &&
        Objects.equals(this.countryCode, payeesRegisterNewPayeeResponse.countryCode)&&
        Objects.equals(this.additionalProperties, payeesRegisterNewPayeeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayeesRegisterNewPayeeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeesRegisterNewPayeeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeesRegisterNewPayeeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeesRegisterNewPayeeResponse is not found in the empty JSON string", PayeesRegisterNewPayeeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeesRegisterNewPayeeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeesRegisterNewPayeeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeesRegisterNewPayeeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeesRegisterNewPayeeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeesRegisterNewPayeeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeesRegisterNewPayeeResponse>() {
           @Override
           public void write(JsonWriter out, PayeesRegisterNewPayeeResponse value) throws IOException {
           ...
           @Override
           public PayeesRegisterNewPayeeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeesRegisterNewPayeeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeesRegisterNewPayeeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeesRegisterNewPayeeResponse
  * @throws IOException if the JSON string is invalid with respect to PayeesRegisterNewPayeeResponse
  */
  public static PayeesRegisterNewPayeeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeesRegisterNewPayeeResponse.class);
  }

 /**
  * Convert an instance of PayeesRegisterNewPayeeResponse to an JSON string
  *
  * @return JSON string
  */
