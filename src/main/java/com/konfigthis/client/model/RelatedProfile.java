...
import com.konfigthis.client.model.MobileNumber2;
import com.konfigthis.client.model.SubjectAssociationProperty;
...
public class RelatedProfile {
  ...
  public static final String SERIALIZED_NAME_SUBJECT_ASSOCIATION = "subject-association";
  @SerializedName(SERIALIZED_NAME_SUBJECT_ASSOCIATION)
  private SubjectAssociationProperty subjectAssociation;

  public static final String SERIALIZED_NAME_CLAIMS = "claims";
  @SerializedName(SERIALIZED_NAME_CLAIMS)
  private List<MobileNumber2> claims = new ArrayList<>();

  public RelatedProfile() {
  }

  public RelatedProfile displayName(String displayName) {
  ...
  **/
  ...
  public RelatedProfile subjectAssociation(SubjectAssociationProperty subjectAssociation) {
   ...
   /**
   * Get subjectAssociation
   * @return subjectAssociation
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public SubjectAssociationProperty getSubjectAssociation() {
    return subjectAssociation;
  }


  public void setSubjectAssociation(SubjectAssociationProperty subjectAssociation) {
  ...
  public RelatedProfile claims(List<MobileNumber2> claims) {
  ...
  public RelatedProfile addClaimsItem(MobileNumber2 claimsItem) {
  ...
  **/
  ...
  public List<MobileNumber2> getClaims() {
    return claims;
  }


  public void setClaims(List<MobileNumber2> claims) {
   ...
   * @return the RelatedProfile instance itself
   */
  public RelatedProfile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedProfile relatedProfile = (RelatedProfile) o;
    return Objects.equals(this.displayName, relatedProfile.displayName) &&
        Objects.equals(this.subjectAssociation, relatedProfile.subjectAssociation) &&
        Objects.equals(this.claims, relatedProfile.claims)&&
        Objects.equals(this.additionalProperties, relatedProfile.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, subjectAssociation, claims, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RelatedProfile {\n");
    sb.append("    displayName: ").append(toIndentedString(displayName)).append("\n");
    sb.append("    subjectAssociation: ").append(toIndentedString(subjectAssociation)).append("\n");
  ...
  static {
    ...
    openapiFields.add("subject-association");
    openapiFields.add("claims");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("display-name");
    openapiRequiredFields.add("subject-association");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RelatedProfile
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RelatedProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RelatedProfile is not found in the empty JSON string", RelatedProfile.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelatedProfile.openapiRequiredFields) {
      ...
      // validate the required field `subject-association`
      SubjectAssociationProperty.validateJsonObject(jsonObj.getAsJsonObject("subject-association"));
      ...
      for (int i = 0; i < jsonArrayclaims.size(); i++) {
        MobileNumber2.validateJsonObject(jsonArrayclaims.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedProfile>() {
           @Override
           public void write(JsonWriter out, RelatedProfile value) throws IOException {
           ...
           @Override
           public RelatedProfile read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RelatedProfile instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RelatedProfile given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RelatedProfile
  * @throws IOException if the JSON string is invalid with respect to RelatedProfile
  */
  public static RelatedProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedProfile.class);
  }

 /**
  * Convert an instance of RelatedProfile to an JSON string
  *
  * @return JSON string
  */
