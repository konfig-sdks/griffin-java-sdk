...
public class IncomeProperty2 {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty2() {
  }

  public IncomeProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty2 value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty2 instance itself
   */
  public IncomeProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty2 incomeProperty2 = (IncomeProperty2) o;
    return Objects.equals(this.currency, incomeProperty2.currency) &&
        Objects.equals(this.value, incomeProperty2.value)&&
        Objects.equals(this.additionalProperties, incomeProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty2 is not found in the empty JSON string", IncomeProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty2>() {
           @Override
           public void write(JsonWriter out, IncomeProperty2 value) throws IOException {
           ...
           @Override
           public IncomeProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty2
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty2
  */
  public static IncomeProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty2.class);
  }

 /**
  * Convert an instance of IncomeProperty2 to an JSON string
  *
  * @return JSON string
  */
