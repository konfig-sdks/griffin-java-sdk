...
public class PaymentAmountProperty3 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public PaymentAmountProperty3() {
  }

  public PaymentAmountProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public PaymentAmountProperty3 value(String value) {
  ...
  **/
   ...
   * @return the PaymentAmountProperty3 instance itself
   */
  public PaymentAmountProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentAmountProperty3 paymentAmountProperty3 = (PaymentAmountProperty3) o;
    return Objects.equals(this.currency, paymentAmountProperty3.currency) &&
        Objects.equals(this.value, paymentAmountProperty3.value)&&
        Objects.equals(this.additionalProperties, paymentAmountProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAmountProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAmountProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAmountProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountProperty3 is not found in the empty JSON string", PaymentAmountProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountProperty3>() {
           @Override
           public void write(JsonWriter out, PaymentAmountProperty3 value) throws IOException {
           ...
           @Override
           public PaymentAmountProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentAmountProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentAmountProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAmountProperty3
  * @throws IOException if the JSON string is invalid with respect to PaymentAmountProperty3
  */
  public static PaymentAmountProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountProperty3.class);
  }

 /**
  * Convert an instance of PaymentAmountProperty3 to an JSON string
  *
  * @return JSON string
  */
