...
public class OpsUserProperty {
  /**
   * Gets or Sets manuallyCreatedByType
   */
  @JsonAdapter(ManuallyCreatedByTypeEnum.Adapter.class)
 public enum ManuallyCreatedByTypeEnum {
    OPS_USER("ops-user");

    private String value;

    ManuallyCreatedByTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static ManuallyCreatedByTypeEnum fromValue(String value) {
      for (ManuallyCreatedByTypeEnum b : ManuallyCreatedByTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ManuallyCreatedByTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ManuallyCreatedByTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ManuallyCreatedByTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ManuallyCreatedByTypeEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_MANUALLY_CREATED_BY_TYPE = "manually-created-by-type";
  @SerializedName(SERIALIZED_NAME_MANUALLY_CREATED_BY_TYPE)
  private ManuallyCreatedByTypeEnum manuallyCreatedByType;

  public OpsUserProperty() {
  }

  public OpsUserProperty manuallyCreatedByType(ManuallyCreatedByTypeEnum manuallyCreatedByType) {
    
    
    
    
    this.manuallyCreatedByType = manuallyCreatedByType;
    return this;
  }

   /**
   * Get manuallyCreatedByType
   * @return manuallyCreatedByType
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public ManuallyCreatedByTypeEnum getManuallyCreatedByType() {
    return manuallyCreatedByType;
  }


  public void setManuallyCreatedByType(ManuallyCreatedByTypeEnum manuallyCreatedByType) {
   ...
   * @return the OpsUserProperty instance itself
   */
  public OpsUserProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpsUserProperty opsUserProperty = (OpsUserProperty) o;
    return Objects.equals(this.manuallyCreatedByType, opsUserProperty.manuallyCreatedByType)&&
        Objects.equals(this.additionalProperties, opsUserProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(manuallyCreatedByType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpsUserProperty {\n");
    sb.append("    manuallyCreatedByType: ").append(toIndentedString(manuallyCreatedByType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("manually-created-by-type");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("manually-created-by-type");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpsUserProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpsUserProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpsUserProperty is not found in the empty JSON string", OpsUserProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpsUserProperty.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("manually-created-by-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `manually-created-by-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manually-created-by-type").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpsUserProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpsUserProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpsUserProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpsUserProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<OpsUserProperty>() {
           @Override
           public void write(JsonWriter out, OpsUserProperty value) throws IOException {
           ...
           @Override
           public OpsUserProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OpsUserProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OpsUserProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OpsUserProperty
  * @throws IOException if the JSON string is invalid with respect to OpsUserProperty
  */
  public static OpsUserProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpsUserProperty.class);
  }

 /**
  * Convert an instance of OpsUserProperty to an JSON string
  *
  * @return JSON string
  */
