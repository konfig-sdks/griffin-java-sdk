...
public class BankAddress1 {
 ...
 public enum AccountNumberCodeEnum {
  ...
  public BankAddress1 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public BankAddress1 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public BankAddress1 bankId(String bankId) {
  ...
  **/
  ...
  public BankAddress1 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public BankAddress1 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
   ...
   * @return the BankAddress1 instance itself
   */
  public BankAddress1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAddress1 bankAddress1 = (BankAddress1) o;
    return Objects.equals(this.accountHolder, bankAddress1.accountHolder) &&
        Objects.equals(this.bankIdCode, bankAddress1.bankIdCode) &&
        Objects.equals(this.bankId, bankAddress1.bankId) &&
        Objects.equals(this.accountNumber, bankAddress1.accountNumber) &&
        Objects.equals(this.accountNumberCode, bankAddress1.accountNumberCode)&&
        Objects.equals(this.additionalProperties, bankAddress1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAddress1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAddress1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAddress1 is not found in the empty JSON string", BankAddress1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAddress1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAddress1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAddress1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAddress1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAddress1.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAddress1>() {
           @Override
           public void write(JsonWriter out, BankAddress1 value) throws IOException {
           ...
           @Override
           public BankAddress1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAddress1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAddress1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAddress1
  * @throws IOException if the JSON string is invalid with respect to BankAddress1
  */
  public static BankAddress1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAddress1.class);
  }

 /**
  * Convert an instance of BankAddress1 to an JSON string
  *
  * @return JSON string
  */
