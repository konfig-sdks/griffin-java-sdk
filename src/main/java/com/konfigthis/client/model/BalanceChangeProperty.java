...
public class BalanceChangeProperty {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public BalanceChangeProperty() {
  }

  public BalanceChangeProperty currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public BalanceChangeProperty value(String value) {
  ...
  **/
   ...
   * @return the BalanceChangeProperty instance itself
   */
  public BalanceChangeProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BalanceChangeProperty balanceChangeProperty = (BalanceChangeProperty) o;
    return Objects.equals(this.currency, balanceChangeProperty.currency) &&
        Objects.equals(this.value, balanceChangeProperty.value)&&
        Objects.equals(this.additionalProperties, balanceChangeProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BalanceChangeProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BalanceChangeProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BalanceChangeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BalanceChangeProperty is not found in the empty JSON string", BalanceChangeProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BalanceChangeProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BalanceChangeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BalanceChangeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BalanceChangeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BalanceChangeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<BalanceChangeProperty>() {
           @Override
           public void write(JsonWriter out, BalanceChangeProperty value) throws IOException {
           ...
           @Override
           public BalanceChangeProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BalanceChangeProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BalanceChangeProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BalanceChangeProperty
  * @throws IOException if the JSON string is invalid with respect to BalanceChangeProperty
  */
  public static BalanceChangeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BalanceChangeProperty.class);
  }

 /**
  * Convert an instance of BalanceChangeProperty to an JSON string
  *
  * @return JSON string
  */
