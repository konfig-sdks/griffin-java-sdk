...
public class UserProperty2 {
  ...
  public UserProperty2() {
  }

  public UserProperty2 userEmail(String userEmail) {
  ...
  **/
  ...
  public UserProperty2 userUrl(String userUrl) {
  ...
  **/
  ...
  public UserProperty2 userUsername(String userUsername) {
  ...
  **/
  ...
  public UserProperty2 apiKeysUrl(String apiKeysUrl) {
  ...
  **/
  ...
  public UserProperty2 userMembershipsUrl(String userMembershipsUrl) {
  ...
  **/
  ...
  public UserProperty2 givenName(String givenName) {
  ...
  **/
  ...
  public UserProperty2 surname(String surname) {
  ...
  **/
   ...
   * @return the UserProperty2 instance itself
   */
  public UserProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserProperty2 userProperty2 = (UserProperty2) o;
    return Objects.equals(this.userEmail, userProperty2.userEmail) &&
        Objects.equals(this.userUrl, userProperty2.userUrl) &&
        Objects.equals(this.userUsername, userProperty2.userUsername) &&
        Objects.equals(this.apiKeysUrl, userProperty2.apiKeysUrl) &&
        Objects.equals(this.userMembershipsUrl, userProperty2.userMembershipsUrl) &&
        Objects.equals(this.givenName, userProperty2.givenName) &&
        Objects.equals(this.surname, userProperty2.surname)&&
        Objects.equals(this.additionalProperties, userProperty2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserProperty2 is not found in the empty JSON string", UserProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<UserProperty2>() {
           @Override
           public void write(JsonWriter out, UserProperty2 value) throws IOException {
           ...
           @Override
           public UserProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserProperty2
  * @throws IOException if the JSON string is invalid with respect to UserProperty2
  */
  public static UserProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserProperty2.class);
  }

 /**
  * Convert an instance of UserProperty2 to an JSON string
  *
  * @return JSON string
  */
