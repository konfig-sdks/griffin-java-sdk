...
public class BankAddress4 {
 ...
 public enum AccountNumberCodeEnum {
  ...
  public BankAddress4 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public BankAddress4 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public BankAddress4 bankId(String bankId) {
  ...
  **/
  ...
  public BankAddress4 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public BankAddress4 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
   ...
   * @return the BankAddress4 instance itself
   */
  public BankAddress4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAddress4 bankAddress4 = (BankAddress4) o;
    return Objects.equals(this.accountHolder, bankAddress4.accountHolder) &&
        Objects.equals(this.bankIdCode, bankAddress4.bankIdCode) &&
        Objects.equals(this.bankId, bankAddress4.bankId) &&
        Objects.equals(this.accountNumber, bankAddress4.accountNumber) &&
        Objects.equals(this.accountNumberCode, bankAddress4.accountNumberCode)&&
        Objects.equals(this.additionalProperties, bankAddress4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAddress4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAddress4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAddress4 is not found in the empty JSON string", BankAddress4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAddress4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAddress4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAddress4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAddress4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAddress4.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAddress4>() {
           @Override
           public void write(JsonWriter out, BankAddress4 value) throws IOException {
           ...
           @Override
           public BankAddress4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAddress4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAddress4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAddress4
  * @throws IOException if the JSON string is invalid with respect to BankAddress4
  */
  public static BankAddress4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAddress4.class);
  }

 /**
  * Convert an instance of BankAddress4 to an JSON string
  *
  * @return JSON string
  */
