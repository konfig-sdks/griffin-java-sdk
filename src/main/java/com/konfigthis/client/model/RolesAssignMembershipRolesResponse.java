...
import com.konfigthis.client.model.Role3;
...
public class RolesAssignMembershipRolesResponse {
  public static final String SERIALIZED_NAME_ROLES = "roles";
  @SerializedName(SERIALIZED_NAME_ROLES)
  private List<Role3> roles = new ArrayList<>();

  public RolesAssignMembershipRolesResponse() {
  }

  public RolesAssignMembershipRolesResponse roles(List<Role3> roles) {
  ...
  public RolesAssignMembershipRolesResponse addRolesItem(Role3 rolesItem) {
  ...
  **/
   ...
   * @return the RolesAssignMembershipRolesResponse instance itself
   */
  public RolesAssignMembershipRolesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RolesAssignMembershipRolesResponse rolesAssignMembershipRolesResponse = (RolesAssignMembershipRolesResponse) o;
    return Objects.equals(this.roles, rolesAssignMembershipRolesResponse.roles)&&
        Objects.equals(this.additionalProperties, rolesAssignMembershipRolesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RolesAssignMembershipRolesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RolesAssignMembershipRolesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RolesAssignMembershipRolesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RolesAssignMembershipRolesResponse is not found in the empty JSON string", RolesAssignMembershipRolesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RolesAssignMembershipRolesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayroles.size(); i++) {
        Role3.validateJsonObject(jsonArrayroles.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RolesAssignMembershipRolesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RolesAssignMembershipRolesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RolesAssignMembershipRolesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RolesAssignMembershipRolesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RolesAssignMembershipRolesResponse>() {
           @Override
           public void write(JsonWriter out, RolesAssignMembershipRolesResponse value) throws IOException {
           ...
           @Override
           public RolesAssignMembershipRolesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RolesAssignMembershipRolesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RolesAssignMembershipRolesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RolesAssignMembershipRolesResponse
  * @throws IOException if the JSON string is invalid with respect to RolesAssignMembershipRolesResponse
  */
  public static RolesAssignMembershipRolesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RolesAssignMembershipRolesResponse.class);
  }

 /**
  * Convert an instance of RolesAssignMembershipRolesResponse to an JSON string
  *
  * @return JSON string
  */
