...
public class Role4 {
  ...
  public Role4 description(String description) {
  ...
  **/
  ...
  public Role4 displayName(String displayName) {
  ...
  **/
  ...
  public Role4 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role4 instance itself
   */
  public Role4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role4 role4 = (Role4) o;
    return Objects.equals(this.description, role4.description) &&
        Objects.equals(this.displayName, role4.displayName) &&
        Objects.equals(this.roleUrl, role4.roleUrl)&&
        Objects.equals(this.additionalProperties, role4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role4 is not found in the empty JSON string", Role4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role4.class));

       return (TypeAdapter<T>) new TypeAdapter<Role4>() {
           @Override
           public void write(JsonWriter out, Role4 value) throws IOException {
           ...
           @Override
           public Role4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role4
  * @throws IOException if the JSON string is invalid with respect to Role4
  */
  public static Role4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role4.class);
  }

 /**
  * Convert an instance of Role4 to an JSON string
  *
  * @return JSON string
  */
