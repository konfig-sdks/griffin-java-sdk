...
public class PaymentAmountProperty2 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public PaymentAmountProperty2() {
  }

  public PaymentAmountProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public PaymentAmountProperty2 value(String value) {
  ...
  **/
   ...
   * @return the PaymentAmountProperty2 instance itself
   */
  public PaymentAmountProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentAmountProperty2 paymentAmountProperty2 = (PaymentAmountProperty2) o;
    return Objects.equals(this.currency, paymentAmountProperty2.currency) &&
        Objects.equals(this.value, paymentAmountProperty2.value)&&
        Objects.equals(this.additionalProperties, paymentAmountProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAmountProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAmountProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAmountProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountProperty2 is not found in the empty JSON string", PaymentAmountProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountProperty2>() {
           @Override
           public void write(JsonWriter out, PaymentAmountProperty2 value) throws IOException {
           ...
           @Override
           public PaymentAmountProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentAmountProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentAmountProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAmountProperty2
  * @throws IOException if the JSON string is invalid with respect to PaymentAmountProperty2
  */
  public static PaymentAmountProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountProperty2.class);
  }

 /**
  * Convert an instance of PaymentAmountProperty2 to an JSON string
  *
  * @return JSON string
  */
