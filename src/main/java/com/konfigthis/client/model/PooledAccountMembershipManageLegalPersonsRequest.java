...
public class PooledAccountMembershipManageLegalPersonsRequest {
  ...
  public PooledAccountMembershipManageLegalPersonsRequest() {
  }

  public PooledAccountMembershipManageLegalPersonsRequest additions(List<String> additions) {
  ...
  public PooledAccountMembershipManageLegalPersonsRequest addAdditionsItem(String additionsItem) {
  ...
  **/
  ...
  public PooledAccountMembershipManageLegalPersonsRequest deletions(List<String> deletions) {
  ...
  public PooledAccountMembershipManageLegalPersonsRequest addDeletionsItem(String deletionsItem) {
  ...
  **/
   ...
   * @return the PooledAccountMembershipManageLegalPersonsRequest instance itself
   */
  public PooledAccountMembershipManageLegalPersonsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PooledAccountMembershipManageLegalPersonsRequest pooledAccountMembershipManageLegalPersonsRequest = (PooledAccountMembershipManageLegalPersonsRequest) o;
    return Objects.equals(this.additions, pooledAccountMembershipManageLegalPersonsRequest.additions) &&
        Objects.equals(this.deletions, pooledAccountMembershipManageLegalPersonsRequest.deletions)&&
        Objects.equals(this.additionalProperties, pooledAccountMembershipManageLegalPersonsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additions, deletions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PooledAccountMembershipManageLegalPersonsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PooledAccountMembershipManageLegalPersonsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PooledAccountMembershipManageLegalPersonsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PooledAccountMembershipManageLegalPersonsRequest is not found in the empty JSON string", PooledAccountMembershipManageLegalPersonsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PooledAccountMembershipManageLegalPersonsRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the required json array is present
      if (jsonObj.get("additions") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("additions").isJsonArray()) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("deletions") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("deletions").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PooledAccountMembershipManageLegalPersonsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PooledAccountMembershipManageLegalPersonsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PooledAccountMembershipManageLegalPersonsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PooledAccountMembershipManageLegalPersonsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PooledAccountMembershipManageLegalPersonsRequest>() {
           @Override
           public void write(JsonWriter out, PooledAccountMembershipManageLegalPersonsRequest value) throws IOException {
           ...
           @Override
           public PooledAccountMembershipManageLegalPersonsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PooledAccountMembershipManageLegalPersonsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PooledAccountMembershipManageLegalPersonsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PooledAccountMembershipManageLegalPersonsRequest
  * @throws IOException if the JSON string is invalid with respect to PooledAccountMembershipManageLegalPersonsRequest
  */
  public static PooledAccountMembershipManageLegalPersonsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PooledAccountMembershipManageLegalPersonsRequest.class);
  }

 /**
  * Convert an instance of PooledAccountMembershipManageLegalPersonsRequest to an JSON string
  *
  * @return JSON string
  */
