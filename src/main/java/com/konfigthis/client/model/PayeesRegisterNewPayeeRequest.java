...
public class PayeesRegisterNewPayeeRequest {
  ...
  public PayeesRegisterNewPayeeRequest() {
  }

  public PayeesRegisterNewPayeeRequest accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeRequest accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeesRegisterNewPayeeRequest bankId(String bankId) {
  ...
  **/
   ...
   * @return the PayeesRegisterNewPayeeRequest instance itself
   */
  public PayeesRegisterNewPayeeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeesRegisterNewPayeeRequest payeesRegisterNewPayeeRequest = (PayeesRegisterNewPayeeRequest) o;
    return Objects.equals(this.accountHolder, payeesRegisterNewPayeeRequest.accountHolder) &&
        Objects.equals(this.accountNumber, payeesRegisterNewPayeeRequest.accountNumber) &&
        Objects.equals(this.bankId, payeesRegisterNewPayeeRequest.bankId)&&
        Objects.equals(this.additionalProperties, payeesRegisterNewPayeeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountHolder, accountNumber, bankId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayeesRegisterNewPayeeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeesRegisterNewPayeeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeesRegisterNewPayeeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeesRegisterNewPayeeRequest is not found in the empty JSON string", PayeesRegisterNewPayeeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeesRegisterNewPayeeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeesRegisterNewPayeeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeesRegisterNewPayeeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeesRegisterNewPayeeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeesRegisterNewPayeeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeesRegisterNewPayeeRequest>() {
           @Override
           public void write(JsonWriter out, PayeesRegisterNewPayeeRequest value) throws IOException {
           ...
           @Override
           public PayeesRegisterNewPayeeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeesRegisterNewPayeeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeesRegisterNewPayeeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeesRegisterNewPayeeRequest
  * @throws IOException if the JSON string is invalid with respect to PayeesRegisterNewPayeeRequest
  */
  public static PayeesRegisterNewPayeeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeesRegisterNewPayeeRequest.class);
  }

 /**
  * Convert an instance of PayeesRegisterNewPayeeRequest to an JSON string
  *
  * @return JSON string
  */
