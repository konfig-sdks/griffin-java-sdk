...
public class Admission1 {
 ...
 public enum AdmissionStatusEnum {
  ...
  public Admission1 admissionStatus(AdmissionStatusEnum admissionStatus) {
  ...
  **/
  ...
  public Admission1 admissionSchemeInformation(FpsProperty admissionSchemeInformation) {
  ...
  **/
  ...
  public Admission1 paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public Admission1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Admission1 admissionUrl(String admissionUrl) {
  ...
  **/
   ...
   * @return the Admission1 instance itself
   */
  public Admission1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Admission1 admission1 = (Admission1) o;
    return Objects.equals(this.admissionStatus, admission1.admissionStatus) &&
        Objects.equals(this.admissionSchemeInformation, admission1.admissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, admission1.paymentUrl) &&
        Objects.equals(this.createdAt, admission1.createdAt) &&
        Objects.equals(this.admissionUrl, admission1.admissionUrl)&&
        Objects.equals(this.additionalProperties, admission1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Admission1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Admission1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Admission1 is not found in the empty JSON string", Admission1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Admission1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Admission1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Admission1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Admission1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Admission1.class));

       return (TypeAdapter<T>) new TypeAdapter<Admission1>() {
           @Override
           public void write(JsonWriter out, Admission1 value) throws IOException {
           ...
           @Override
           public Admission1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Admission1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Admission1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Admission1
  * @throws IOException if the JSON string is invalid with respect to Admission1
  */
  public static Admission1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Admission1.class);
  }

 /**
  * Convert an instance of Admission1 to an JSON string
  *
  * @return JSON string
  */
