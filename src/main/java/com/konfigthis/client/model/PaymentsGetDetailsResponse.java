...
import com.konfigthis.client.model.DebtorProperty3;
import com.konfigthis.client.model.PayeeProperty4;
import com.konfigthis.client.model.PaymentAmountProperty4;
import com.konfigthis.client.model.UltimateDebtorProperty3;
...
public class PaymentsGetDetailsResponse {
 ...
 public enum PaymentDirectionEnum {
  ...
  private DebtorProperty3 debtor;

  public PaymentsGetDetailsResponse() {
  }

  public PaymentsGetDetailsResponse creditor(PayeeProperty4 creditor) {
  ...
  **/
  ...
  public PayeeProperty4 getCreditor() {
    return creditor;
  }


  public void setCreditor(PayeeProperty4 creditor) {
  ...
  public PaymentsGetDetailsResponse paymentDirection(PaymentDirectionEnum paymentDirection) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse paymentReference(String paymentReference) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse paymentAmount(PaymentAmountProperty4 paymentAmount) {
  ...
  **/
  ...
  public PaymentAmountProperty4 getPaymentAmount() {
    return paymentAmount;
  }


  public void setPaymentAmount(PaymentAmountProperty4 paymentAmount) {
  ...
  public PaymentsGetDetailsResponse ultimateDebtor(UltimateDebtorProperty3 ultimateDebtor) {
  ...
  **/
  ...
  public UltimateDebtorProperty3 getUltimateDebtor() {
    return ultimateDebtor;
  }


  public void setUltimateDebtor(UltimateDebtorProperty3 ultimateDebtor) {
  ...
  public PaymentsGetDetailsResponse paymentAdmissionsUrl(String paymentAdmissionsUrl) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse paymentSubmissionsUrl(String paymentSubmissionsUrl) {
  ...
  **/
  ...
  public PaymentsGetDetailsResponse debtor(DebtorProperty3 debtor) {
  ...
  **/
  ...
  public DebtorProperty3 getDebtor() {
    return debtor;
  }


  public void setDebtor(DebtorProperty3 debtor) {
   ...
   * @return the PaymentsGetDetailsResponse instance itself
   */
  public PaymentsGetDetailsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsGetDetailsResponse paymentsGetDetailsResponse = (PaymentsGetDetailsResponse) o;
    return Objects.equals(this.creditor, paymentsGetDetailsResponse.creditor) &&
        Objects.equals(this.paymentDirection, paymentsGetDetailsResponse.paymentDirection) &&
        Objects.equals(this.createdAt, paymentsGetDetailsResponse.createdAt) &&
        Objects.equals(this.paymentUrl, paymentsGetDetailsResponse.paymentUrl) &&
        Objects.equals(this.paymentReference, paymentsGetDetailsResponse.paymentReference) &&
        Objects.equals(this.paymentAmount, paymentsGetDetailsResponse.paymentAmount) &&
        Objects.equals(this.ultimateDebtor, paymentsGetDetailsResponse.ultimateDebtor) &&
        Objects.equals(this.paymentAdmissionsUrl, paymentsGetDetailsResponse.paymentAdmissionsUrl) &&
        Objects.equals(this.paymentSubmissionsUrl, paymentsGetDetailsResponse.paymentSubmissionsUrl) &&
        Objects.equals(this.debtor, paymentsGetDetailsResponse.debtor)&&
        Objects.equals(this.additionalProperties, paymentsGetDetailsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsGetDetailsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsGetDetailsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsGetDetailsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsGetDetailsResponse is not found in the empty JSON string", PaymentsGetDetailsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsGetDetailsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `creditor`
      PayeeProperty4.validateJsonObject(jsonObj.getAsJsonObject("creditor"));
      ...
      PaymentAmountProperty4.validateJsonObject(jsonObj.getAsJsonObject("payment-amount"));
      // validate the optional field `ultimate-debtor`
      if (jsonObj.get("ultimate-debtor") != null && !jsonObj.get("ultimate-debtor").isJsonNull()) {
        UltimateDebtorProperty3.validateJsonObject(jsonObj.getAsJsonObject("ultimate-debtor"));
      }
      ...
      DebtorProperty3.validateJsonObject(jsonObj.getAsJsonObject("debtor"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsGetDetailsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsGetDetailsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsGetDetailsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsGetDetailsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsGetDetailsResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsGetDetailsResponse value) throws IOException {
           ...
           @Override
           public PaymentsGetDetailsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsGetDetailsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsGetDetailsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsGetDetailsResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsGetDetailsResponse
  */
  public static PaymentsGetDetailsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsGetDetailsResponse.class);
  }

 /**
  * Convert an instance of PaymentsGetDetailsResponse to an JSON string
  *
  * @return JSON string
  */
