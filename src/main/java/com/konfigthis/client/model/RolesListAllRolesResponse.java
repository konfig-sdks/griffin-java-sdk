...
import com.konfigthis.client.model.Role7;
...
public class RolesListAllRolesResponse {
  public static final String SERIALIZED_NAME_ROLES = "roles";
  @SerializedName(SERIALIZED_NAME_ROLES)
  private List<Role7> roles = new ArrayList<>();

  public RolesListAllRolesResponse() {
  }

  public RolesListAllRolesResponse roles(List<Role7> roles) {
  ...
  public RolesListAllRolesResponse addRolesItem(Role7 rolesItem) {
  ...
  **/
  ...
  public List<Role7> getRoles() {
    return roles;
  }


  public void setRoles(List<Role7> roles) {
   ...
   * @return the RolesListAllRolesResponse instance itself
   */
  public RolesListAllRolesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RolesListAllRolesResponse rolesListAllRolesResponse = (RolesListAllRolesResponse) o;
    return Objects.equals(this.roles, rolesListAllRolesResponse.roles)&&
        Objects.equals(this.additionalProperties, rolesListAllRolesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RolesListAllRolesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RolesListAllRolesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RolesListAllRolesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RolesListAllRolesResponse is not found in the empty JSON string", RolesListAllRolesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RolesListAllRolesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayroles.size(); i++) {
        Role7.validateJsonObject(jsonArrayroles.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RolesListAllRolesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RolesListAllRolesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RolesListAllRolesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RolesListAllRolesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RolesListAllRolesResponse>() {
           @Override
           public void write(JsonWriter out, RolesListAllRolesResponse value) throws IOException {
           ...
           @Override
           public RolesListAllRolesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RolesListAllRolesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RolesListAllRolesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RolesListAllRolesResponse
  * @throws IOException if the JSON string is invalid with respect to RolesListAllRolesResponse
  */
  public static RolesListAllRolesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RolesListAllRolesResponse.class);
  }

 /**
  * Convert an instance of RolesListAllRolesResponse to an JSON string
  *
  * @return JSON string
  */
