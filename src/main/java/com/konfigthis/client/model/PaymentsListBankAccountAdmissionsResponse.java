...
import com.konfigthis.client.model.Admission;
...
public class PaymentsListBankAccountAdmissionsResponse {
  public static final String SERIALIZED_NAME_ADMISSIONS = "admissions";
  @SerializedName(SERIALIZED_NAME_ADMISSIONS)
  ...
  public PaymentsListBankAccountAdmissionsResponse() {
  }

  public PaymentsListBankAccountAdmissionsResponse admissions(List<Admission> admissions) {
  ...
  public PaymentsListBankAccountAdmissionsResponse addAdmissionsItem(Admission admissionsItem) {
    this.admissions.add(admissionsItem);
    return this;
  }
  ...
  **/
  ...
  public PaymentsListBankAccountAdmissionsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the PaymentsListBankAccountAdmissionsResponse instance itself
   */
  public PaymentsListBankAccountAdmissionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsListBankAccountAdmissionsResponse paymentsListBankAccountAdmissionsResponse = (PaymentsListBankAccountAdmissionsResponse) o;
    return Objects.equals(this.admissions, paymentsListBankAccountAdmissionsResponse.admissions) &&
        Objects.equals(this.links, paymentsListBankAccountAdmissionsResponse.links)&&
        Objects.equals(this.additionalProperties, paymentsListBankAccountAdmissionsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(admissions, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsListBankAccountAdmissionsResponse {\n");
    sb.append("    admissions: ").append(toIndentedString(admissions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("admissions");
    openapiFields.add("links");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("admissions");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsListBankAccountAdmissionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsListBankAccountAdmissionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsListBankAccountAdmissionsResponse is not found in the empty JSON string", PaymentsListBankAccountAdmissionsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsListBankAccountAdmissionsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("admissions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `admissions` to be an array in the JSON string but got `%s`", jsonObj.get("admissions").toString()));
      }

      JsonArray jsonArrayadmissions = jsonObj.getAsJsonArray("admissions");
      // validate the required field `admissions` (array)
      for (int i = 0; i < jsonArrayadmissions.size(); i++) {
        Admission.validateJsonObject(jsonArrayadmissions.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsListBankAccountAdmissionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsListBankAccountAdmissionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsListBankAccountAdmissionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsListBankAccountAdmissionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsListBankAccountAdmissionsResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsListBankAccountAdmissionsResponse value) throws IOException {
           ...
           @Override
           public PaymentsListBankAccountAdmissionsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsListBankAccountAdmissionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsListBankAccountAdmissionsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsListBankAccountAdmissionsResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsListBankAccountAdmissionsResponse
  */
  public static PaymentsListBankAccountAdmissionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsListBankAccountAdmissionsResponse.class);
  }

 /**
  * Convert an instance of PaymentsListBankAccountAdmissionsResponse to an JSON string
  *
  * @return JSON string
  */
