 ...
 */
@ApiModel(description = "Shows the [account balance](http://docs.griffin.com).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountBalanceProperty5 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty5() {
  }

  public AccountBalanceProperty5 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty5 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty5 instance itself
   */
  public AccountBalanceProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty5 accountBalanceProperty5 = (AccountBalanceProperty5) o;
    return Objects.equals(this.currency, accountBalanceProperty5.currency) &&
        Objects.equals(this.value, accountBalanceProperty5.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty5 is not found in the empty JSON string", AccountBalanceProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty5>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty5 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty5
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty5
  */
  public static AccountBalanceProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty5.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty5 to an JSON string
  *
  * @return JSON string
  */
