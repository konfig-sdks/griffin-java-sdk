...
import com.konfigthis.client.model.EstimatedTotalProperty;
...
public class PageProperty {
  ...
  public static final String SERIALIZED_NAME_ESTIMATED_TOTAL = "estimated-total";
  @SerializedName(SERIALIZED_NAME_ESTIMATED_TOTAL)
  private EstimatedTotalProperty estimatedTotal;

  public PageProperty() {
  }

  public PageProperty total(Long total) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total number of items. Present when the total number of items in the full result set is less than 10,000.")
  ...
  public PageProperty estimatedTotal(EstimatedTotalProperty estimatedTotal) {
  ...
  **/
  ...
  public EstimatedTotalProperty getEstimatedTotal() {
    return estimatedTotal;
  }


  public void setEstimatedTotal(EstimatedTotalProperty estimatedTotal) {
   ...
   * @return the PageProperty instance itself
   */
  public PageProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, pageProperty.total) &&
        Objects.equals(this.estimatedTotal, pageProperty.estimatedTotal)&&
        Objects.equals(this.additionalProperties, pageProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, estimatedTotal, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("estimated-total");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageProperty is not found in the empty JSON string", PageProperty.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `estimated-total`
      if (jsonObj.get("estimated-total") != null && !jsonObj.get("estimated-total").isJsonNull()) {
        EstimatedTotalProperty.validateJsonObject(jsonObj.getAsJsonObject("estimated-total"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<PageProperty>() {
           @Override
           public void write(JsonWriter out, PageProperty value) throws IOException {
           ...
           @Override
           public PageProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PageProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PageProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PageProperty
  * @throws IOException if the JSON string is invalid with respect to PageProperty
  */
  public static PageProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PageProperty.class);
  }

 /**
  * Convert an instance of PageProperty to an JSON string
  *
  * @return JSON string
  */
