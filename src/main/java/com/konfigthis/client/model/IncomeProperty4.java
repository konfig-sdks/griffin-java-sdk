...
public class IncomeProperty4 {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty4() {
  }

  public IncomeProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty4 value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty4 instance itself
   */
  public IncomeProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty4 incomeProperty4 = (IncomeProperty4) o;
    return Objects.equals(this.currency, incomeProperty4.currency) &&
        Objects.equals(this.value, incomeProperty4.value)&&
        Objects.equals(this.additionalProperties, incomeProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty4 is not found in the empty JSON string", IncomeProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty4>() {
           @Override
           public void write(JsonWriter out, IncomeProperty4 value) throws IOException {
           ...
           @Override
           public IncomeProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty4
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty4
  */
  public static IncomeProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty4.class);
  }

 /**
  * Convert an instance of IncomeProperty4 to an JSON string
  *
  * @return JSON string
  */
