...
import com.konfigthis.client.model.RiskRatingRegistered;
...
public class LegalPersonHistoryListEventsResponse {
  public static final String SERIALIZED_NAME_LEGAL_PERSON_HISTORY = "legal-person-history";
  @SerializedName(SERIALIZED_NAME_LEGAL_PERSON_HISTORY)
  private List<RiskRatingRegistered> legalPersonHistory = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private LinksProperty links;

  public LegalPersonHistoryListEventsResponse() {
  }

  public LegalPersonHistoryListEventsResponse legalPersonHistory(List<RiskRatingRegistered> legalPersonHistory) {
    
    
    
    
    this.legalPersonHistory = legalPersonHistory;
    return this;
  }

  public LegalPersonHistoryListEventsResponse addLegalPersonHistoryItem(RiskRatingRegistered legalPersonHistoryItem) {
    this.legalPersonHistory.add(legalPersonHistoryItem);
    return this;
  }

   /**
   * Get legalPersonHistory
   * @return legalPersonHistory
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public List<RiskRatingRegistered> getLegalPersonHistory() {
    return legalPersonHistory;
  }


  public void setLegalPersonHistory(List<RiskRatingRegistered> legalPersonHistory) {
  ...
  public LegalPersonHistoryListEventsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the LegalPersonHistoryListEventsResponse instance itself
   */
  public LegalPersonHistoryListEventsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonHistoryListEventsResponse legalPersonHistoryListEventsResponse = (LegalPersonHistoryListEventsResponse) o;
    return Objects.equals(this.legalPersonHistory, legalPersonHistoryListEventsResponse.legalPersonHistory) &&
        Objects.equals(this.links, legalPersonHistoryListEventsResponse.links)&&
        Objects.equals(this.additionalProperties, legalPersonHistoryListEventsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(legalPersonHistory, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LegalPersonHistoryListEventsResponse {\n");
    sb.append("    legalPersonHistory: ").append(toIndentedString(legalPersonHistory)).append("\n");
  ...
  static {
    ...
    openapiFields.add("legal-person-history");
    openapiFields.add("links");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("legal-person-history");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonHistoryListEventsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonHistoryListEventsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonHistoryListEventsResponse is not found in the empty JSON string", LegalPersonHistoryListEventsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonHistoryListEventsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("legal-person-history").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `legal-person-history` to be an array in the JSON string but got `%s`", jsonObj.get("legal-person-history").toString()));
      }

      JsonArray jsonArraylegalPersonHistory = jsonObj.getAsJsonArray("legal-person-history");
      // validate the required field `legal-person-history` (array)
      for (int i = 0; i < jsonArraylegalPersonHistory.size(); i++) {
        RiskRatingRegistered.validateJsonObject(jsonArraylegalPersonHistory.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonHistoryListEventsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonHistoryListEventsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonHistoryListEventsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonHistoryListEventsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonHistoryListEventsResponse>() {
           @Override
           public void write(JsonWriter out, LegalPersonHistoryListEventsResponse value) throws IOException {
           ...
           @Override
           public LegalPersonHistoryListEventsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonHistoryListEventsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonHistoryListEventsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonHistoryListEventsResponse
  * @throws IOException if the JSON string is invalid with respect to LegalPersonHistoryListEventsResponse
  */
  public static LegalPersonHistoryListEventsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonHistoryListEventsResponse.class);
  }

 /**
  * Convert an instance of LegalPersonHistoryListEventsResponse to an JSON string
  *
  * @return JSON string
  */
