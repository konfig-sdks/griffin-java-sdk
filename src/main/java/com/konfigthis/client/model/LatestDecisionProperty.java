...
public class LatestDecisionProperty {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public LatestDecisionProperty() {
  }

  public LatestDecisionProperty verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public LatestDecisionProperty createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public LatestDecisionProperty decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the LatestDecisionProperty instance itself
   */
  public LatestDecisionProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LatestDecisionProperty latestDecisionProperty = (LatestDecisionProperty) o;
    return Objects.equals(this.verificationUrl, latestDecisionProperty.verificationUrl) &&
        Objects.equals(this.decisionOutcome, latestDecisionProperty.decisionOutcome) &&
        Objects.equals(this.decisionMaker, latestDecisionProperty.decisionMaker) &&
        Objects.equals(this.decisionNotes, latestDecisionProperty.decisionNotes) &&
        Objects.equals(this.createdAt, latestDecisionProperty.createdAt) &&
        Objects.equals(this.decisionUserUrl, latestDecisionProperty.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, latestDecisionProperty.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, latestDecisionProperty.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, latestDecisionProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LatestDecisionProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LatestDecisionProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LatestDecisionProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatestDecisionProperty is not found in the empty JSON string", LatestDecisionProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LatestDecisionProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatestDecisionProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatestDecisionProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatestDecisionProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatestDecisionProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LatestDecisionProperty>() {
           @Override
           public void write(JsonWriter out, LatestDecisionProperty value) throws IOException {
           ...
           @Override
           public LatestDecisionProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LatestDecisionProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LatestDecisionProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LatestDecisionProperty
  * @throws IOException if the JSON string is invalid with respect to LatestDecisionProperty
  */
  public static LatestDecisionProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatestDecisionProperty.class);
  }

 /**
  * Convert an instance of LatestDecisionProperty to an JSON string
  *
  * @return JSON string
  */
