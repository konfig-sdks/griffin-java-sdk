...
import com.konfigthis.client.model.DirectorProperty;
import com.konfigthis.client.model.PscProperty;
 ...
 */
@ApiModel(description = "The relationship with the subject profile.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SubjectAssociationProperty {
  public static final String SERIALIZED_NAME_DIRECTOR = "director";
  @SerializedName(SERIALIZED_NAME_DIRECTOR)
  private DirectorProperty director;

  public static final String SERIALIZED_NAME_PSC = "psc";
  @SerializedName(SERIALIZED_NAME_PSC)
  private PscProperty psc;

  public static final String SERIALIZED_NAME_SENIOR_MANAGER = "senior-manager";
  @SerializedName(SERIALIZED_NAME_SENIOR_MANAGER)
  private Object seniorManager;

  public SubjectAssociationProperty() {
  }

  public SubjectAssociationProperty director(DirectorProperty director) {
  ...
  **/
  ...
  public DirectorProperty getDirector() {
    return director;
  }


  public void setDirector(DirectorProperty director) {
  ...
  public SubjectAssociationProperty psc(PscProperty psc) {
  ...
  **/
  ...
  public PscProperty getPsc() {
    return psc;
  }


  public void setPsc(PscProperty psc) {
  ...
  public SubjectAssociationProperty seniorManager(Object seniorManager) {
  ...
  **/
  ...
  public Object getSeniorManager() {
    return seniorManager;
  }


  public void setSeniorManager(Object seniorManager) {
   ...
   * @return the SubjectAssociationProperty instance itself
   */
  public SubjectAssociationProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubjectAssociationProperty subjectAssociationProperty = (SubjectAssociationProperty) o;
    return Objects.equals(this.director, subjectAssociationProperty.director) &&
        Objects.equals(this.psc, subjectAssociationProperty.psc) &&
        Objects.equals(this.seniorManager, subjectAssociationProperty.seniorManager)&&
        Objects.equals(this.additionalProperties, subjectAssociationProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(director, psc, seniorManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubjectAssociationProperty {\n");
    sb.append("    director: ").append(toIndentedString(director)).append("\n");
    sb.append("    psc: ").append(toIndentedString(psc)).append("\n");
    sb.append("    seniorManager: ").append(toIndentedString(seniorManager)).append("\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubjectAssociationProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubjectAssociationProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubjectAssociationProperty is not found in the empty JSON string", SubjectAssociationProperty.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `director`
      if (jsonObj.get("director") != null && !jsonObj.get("director").isJsonNull()) {
        DirectorProperty.validateJsonObject(jsonObj.getAsJsonObject("director"));
      }
      // validate the optional field `psc`
      if (jsonObj.get("psc") != null && !jsonObj.get("psc").isJsonNull()) {
        PscProperty.validateJsonObject(jsonObj.getAsJsonObject("psc"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubjectAssociationProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubjectAssociationProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubjectAssociationProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubjectAssociationProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<SubjectAssociationProperty>() {
           @Override
           public void write(JsonWriter out, SubjectAssociationProperty value) throws IOException {
           ...
           @Override
           public SubjectAssociationProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubjectAssociationProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubjectAssociationProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubjectAssociationProperty
  * @throws IOException if the JSON string is invalid with respect to SubjectAssociationProperty
  */
  public static SubjectAssociationProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubjectAssociationProperty.class);
  }

 /**
  * Convert an instance of SubjectAssociationProperty to an JSON string
  *
  * @return JSON string
  */
