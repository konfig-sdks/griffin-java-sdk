...
public class PscProperty {
  ...
  public PscProperty ownershipPercent(String ownershipPercent) {
  ...
  **/
  ...
  public PscProperty companiesHouseUrl(String companiesHouseUrl) {
  ...
  **/
   ...
   * @return the PscProperty instance itself
   */
  public PscProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PscProperty pscProperty = (PscProperty) o;
    return Objects.equals(this.ownershipPercent, pscProperty.ownershipPercent) &&
        Objects.equals(this.companiesHouseUrl, pscProperty.companiesHouseUrl)&&
        Objects.equals(this.additionalProperties, pscProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ownershipPercent, companiesHouseUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PscProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PscProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PscProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PscProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PscProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PscProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PscProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<PscProperty>() {
           @Override
           public void write(JsonWriter out, PscProperty value) throws IOException {
           ...
           @Override
           public PscProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PscProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PscProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PscProperty
  * @throws IOException if the JSON string is invalid with respect to PscProperty
  */
  public static PscProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PscProperty.class);
  }

 /**
  * Convert an instance of PscProperty to an JSON string
  *
  * @return JSON string
  */
