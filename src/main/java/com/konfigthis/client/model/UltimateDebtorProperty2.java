...
public class UltimateDebtorProperty2 {
 ...
 public enum BankIdCodeEnum {
  ...
  public UltimateDebtorProperty2() {
  }

  public UltimateDebtorProperty2 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public UltimateDebtorProperty2 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty2 bankId(String bankId) {
  ...
  **/
  ...
  public UltimateDebtorProperty2 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty2 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public UltimateDebtorProperty2 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the UltimateDebtorProperty2 instance itself
   */
  public UltimateDebtorProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UltimateDebtorProperty2 ultimateDebtorProperty2 = (UltimateDebtorProperty2) o;
    return Objects.equals(this.accountNumber, ultimateDebtorProperty2.accountNumber) &&
        Objects.equals(this.accountNumberCode, ultimateDebtorProperty2.accountNumberCode) &&
        Objects.equals(this.bankId, ultimateDebtorProperty2.bankId) &&
        Objects.equals(this.bankIdCode, ultimateDebtorProperty2.bankIdCode) &&
        Objects.equals(this.accountHolder, ultimateDebtorProperty2.accountHolder) &&
        Objects.equals(this.accountUrl, ultimateDebtorProperty2.accountUrl)&&
        Objects.equals(this.additionalProperties, ultimateDebtorProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UltimateDebtorProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UltimateDebtorProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UltimateDebtorProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UltimateDebtorProperty2 is not found in the empty JSON string", UltimateDebtorProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UltimateDebtorProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UltimateDebtorProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UltimateDebtorProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UltimateDebtorProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UltimateDebtorProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<UltimateDebtorProperty2>() {
           @Override
           public void write(JsonWriter out, UltimateDebtorProperty2 value) throws IOException {
           ...
           @Override
           public UltimateDebtorProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UltimateDebtorProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UltimateDebtorProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UltimateDebtorProperty2
  * @throws IOException if the JSON string is invalid with respect to UltimateDebtorProperty2
  */
  public static UltimateDebtorProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UltimateDebtorProperty2.class);
  }

 /**
  * Convert an instance of UltimateDebtorProperty2 to an JSON string
  *
  * @return JSON string
  */
