...
public class RiskRatingEntry1 {
 ...
 public enum PreviousRiskRatingEnum {
  ...
  public RiskRatingEntry1() {
  }

  public RiskRatingEntry1 riskRatingUrl(String riskRatingUrl) {
  ...
  **/
  ...
  public RiskRatingEntry1 riskRating(RiskRatingEnum riskRating) {
  ...
  **/
  ...
  public RiskRatingEntry1 legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public RiskRatingEntry1 notes(String notes) {
  ...
  **/
  ...
  public RiskRatingEntry1 manuallyCreatedBy(OpsUserProperty manuallyCreatedBy) {
  ...
  **/
  ...
  public RiskRatingEntry1 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public RiskRatingEntry1 previousRiskRating(PreviousRiskRatingEnum previousRiskRating) {
  ...
  **/
   ...
   * @return the RiskRatingEntry1 instance itself
   */
  public RiskRatingEntry1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RiskRatingEntry1 riskRatingEntry1 = (RiskRatingEntry1) o;
    return Objects.equals(this.riskRatingUrl, riskRatingEntry1.riskRatingUrl) &&
        Objects.equals(this.riskRating, riskRatingEntry1.riskRating) &&
        Objects.equals(this.legalPersonUrl, riskRatingEntry1.legalPersonUrl) &&
        Objects.equals(this.notes, riskRatingEntry1.notes) &&
        Objects.equals(this.manuallyCreatedBy, riskRatingEntry1.manuallyCreatedBy) &&
        Objects.equals(this.verificationUrl, riskRatingEntry1.verificationUrl) &&
        Objects.equals(this.previousRiskRating, riskRatingEntry1.previousRiskRating)&&
        Objects.equals(this.additionalProperties, riskRatingEntry1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RiskRatingEntry1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RiskRatingEntry1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RiskRatingEntry1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RiskRatingEntry1 is not found in the empty JSON string", RiskRatingEntry1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RiskRatingEntry1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RiskRatingEntry1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RiskRatingEntry1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RiskRatingEntry1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RiskRatingEntry1.class));

       return (TypeAdapter<T>) new TypeAdapter<RiskRatingEntry1>() {
           @Override
           public void write(JsonWriter out, RiskRatingEntry1 value) throws IOException {
           ...
           @Override
           public RiskRatingEntry1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RiskRatingEntry1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RiskRatingEntry1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RiskRatingEntry1
  * @throws IOException if the JSON string is invalid with respect to RiskRatingEntry1
  */
  public static RiskRatingEntry1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RiskRatingEntry1.class);
  }

 /**
  * Convert an instance of RiskRatingEntry1 to an JSON string
  *
  * @return JSON string
  */
