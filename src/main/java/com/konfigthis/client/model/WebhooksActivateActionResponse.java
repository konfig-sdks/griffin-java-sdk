...
public class WebhooksActivateActionResponse {
  ...
  public WebhooksActivateActionResponse() {
  }

  public WebhooksActivateActionResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse webhookDestinationUrl(String webhookDestinationUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse testWebhookUrl(String testWebhookUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse activateWebhookUrl(String activateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse deactivateWebhookUrl(String deactivateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksActivateActionResponse webhookDescription(String webhookDescription) {
  ...
  **/
   ...
   * @return the WebhooksActivateActionResponse instance itself
   */
  public WebhooksActivateActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksActivateActionResponse webhooksActivateActionResponse = (WebhooksActivateActionResponse) o;
    return Objects.equals(this.organizationUrl, webhooksActivateActionResponse.organizationUrl) &&
        Objects.equals(this.webhookUrl, webhooksActivateActionResponse.webhookUrl) &&
        Objects.equals(this.webhookDestinationUrl, webhooksActivateActionResponse.webhookDestinationUrl) &&
        Objects.equals(this.testWebhookUrl, webhooksActivateActionResponse.testWebhookUrl) &&
        Objects.equals(this.activateWebhookUrl, webhooksActivateActionResponse.activateWebhookUrl) &&
        Objects.equals(this.deactivateWebhookUrl, webhooksActivateActionResponse.deactivateWebhookUrl) &&
        Objects.equals(this.webhookDescription, webhooksActivateActionResponse.webhookDescription)&&
        Objects.equals(this.additionalProperties, webhooksActivateActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksActivateActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksActivateActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksActivateActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksActivateActionResponse is not found in the empty JSON string", WebhooksActivateActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksActivateActionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksActivateActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksActivateActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksActivateActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksActivateActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksActivateActionResponse>() {
           @Override
           public void write(JsonWriter out, WebhooksActivateActionResponse value) throws IOException {
           ...
           @Override
           public WebhooksActivateActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksActivateActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksActivateActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksActivateActionResponse
  * @throws IOException if the JSON string is invalid with respect to WebhooksActivateActionResponse
  */
  public static WebhooksActivateActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksActivateActionResponse.class);
  }

 /**
  * Convert an instance of WebhooksActivateActionResponse to an JSON string
  *
  * @return JSON string
  */
