...
public class Role3 {
  ...
  public Role3 description(String description) {
  ...
  **/
  ...
  public Role3 displayName(String displayName) {
  ...
  **/
  ...
  public Role3 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role3 instance itself
   */
  public Role3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role3 role3 = (Role3) o;
    return Objects.equals(this.description, role3.description) &&
        Objects.equals(this.displayName, role3.displayName) &&
        Objects.equals(this.roleUrl, role3.roleUrl)&&
        Objects.equals(this.additionalProperties, role3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role3 is not found in the empty JSON string", Role3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role3.class));

       return (TypeAdapter<T>) new TypeAdapter<Role3>() {
           @Override
           public void write(JsonWriter out, Role3 value) throws IOException {
           ...
           @Override
           public Role3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role3
  * @throws IOException if the JSON string is invalid with respect to Role3
  */
  public static Role3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role3.class);
  }

 /**
  * Convert an instance of Role3 to an JSON string
  *
  * @return JSON string
  */
