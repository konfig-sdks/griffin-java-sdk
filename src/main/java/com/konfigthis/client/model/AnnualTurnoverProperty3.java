...
public class AnnualTurnoverProperty3 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty3() {
  }

  public AnnualTurnoverProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty3 value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty3 instance itself
   */
  public AnnualTurnoverProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty3 annualTurnoverProperty3 = (AnnualTurnoverProperty3) o;
    return Objects.equals(this.currency, annualTurnoverProperty3.currency) &&
        Objects.equals(this.value, annualTurnoverProperty3.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty3 is not found in the empty JSON string", AnnualTurnoverProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty3>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty3 value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty3
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty3
  */
  public static AnnualTurnoverProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty3.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty3 to an JSON string
  *
  * @return JSON string
  */
