...
public class PayeesListLegalPersonPayeesResponse {
  ...
  public PayeesListLegalPersonPayeesResponse() {
  }

  public PayeesListLegalPersonPayeesResponse payees(List<Payee> payees) {
  ...
  public PayeesListLegalPersonPayeesResponse addPayeesItem(Payee payeesItem) {
  ...
  **/
  ...
  public PayeesListLegalPersonPayeesResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the PayeesListLegalPersonPayeesResponse instance itself
   */
  public PayeesListLegalPersonPayeesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeesListLegalPersonPayeesResponse payeesListLegalPersonPayeesResponse = (PayeesListLegalPersonPayeesResponse) o;
    return Objects.equals(this.payees, payeesListLegalPersonPayeesResponse.payees) &&
        Objects.equals(this.links, payeesListLegalPersonPayeesResponse.links)&&
        Objects.equals(this.additionalProperties, payeesListLegalPersonPayeesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payees, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayeesListLegalPersonPayeesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeesListLegalPersonPayeesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeesListLegalPersonPayeesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeesListLegalPersonPayeesResponse is not found in the empty JSON string", PayeesListLegalPersonPayeesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeesListLegalPersonPayeesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeesListLegalPersonPayeesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeesListLegalPersonPayeesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeesListLegalPersonPayeesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeesListLegalPersonPayeesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeesListLegalPersonPayeesResponse>() {
           @Override
           public void write(JsonWriter out, PayeesListLegalPersonPayeesResponse value) throws IOException {
           ...
           @Override
           public PayeesListLegalPersonPayeesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeesListLegalPersonPayeesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeesListLegalPersonPayeesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeesListLegalPersonPayeesResponse
  * @throws IOException if the JSON string is invalid with respect to PayeesListLegalPersonPayeesResponse
  */
  public static PayeesListLegalPersonPayeesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeesListLegalPersonPayeesResponse.class);
  }

 /**
  * Convert an instance of PayeesListLegalPersonPayeesResponse to an JSON string
  *
  * @return JSON string
  */
