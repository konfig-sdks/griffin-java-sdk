...
public class VerificationsGetVerificationResponse {
 ...
 public enum VerificationStatusEnum {
  ...
  public VerificationsGetVerificationResponse() {
  }

  public VerificationsGetVerificationResponse verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse workflowUrl(String workflowUrl) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse verificationChecksUrl(String verificationChecksUrl) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/v0/verifications/vn.IHZlcmlmaWNhdGlvbi1pZA/checks", required = true, value = "")
  ...
  public VerificationsGetVerificationResponse riskRating(RiskRatingEnum riskRating) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse verificationStatus(VerificationStatusEnum verificationStatus) {
  ...
  **/
  ...
  public VerificationsGetVerificationResponse verificationRiskAssessmentsUrl(String verificationRiskAssessmentsUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/v0/verifications/vn.IHZlcmlmaWNhdGlvbi1pZA/risk-assessments", value = "")
   ...
   * @return the VerificationsGetVerificationResponse instance itself
   */
  public VerificationsGetVerificationResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VerificationsGetVerificationResponse verificationsGetVerificationResponse = (VerificationsGetVerificationResponse) o;
    return Objects.equals(this.verificationUrl, verificationsGetVerificationResponse.verificationUrl) &&
        Objects.equals(this.updatedAt, verificationsGetVerificationResponse.updatedAt) &&
        Objects.equals(this.legalPersonUrl, verificationsGetVerificationResponse.legalPersonUrl) &&
        Objects.equals(this.workflowUrl, verificationsGetVerificationResponse.workflowUrl) &&
        Objects.equals(this.createdAt, verificationsGetVerificationResponse.createdAt) &&
        Objects.equals(this.verificationChecksUrl, verificationsGetVerificationResponse.verificationChecksUrl) &&
        Objects.equals(this.riskRating, verificationsGetVerificationResponse.riskRating) &&
        Objects.equals(this.verificationStatus, verificationsGetVerificationResponse.verificationStatus) &&
        Objects.equals(this.verificationRiskAssessmentsUrl, verificationsGetVerificationResponse.verificationRiskAssessmentsUrl)&&
        Objects.equals(this.additionalProperties, verificationsGetVerificationResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerificationsGetVerificationResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VerificationsGetVerificationResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VerificationsGetVerificationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationsGetVerificationResponse is not found in the empty JSON string", VerificationsGetVerificationResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerificationsGetVerificationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerificationsGetVerificationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerificationsGetVerificationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerificationsGetVerificationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerificationsGetVerificationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VerificationsGetVerificationResponse>() {
           @Override
           public void write(JsonWriter out, VerificationsGetVerificationResponse value) throws IOException {
           ...
           @Override
           public VerificationsGetVerificationResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VerificationsGetVerificationResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VerificationsGetVerificationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VerificationsGetVerificationResponse
  * @throws IOException if the JSON string is invalid with respect to VerificationsGetVerificationResponse
  */
  public static VerificationsGetVerificationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerificationsGetVerificationResponse.class);
  }

 /**
  * Convert an instance of VerificationsGetVerificationResponse to an JSON string
  *
  * @return JSON string
  */
