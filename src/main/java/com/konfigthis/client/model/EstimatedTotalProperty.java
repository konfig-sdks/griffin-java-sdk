...
public class EstimatedTotalProperty {
  /**
   ...
   */
  @JsonAdapter(AtLeastEnum.Adapter.class)
 public enum AtLeastEnum {
    _10000("10000");

    private String value;

    AtLeastEnum(String value) {
      this.value = value;
    }
    ...
    public static AtLeastEnum fromValue(String value) {
      for (AtLeastEnum b : AtLeastEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AtLeastEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AtLeastEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AtLeastEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AtLeastEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_AT_LEAST = "at-least";
  @SerializedName(SERIALIZED_NAME_AT_LEAST)
  private AtLeastEnum atLeast;

  public EstimatedTotalProperty() {
  }

  public EstimatedTotalProperty atLeast(AtLeastEnum atLeast) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Present when the total number of items in the full result set exceeds 10,000. This indicates that the actual number of items is at least 10,000, but the exact total is not provided due to performance considerations.")

  public AtLeastEnum getAtLeast() {
    return atLeast;
  }


  public void setAtLeast(AtLeastEnum atLeast) {
   ...
   * @return the EstimatedTotalProperty instance itself
   */
  public EstimatedTotalProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EstimatedTotalProperty estimatedTotalProperty = (EstimatedTotalProperty) o;
    return Objects.equals(this.atLeast, estimatedTotalProperty.atLeast)&&
        Objects.equals(this.additionalProperties, estimatedTotalProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atLeast, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EstimatedTotalProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EstimatedTotalProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EstimatedTotalProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EstimatedTotalProperty is not found in the empty JSON string", EstimatedTotalProperty.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("at-least") != null && !jsonObj.get("at-least").isJsonNull()) && !jsonObj.get("at-least").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `at-least` to be a primitive type in the JSON string but got `%s`", jsonObj.get("at-least").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EstimatedTotalProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EstimatedTotalProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EstimatedTotalProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EstimatedTotalProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<EstimatedTotalProperty>() {
           @Override
           public void write(JsonWriter out, EstimatedTotalProperty value) throws IOException {
           ...
           @Override
           public EstimatedTotalProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EstimatedTotalProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EstimatedTotalProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimatedTotalProperty
  * @throws IOException if the JSON string is invalid with respect to EstimatedTotalProperty
  */
  public static EstimatedTotalProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimatedTotalProperty.class);
  }

 /**
  * Convert an instance of EstimatedTotalProperty to an JSON string
  *
  * @return JSON string
  */
