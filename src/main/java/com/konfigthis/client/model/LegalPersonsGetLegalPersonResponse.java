...
import com.konfigthis.client.model.LatestDecisionProperty1;
...
public class LegalPersonsGetLegalPersonResponse {
 ...
 public enum ApplicationStatusEnum {
  ...
  public LegalPersonsGetLegalPersonResponse() {
  }

  public LegalPersonsGetLegalPersonResponse latestDecision(LatestDecisionProperty1 latestDecision) {
  ...
  **/
  ...
  public LatestDecisionProperty1 getLatestDecision() {
    return latestDecision;
  }


  public void setLatestDecision(LatestDecisionProperty1 latestDecision) {
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse latestRiskRatingUrl(String latestRiskRatingUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse displayName(String displayName) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse applicationStatus(ApplicationStatusEnum applicationStatus) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonDecisionsUrl(String legalPersonDecisionsUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse statusChangedAt(OffsetDateTime statusChangedAt) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonClaimsUrl(String legalPersonClaimsUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonBankPayeesUrl(String legalPersonBankPayeesUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonVerificationsUrl(String legalPersonVerificationsUrl) {
  ...
  **/
  ...
  public LegalPersonsGetLegalPersonResponse legalPersonDocumentsUrl(String legalPersonDocumentsUrl) {
  ...
  **/
   ...
   * @return the LegalPersonsGetLegalPersonResponse instance itself
   */
  public LegalPersonsGetLegalPersonResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonsGetLegalPersonResponse legalPersonsGetLegalPersonResponse = (LegalPersonsGetLegalPersonResponse) o;
    return Objects.equals(this.latestDecision, legalPersonsGetLegalPersonResponse.latestDecision) &&
        Objects.equals(this.legalPersonType, legalPersonsGetLegalPersonResponse.legalPersonType) &&
        Objects.equals(this.latestRiskRatingUrl, legalPersonsGetLegalPersonResponse.latestRiskRatingUrl) &&
        Objects.equals(this.displayName, legalPersonsGetLegalPersonResponse.displayName) &&
        Objects.equals(this.applicationStatus, legalPersonsGetLegalPersonResponse.applicationStatus) &&
        Objects.equals(this.legalPersonUrl, legalPersonsGetLegalPersonResponse.legalPersonUrl) &&
        Objects.equals(this.legalPersonDecisionsUrl, legalPersonsGetLegalPersonResponse.legalPersonDecisionsUrl) &&
        Objects.equals(this.statusChangedAt, legalPersonsGetLegalPersonResponse.statusChangedAt) &&
        Objects.equals(this.createdAt, legalPersonsGetLegalPersonResponse.createdAt) &&
        Objects.equals(this.legalPersonClaimsUrl, legalPersonsGetLegalPersonResponse.legalPersonClaimsUrl) &&
        Objects.equals(this.legalPersonBankPayeesUrl, legalPersonsGetLegalPersonResponse.legalPersonBankPayeesUrl) &&
        Objects.equals(this.legalPersonVerificationsUrl, legalPersonsGetLegalPersonResponse.legalPersonVerificationsUrl) &&
        Objects.equals(this.legalPersonDocumentsUrl, legalPersonsGetLegalPersonResponse.legalPersonDocumentsUrl)&&
        Objects.equals(this.additionalProperties, legalPersonsGetLegalPersonResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegalPersonsGetLegalPersonResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonsGetLegalPersonResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonsGetLegalPersonResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonsGetLegalPersonResponse is not found in the empty JSON string", LegalPersonsGetLegalPersonResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonsGetLegalPersonResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("latest-decision") != null && !jsonObj.get("latest-decision").isJsonNull()) {
        LatestDecisionProperty1.validateJsonObject(jsonObj.getAsJsonObject("latest-decision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonsGetLegalPersonResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonsGetLegalPersonResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonsGetLegalPersonResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonsGetLegalPersonResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonsGetLegalPersonResponse>() {
           @Override
           public void write(JsonWriter out, LegalPersonsGetLegalPersonResponse value) throws IOException {
           ...
           @Override
           public LegalPersonsGetLegalPersonResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonsGetLegalPersonResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonsGetLegalPersonResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonsGetLegalPersonResponse
  * @throws IOException if the JSON string is invalid with respect to LegalPersonsGetLegalPersonResponse
  */
  public static LegalPersonsGetLegalPersonResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonsGetLegalPersonResponse.class);
  }

 /**
  * Convert an instance of LegalPersonsGetLegalPersonResponse to an JSON string
  *
  * @return JSON string
  */
