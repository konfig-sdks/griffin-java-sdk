...
public class WorkflowsGetWorkflowResponse {
 ...
 public enum InnerEnum {
  ...
  public static final String SERIALIZED_NAME_REQUIRED_CLAIM_TYPES = "required-claim-types";
  @SerializedName(SERIALIZED_NAME_REQUIRED_CLAIM_TYPES)
  private Map<String, Set<String>> requiredClaimTypes = null;

  /**
   * Gets or Sets workflowRules
   */
  @JsonAdapter(WorkflowRulesEnum.Adapter.class)
 public enum WorkflowRulesEnum {
    ...
    WorkflowRulesEnum(String value) {
      this.value = value;
    }
    ...
    public static WorkflowRulesEnum fromValue(String value) {
      for (WorkflowRulesEnum b : WorkflowRulesEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<WorkflowRulesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final WorkflowRulesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public WorkflowRulesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return WorkflowRulesEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_WORKFLOW_RULES = "workflow-rules";
  @SerializedName(SERIALIZED_NAME_WORKFLOW_RULES)
  private Set<WorkflowRulesEnum> workflowRules = null;

  public WorkflowsGetWorkflowResponse() {
  }

  public WorkflowsGetWorkflowResponse workflowUrl(String workflowUrl) {
  ...
  **/
  ...
  public WorkflowsGetWorkflowResponse displayName(String displayName) {
  ...
  **/
  ...
  public WorkflowsGetWorkflowResponse legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public WorkflowsGetWorkflowResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public WorkflowsGetWorkflowResponse requiredClaimTypes(Map<String, Set<String>> requiredClaimTypes) {
    
    
    
    
    this.requiredClaimTypes = requiredClaimTypes;
    return this;
  }

  public WorkflowsGetWorkflowResponse putRequiredClaimTypesItem(String key, Set<InnerEnum> requiredClaimTypesItem) {
    if (this.requiredClaimTypes == null) {
      this.requiredClaimTypes = new HashMap<>();
    }
    this.requiredClaimTypes.put(key, requiredClaimTypesItem);
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "A mapping of workflow-appropriate legal person types                                  to claims that are required for each type.")

  public Map<String, Set<String>> getRequiredClaimTypes() {
    return requiredClaimTypes;
  }


  public void setRequiredClaimTypes(Map<String, Set<String>> requiredClaimTypes) {
  ...
  public WorkflowsGetWorkflowResponse workflowRules(Set<WorkflowRulesEnum> workflowRules) {
  ...
  public WorkflowsGetWorkflowResponse addWorkflowRulesItem(WorkflowRulesEnum workflowRulesItem) {
    if (this.workflowRules == null) {
      this.workflowRules = new LinkedHashSet<>();
    }
    this.workflowRules.add(workflowRulesItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of special behaviours a workflow can possess.")

  public Set<WorkflowRulesEnum> getWorkflowRules() {
    return workflowRules;
  }


  public void setWorkflowRules(Set<WorkflowRulesEnum> workflowRules) {
   ...
   * @return the WorkflowsGetWorkflowResponse instance itself
   */
  public WorkflowsGetWorkflowResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowsGetWorkflowResponse workflowsGetWorkflowResponse = (WorkflowsGetWorkflowResponse) o;
    return Objects.equals(this.workflowUrl, workflowsGetWorkflowResponse.workflowUrl) &&
        Objects.equals(this.displayName, workflowsGetWorkflowResponse.displayName) &&
        Objects.equals(this.legalPersonType, workflowsGetWorkflowResponse.legalPersonType) &&
        Objects.equals(this.createdAt, workflowsGetWorkflowResponse.createdAt) &&
        Objects.equals(this.requiredClaimTypes, workflowsGetWorkflowResponse.requiredClaimTypes) &&
        Objects.equals(this.workflowRules, workflowsGetWorkflowResponse.workflowRules)&&
        Objects.equals(this.additionalProperties, workflowsGetWorkflowResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflowUrl, displayName, legalPersonType, createdAt, requiredClaimTypes, workflowRules, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkflowsGetWorkflowResponse {\n");
    ...
    sb.append("    requiredClaimTypes: ").append(toIndentedString(requiredClaimTypes)).append("\n");
    sb.append("    workflowRules: ").append(toIndentedString(workflowRules)).append("\n");
  ...
  static {
    ...
    openapiFields.add("required-claim-types");
    openapiFields.add("workflow-rules");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowsGetWorkflowResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowsGetWorkflowResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowsGetWorkflowResponse is not found in the empty JSON string", WorkflowsGetWorkflowResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowsGetWorkflowResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("workflow-rules") != null && !jsonObj.get("workflow-rules").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `workflow-rules` to be an array in the JSON string but got `%s`", jsonObj.get("workflow-rules").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowsGetWorkflowResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowsGetWorkflowResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowsGetWorkflowResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowsGetWorkflowResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowsGetWorkflowResponse>() {
           @Override
           public void write(JsonWriter out, WorkflowsGetWorkflowResponse value) throws IOException {
           ...
           @Override
           public WorkflowsGetWorkflowResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkflowsGetWorkflowResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkflowsGetWorkflowResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowsGetWorkflowResponse
  * @throws IOException if the JSON string is invalid with respect to WorkflowsGetWorkflowResponse
  */
  public static WorkflowsGetWorkflowResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowsGetWorkflowResponse.class);
  }

 /**
  * Convert an instance of WorkflowsGetWorkflowResponse to an JSON string
  *
  * @return JSON string
  */
