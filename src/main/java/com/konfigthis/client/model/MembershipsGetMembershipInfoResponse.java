...
import com.konfigthis.client.model.OrganizationProperty;
import com.konfigthis.client.model.Role1;
...
public class MembershipsGetMembershipInfoResponse {
  ...
  private OrganizationProperty organization;
  ...
  public MembershipsGetMembershipInfoResponse() {
  }

  public MembershipsGetMembershipInfoResponse membershipUrl(String membershipUrl) {
  ...
  **/
  ...
  public MembershipsGetMembershipInfoResponse membershipRolesUrl(String membershipRolesUrl) {
  ...
  **/
  ...
  public MembershipsGetMembershipInfoResponse organization(OrganizationProperty organization) {
  ...
  **/
  ...
  public OrganizationProperty getOrganization() {
    return organization;
  }


  public void setOrganization(OrganizationProperty organization) {
  ...
  public MembershipsGetMembershipInfoResponse roles(List<Role1> roles) {
  ...
  public MembershipsGetMembershipInfoResponse addRolesItem(Role1 rolesItem) {
  ...
  **/
  ...
  public MembershipsGetMembershipInfoResponse user(UserProperty user) {
  ...
  **/
  ...
  public UserProperty getUser() {
    return user;
  }


  public void setUser(UserProperty user) {
  ...
  public MembershipsGetMembershipInfoResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
   ...
   * @return the MembershipsGetMembershipInfoResponse instance itself
   */
  public MembershipsGetMembershipInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MembershipsGetMembershipInfoResponse membershipsGetMembershipInfoResponse = (MembershipsGetMembershipInfoResponse) o;
    return Objects.equals(this.membershipUrl, membershipsGetMembershipInfoResponse.membershipUrl) &&
        Objects.equals(this.membershipRolesUrl, membershipsGetMembershipInfoResponse.membershipRolesUrl) &&
        Objects.equals(this.organization, membershipsGetMembershipInfoResponse.organization) &&
        Objects.equals(this.roles, membershipsGetMembershipInfoResponse.roles) &&
        Objects.equals(this.user, membershipsGetMembershipInfoResponse.user) &&
        Objects.equals(this.createdAt, membershipsGetMembershipInfoResponse.createdAt)&&
        Objects.equals(this.additionalProperties, membershipsGetMembershipInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MembershipsGetMembershipInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MembershipsGetMembershipInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MembershipsGetMembershipInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MembershipsGetMembershipInfoResponse is not found in the empty JSON string", MembershipsGetMembershipInfoResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MembershipsGetMembershipInfoResponse.openapiRequiredFields) {
      ...
      OrganizationProperty.validateJsonObject(jsonObj.getAsJsonObject("organization"));
      ...
      for (int i = 0; i < jsonArrayroles.size(); i++) {
        Role1.validateJsonObject(jsonArrayroles.get(i).getAsJsonObject());
      };
      // validate the required field `user`
      UserProperty.validateJsonObject(jsonObj.getAsJsonObject("user"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipsGetMembershipInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipsGetMembershipInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipsGetMembershipInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipsGetMembershipInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipsGetMembershipInfoResponse>() {
           @Override
           public void write(JsonWriter out, MembershipsGetMembershipInfoResponse value) throws IOException {
           ...
           @Override
           public MembershipsGetMembershipInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MembershipsGetMembershipInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MembershipsGetMembershipInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MembershipsGetMembershipInfoResponse
  * @throws IOException if the JSON string is invalid with respect to MembershipsGetMembershipInfoResponse
  */
  public static MembershipsGetMembershipInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipsGetMembershipInfoResponse.class);
  }

 /**
  * Convert an instance of MembershipsGetMembershipInfoResponse to an JSON string
  *
  * @return JSON string
  */
