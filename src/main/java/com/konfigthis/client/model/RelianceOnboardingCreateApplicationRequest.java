...
public class RelianceOnboardingCreateApplicationRequest {
  public static final String SERIALIZED_NAME_WORKFLOW_URL = "workflow-url";
  @SerializedName(SERIALIZED_NAME_WORKFLOW_URL)
  private String workflowUrl;

  public static final String SERIALIZED_NAME_SUBJECT_PROFILE = "subject-profile";
  @SerializedName(SERIALIZED_NAME_SUBJECT_PROFILE)
  private SubjectProfileProperty subjectProfile;

  public static final String SERIALIZED_NAME_RELATED_PROFILES = "related-profiles";
  @SerializedName(SERIALIZED_NAME_RELATED_PROFILES)
  private List<RelatedProfile> relatedProfiles = null;

  public RelianceOnboardingCreateApplicationRequest() {
  }

  public RelianceOnboardingCreateApplicationRequest workflowUrl(String workflowUrl) {
  ...
  **/
  ...
  public RelianceOnboardingCreateApplicationRequest subjectProfile(SubjectProfileProperty subjectProfile) {
  ...
  **/
  ...
  public SubjectProfileProperty getSubjectProfile() {
    return subjectProfile;
  }


  public void setSubjectProfile(SubjectProfileProperty subjectProfile) {
  ...
  public RelianceOnboardingCreateApplicationRequest relatedProfiles(List<RelatedProfile> relatedProfiles) {
  ...
  public RelianceOnboardingCreateApplicationRequest addRelatedProfilesItem(RelatedProfile relatedProfilesItem) {
    if (this.relatedProfiles == null) {
      this.relatedProfiles = new ArrayList<>();
    }
    this.relatedProfiles.add(relatedProfilesItem);
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(value = "A list profiles related to the subject (e.g. directors, person with significant control).")
  ...
  public void setRelatedProfiles(List<RelatedProfile> relatedProfiles) {
   ...
   * @return the RelianceOnboardingCreateApplicationRequest instance itself
   */
  public RelianceOnboardingCreateApplicationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RelianceOnboardingCreateApplicationRequest relianceOnboardingCreateApplicationRequest = (RelianceOnboardingCreateApplicationRequest) o;
    return Objects.equals(this.workflowUrl, relianceOnboardingCreateApplicationRequest.workflowUrl) &&
        Objects.equals(this.subjectProfile, relianceOnboardingCreateApplicationRequest.subjectProfile) &&
        Objects.equals(this.relatedProfiles, relianceOnboardingCreateApplicationRequest.relatedProfiles)&&
        Objects.equals(this.additionalProperties, relianceOnboardingCreateApplicationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflowUrl, subjectProfile, relatedProfiles, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RelianceOnboardingCreateApplicationRequest {\n");
    sb.append("    workflowUrl: ").append(toIndentedString(workflowUrl)).append("\n");
    sb.append("    subjectProfile: ").append(toIndentedString(subjectProfile)).append("\n");
    sb.append("    relatedProfiles: ").append(toIndentedString(relatedProfiles)).append("\n");
  ...
  static {
    ...
    openapiFields.add("subject-profile");
    openapiFields.add("related-profiles");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("workflow-url");
    openapiRequiredFields.add("subject-profile");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RelianceOnboardingCreateApplicationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RelianceOnboardingCreateApplicationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RelianceOnboardingCreateApplicationRequest is not found in the empty JSON string", RelianceOnboardingCreateApplicationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RelianceOnboardingCreateApplicationRequest.openapiRequiredFields) {
      ...
      // validate the required field `subject-profile`
      SubjectProfileProperty.validateJsonObject(jsonObj.getAsJsonObject("subject-profile"));
      if (jsonObj.get("related-profiles") != null && !jsonObj.get("related-profiles").isJsonNull()) {
        JsonArray jsonArrayrelatedProfiles = jsonObj.getAsJsonArray("related-profiles");
        if (jsonArrayrelatedProfiles != null) {
          // ensure the json data is an array
          if (!jsonObj.get("related-profiles").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `related-profiles` to be an array in the JSON string but got `%s`", jsonObj.get("related-profiles").toString()));
          }

          // validate the optional field `related-profiles` (array)
          for (int i = 0; i < jsonArrayrelatedProfiles.size(); i++) {
            RelatedProfile.validateJsonObject(jsonArrayrelatedProfiles.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelianceOnboardingCreateApplicationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelianceOnboardingCreateApplicationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelianceOnboardingCreateApplicationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelianceOnboardingCreateApplicationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RelianceOnboardingCreateApplicationRequest>() {
           @Override
           public void write(JsonWriter out, RelianceOnboardingCreateApplicationRequest value) throws IOException {
           ...
           @Override
           public RelianceOnboardingCreateApplicationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RelianceOnboardingCreateApplicationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RelianceOnboardingCreateApplicationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RelianceOnboardingCreateApplicationRequest
  * @throws IOException if the JSON string is invalid with respect to RelianceOnboardingCreateApplicationRequest
  */
  public static RelianceOnboardingCreateApplicationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelianceOnboardingCreateApplicationRequest.class);
  }

 /**
  * Convert an instance of RelianceOnboardingCreateApplicationRequest to an JSON string
  *
  * @return JSON string
  */
