...
/**
 * AnnualTurnoverProperty4
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AnnualTurnoverProperty4 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty4() {
  }

  public AnnualTurnoverProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty4 value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty4 instance itself
   */
  public AnnualTurnoverProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty4 annualTurnoverProperty4 = (AnnualTurnoverProperty4) o;
    return Objects.equals(this.currency, annualTurnoverProperty4.currency) &&
        Objects.equals(this.value, annualTurnoverProperty4.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty4 is not found in the empty JSON string", AnnualTurnoverProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty4>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty4 value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty4
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty4
  */
  public static AnnualTurnoverProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty4.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty4 to an JSON string
  *
  * @return JSON string
  */
