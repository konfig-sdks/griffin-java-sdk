...
public class UserProperty1 {
  ...
  public UserProperty1() {
  }

  public UserProperty1 userEmail(String userEmail) {
  ...
  **/
  ...
  public UserProperty1 userUrl(String userUrl) {
  ...
  **/
  ...
  public UserProperty1 userUsername(String userUsername) {
  ...
  **/
  ...
  public UserProperty1 apiKeysUrl(String apiKeysUrl) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/v0/users/ur.ICAgICAgICAgdXNlci1pZA/api-keys", required = true, value = "Link to the user's [api keys](http://docs.griffin.com).")
  ...
  public UserProperty1 userMembershipsUrl(String userMembershipsUrl) {
  ...
  **/
  ...
  public UserProperty1 givenName(String givenName) {
  ...
  **/
  ...
  public UserProperty1 surname(String surname) {
  ...
  **/
   ...
   * @return the UserProperty1 instance itself
   */
  public UserProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserProperty1 userProperty1 = (UserProperty1) o;
    return Objects.equals(this.userEmail, userProperty1.userEmail) &&
        Objects.equals(this.userUrl, userProperty1.userUrl) &&
        Objects.equals(this.userUsername, userProperty1.userUsername) &&
        Objects.equals(this.apiKeysUrl, userProperty1.apiKeysUrl) &&
        Objects.equals(this.userMembershipsUrl, userProperty1.userMembershipsUrl) &&
        Objects.equals(this.givenName, userProperty1.givenName) &&
        Objects.equals(this.surname, userProperty1.surname)&&
        Objects.equals(this.additionalProperties, userProperty1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserProperty1 is not found in the empty JSON string", UserProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<UserProperty1>() {
           @Override
           public void write(JsonWriter out, UserProperty1 value) throws IOException {
           ...
           @Override
           public UserProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserProperty1
  * @throws IOException if the JSON string is invalid with respect to UserProperty1
  */
  public static UserProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserProperty1.class);
  }

 /**
  * Convert an instance of UserProperty1 to an JSON string
  *
  * @return JSON string
  */
