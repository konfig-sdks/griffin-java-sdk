...
public class UltimateDebtorProperty {
 ...
 public enum BankIdCodeEnum {
  ...
  public UltimateDebtorProperty() {
  }

  public UltimateDebtorProperty accountNumber(String accountNumber) {
  ...
  **/
  ...
  public UltimateDebtorProperty accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty bankId(String bankId) {
  ...
  **/
  ...
  public UltimateDebtorProperty bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty accountHolder(String accountHolder) {
  ...
  **/
  ...
  public UltimateDebtorProperty accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the UltimateDebtorProperty instance itself
   */
  public UltimateDebtorProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UltimateDebtorProperty ultimateDebtorProperty = (UltimateDebtorProperty) o;
    return Objects.equals(this.accountNumber, ultimateDebtorProperty.accountNumber) &&
        Objects.equals(this.accountNumberCode, ultimateDebtorProperty.accountNumberCode) &&
        Objects.equals(this.bankId, ultimateDebtorProperty.bankId) &&
        Objects.equals(this.bankIdCode, ultimateDebtorProperty.bankIdCode) &&
        Objects.equals(this.accountHolder, ultimateDebtorProperty.accountHolder) &&
        Objects.equals(this.accountUrl, ultimateDebtorProperty.accountUrl)&&
        Objects.equals(this.additionalProperties, ultimateDebtorProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UltimateDebtorProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UltimateDebtorProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UltimateDebtorProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UltimateDebtorProperty is not found in the empty JSON string", UltimateDebtorProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UltimateDebtorProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UltimateDebtorProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UltimateDebtorProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UltimateDebtorProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UltimateDebtorProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<UltimateDebtorProperty>() {
           @Override
           public void write(JsonWriter out, UltimateDebtorProperty value) throws IOException {
           ...
           @Override
           public UltimateDebtorProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UltimateDebtorProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UltimateDebtorProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UltimateDebtorProperty
  * @throws IOException if the JSON string is invalid with respect to UltimateDebtorProperty
  */
  public static UltimateDebtorProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UltimateDebtorProperty.class);
  }

 /**
  * Convert an instance of UltimateDebtorProperty to an JSON string
  *
  * @return JSON string
  */
