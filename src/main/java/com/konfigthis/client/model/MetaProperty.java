...
import com.konfigthis.client.model.PageProperty;
...
public class MetaProperty {
  ...
  public MetaProperty page(PageProperty page) {
  ...
  **/
  ...
  public PageProperty getPage() {
    return page;
  }


  public void setPage(PageProperty page) {
   ...
   * @return the MetaProperty instance itself
   */
  public MetaProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.page, metaProperty.page)&&
        Objects.equals(this.additionalProperties, metaProperty.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetaProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetaProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetaProperty is not found in the empty JSON string", MetaProperty.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `page`
      if (jsonObj.get("page") != null && !jsonObj.get("page").isJsonNull()) {
        PageProperty.validateJsonObject(jsonObj.getAsJsonObject("page"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetaProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetaProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetaProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetaProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<MetaProperty>() {
           @Override
           public void write(JsonWriter out, MetaProperty value) throws IOException {
           ...
           @Override
           public MetaProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetaProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetaProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetaProperty
  * @throws IOException if the JSON string is invalid with respect to MetaProperty
  */
  public static MetaProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetaProperty.class);
  }

 /**
  * Convert an instance of MetaProperty to an JSON string
  *
  * @return JSON string
  */
