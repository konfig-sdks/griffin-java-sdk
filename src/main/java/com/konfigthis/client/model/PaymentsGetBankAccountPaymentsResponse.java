...
public class PaymentsGetBankAccountPaymentsResponse {
  ...
  public PaymentsGetBankAccountPaymentsResponse() {
  }

  public PaymentsGetBankAccountPaymentsResponse payments(List<Payment> payments) {
  ...
  public PaymentsGetBankAccountPaymentsResponse addPaymentsItem(Payment paymentsItem) {
  ...
  **/
  ...
  public PaymentsGetBankAccountPaymentsResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the PaymentsGetBankAccountPaymentsResponse instance itself
   */
  public PaymentsGetBankAccountPaymentsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsGetBankAccountPaymentsResponse paymentsGetBankAccountPaymentsResponse = (PaymentsGetBankAccountPaymentsResponse) o;
    return Objects.equals(this.payments, paymentsGetBankAccountPaymentsResponse.payments) &&
        Objects.equals(this.links, paymentsGetBankAccountPaymentsResponse.links)&&
        Objects.equals(this.additionalProperties, paymentsGetBankAccountPaymentsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payments, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsGetBankAccountPaymentsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsGetBankAccountPaymentsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsGetBankAccountPaymentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsGetBankAccountPaymentsResponse is not found in the empty JSON string", PaymentsGetBankAccountPaymentsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsGetBankAccountPaymentsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsGetBankAccountPaymentsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsGetBankAccountPaymentsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsGetBankAccountPaymentsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsGetBankAccountPaymentsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsGetBankAccountPaymentsResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsGetBankAccountPaymentsResponse value) throws IOException {
           ...
           @Override
           public PaymentsGetBankAccountPaymentsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsGetBankAccountPaymentsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsGetBankAccountPaymentsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsGetBankAccountPaymentsResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsGetBankAccountPaymentsResponse
  */
  public static PaymentsGetBankAccountPaymentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsGetBankAccountPaymentsResponse.class);
  }

 /**
  * Convert an instance of PaymentsGetBankAccountPaymentsResponse to an JSON string
  *
  * @return JSON string
  */
