...
public class AccountBalanceProperty2 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty2() {
  }

  public AccountBalanceProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty2 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty2 instance itself
   */
  public AccountBalanceProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty2 accountBalanceProperty2 = (AccountBalanceProperty2) o;
    return Objects.equals(this.currency, accountBalanceProperty2.currency) &&
        Objects.equals(this.value, accountBalanceProperty2.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty2 is not found in the empty JSON string", AccountBalanceProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty2>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty2 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty2
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty2
  */
  public static AccountBalanceProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty2.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty2 to an JSON string
  *
  * @return JSON string
  */
