...
/**
 * InitialDepositProperty2
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InitialDepositProperty2 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty2() {
  }

  public InitialDepositProperty2 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty2 value(String value) {
  ...
  **/
   ...
   * @return the InitialDepositProperty2 instance itself
   */
  public InitialDepositProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty2 initialDepositProperty2 = (InitialDepositProperty2) o;
    return Objects.equals(this.currency, initialDepositProperty2.currency) &&
        Objects.equals(this.value, initialDepositProperty2.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty2 is not found in the empty JSON string", InitialDepositProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty2>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty2 value) throws IOException {
           ...
           @Override
           public InitialDepositProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty2
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty2
  */
  public static InitialDepositProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty2.class);
  }

 /**
  * Convert an instance of InitialDepositProperty2 to an JSON string
  *
  * @return JSON string
  */
