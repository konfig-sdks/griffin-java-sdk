...
import com.konfigthis.client.model.Property2;
...
public class BankAccountsListResponse {
  ...
  private Property2 included;

  public BankAccountsListResponse() {
  }

  public BankAccountsListResponse accounts(List<BankAccount> accounts) {
  ...
  public BankAccountsListResponse addAccountsItem(BankAccount accountsItem) {
  ...
  **/
  ...
  public BankAccountsListResponse links(LinksProperty links) {
  ...
  **/
  ...
  public BankAccountsListResponse included(Property2 included) {
  ...
  **/
  ...
  public Property2 getIncluded() {
    return included;
  }


  public void setIncluded(Property2 included) {
   ...
   * @return the BankAccountsListResponse instance itself
   */
  public BankAccountsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsListResponse bankAccountsListResponse = (BankAccountsListResponse) o;
    return Objects.equals(this.accounts, bankAccountsListResponse.accounts) &&
        Objects.equals(this.links, bankAccountsListResponse.links) &&
        Objects.equals(this.included, bankAccountsListResponse.included)&&
        Objects.equals(this.additionalProperties, bankAccountsListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accounts, links, included, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BankAccountsListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsListResponse is not found in the empty JSON string", BankAccountsListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsListResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayaccounts.size(); i++) {
        BankAccount.validateJsonObject(jsonArrayaccounts.get(i).getAsJsonObject());
      };
      ...
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        Property2.validateJsonObject(jsonObj.getAsJsonObject("included"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsListResponse>() {
           @Override
           public void write(JsonWriter out, BankAccountsListResponse value) throws IOException {
           ...
           @Override
           public BankAccountsListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsListResponse
  * @throws IOException if the JSON string is invalid with respect to BankAccountsListResponse
  */
  public static BankAccountsListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsListResponse.class);
  }

 /**
  * Convert an instance of BankAccountsListResponse to an JSON string
  *
  * @return JSON string
  */
