...
public class UltimateDebtorProperty1 {
 ...
 public enum BankIdCodeEnum {
  ...
  public UltimateDebtorProperty1() {
  }

  public UltimateDebtorProperty1 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 bankId(String bankId) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the UltimateDebtorProperty1 instance itself
   */
  public UltimateDebtorProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UltimateDebtorProperty1 ultimateDebtorProperty1 = (UltimateDebtorProperty1) o;
    return Objects.equals(this.accountNumber, ultimateDebtorProperty1.accountNumber) &&
        Objects.equals(this.accountNumberCode, ultimateDebtorProperty1.accountNumberCode) &&
        Objects.equals(this.bankId, ultimateDebtorProperty1.bankId) &&
        Objects.equals(this.bankIdCode, ultimateDebtorProperty1.bankIdCode) &&
        Objects.equals(this.accountHolder, ultimateDebtorProperty1.accountHolder) &&
        Objects.equals(this.accountUrl, ultimateDebtorProperty1.accountUrl)&&
        Objects.equals(this.additionalProperties, ultimateDebtorProperty1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountNumberCode, bankId, bankIdCode, accountHolder, accountUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UltimateDebtorProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UltimateDebtorProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UltimateDebtorProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UltimateDebtorProperty1 is not found in the empty JSON string", UltimateDebtorProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UltimateDebtorProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UltimateDebtorProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UltimateDebtorProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UltimateDebtorProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UltimateDebtorProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<UltimateDebtorProperty1>() {
           @Override
           public void write(JsonWriter out, UltimateDebtorProperty1 value) throws IOException {
           ...
           @Override
           public UltimateDebtorProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UltimateDebtorProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UltimateDebtorProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UltimateDebtorProperty1
  * @throws IOException if the JSON string is invalid with respect to UltimateDebtorProperty1
  */
  public static UltimateDebtorProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UltimateDebtorProperty1.class);
  }

 /**
  * Convert an instance of UltimateDebtorProperty1 to an JSON string
  *
  * @return JSON string
  */
