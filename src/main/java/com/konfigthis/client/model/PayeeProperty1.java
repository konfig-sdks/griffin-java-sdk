...
public class PayeeProperty1 {
 ...
 public enum BankIdCodeEnum {
  ...
  public PayeeProperty1() {
  }

  public PayeeProperty1 payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeeProperty1 creditorType(CreditorTypeEnum creditorType) {
  ...
  **/
  ...
  public PayeeProperty1 accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeeProperty1 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeeProperty1 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeeProperty1 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public PayeeProperty1 bankId(String bankId) {
  ...
  **/
  ...
  public PayeeProperty1 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
   ...
   * @return the PayeeProperty1 instance itself
   */
  public PayeeProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeeProperty1 payeeProperty1 = (PayeeProperty1) o;
    return Objects.equals(this.payeeUrl, payeeProperty1.payeeUrl) &&
        Objects.equals(this.creditorType, payeeProperty1.creditorType) &&
        Objects.equals(this.accountUrl, payeeProperty1.accountUrl) &&
        Objects.equals(this.accountHolder, payeeProperty1.accountHolder) &&
        Objects.equals(this.accountNumber, payeeProperty1.accountNumber) &&
        Objects.equals(this.accountNumberCode, payeeProperty1.accountNumberCode) &&
        Objects.equals(this.bankId, payeeProperty1.bankId) &&
        Objects.equals(this.bankIdCode, payeeProperty1.bankIdCode)&&
        Objects.equals(this.additionalProperties, payeeProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayeeProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeeProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeeProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeeProperty1 is not found in the empty JSON string", PayeeProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeeProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeeProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeeProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeeProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeeProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeeProperty1>() {
           @Override
           public void write(JsonWriter out, PayeeProperty1 value) throws IOException {
           ...
           @Override
           public PayeeProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeeProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeeProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeeProperty1
  * @throws IOException if the JSON string is invalid with respect to PayeeProperty1
  */
  public static PayeeProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeeProperty1.class);
  }

 /**
  * Convert an instance of PayeeProperty1 to an JSON string
  *
  * @return JSON string
  */
