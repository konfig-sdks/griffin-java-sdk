...
public class DirectorProperty {
  ...
  public DirectorProperty() {
  }

  public DirectorProperty companiesHouseUrl(String companiesHouseUrl) {
  ...
  **/
   ...
   * @return the DirectorProperty instance itself
   */
  public DirectorProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DirectorProperty directorProperty = (DirectorProperty) o;
    return Objects.equals(this.companiesHouseUrl, directorProperty.companiesHouseUrl)&&
        Objects.equals(this.additionalProperties, directorProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companiesHouseUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DirectorProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DirectorProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DirectorProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectorProperty is not found in the empty JSON string", DirectorProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectorProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectorProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectorProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectorProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectorProperty>() {
           @Override
           public void write(JsonWriter out, DirectorProperty value) throws IOException {
           ...
           @Override
           public DirectorProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DirectorProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DirectorProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DirectorProperty
  * @throws IOException if the JSON string is invalid with respect to DirectorProperty
  */
  public static DirectorProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectorProperty.class);
  }

 /**
  * Convert an instance of DirectorProperty to an JSON string
  *
  * @return JSON string
  */
