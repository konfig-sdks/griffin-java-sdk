...
public class DebtorProperty1 {
 ...
 public enum BankIdCodeEnum {
  ...
  public DebtorProperty1() {
  }

  public DebtorProperty1 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public DebtorProperty1 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public DebtorProperty1 bankId(String bankId) {
  ...
  **/
  ...
  public DebtorProperty1 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public DebtorProperty1 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public DebtorProperty1 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the DebtorProperty1 instance itself
   */
  public DebtorProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DebtorProperty1 debtorProperty1 = (DebtorProperty1) o;
    return Objects.equals(this.accountNumber, debtorProperty1.accountNumber) &&
        Objects.equals(this.accountNumberCode, debtorProperty1.accountNumberCode) &&
        Objects.equals(this.bankId, debtorProperty1.bankId) &&
        Objects.equals(this.bankIdCode, debtorProperty1.bankIdCode) &&
        Objects.equals(this.accountHolder, debtorProperty1.accountHolder) &&
        Objects.equals(this.accountUrl, debtorProperty1.accountUrl)&&
        Objects.equals(this.additionalProperties, debtorProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtorProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DebtorProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DebtorProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DebtorProperty1 is not found in the empty JSON string", DebtorProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DebtorProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DebtorProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DebtorProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DebtorProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebtorProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<DebtorProperty1>() {
           @Override
           public void write(JsonWriter out, DebtorProperty1 value) throws IOException {
           ...
           @Override
           public DebtorProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DebtorProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DebtorProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DebtorProperty1
  * @throws IOException if the JSON string is invalid with respect to DebtorProperty1
  */
  public static DebtorProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DebtorProperty1.class);
  }

 /**
  * Convert an instance of DebtorProperty1 to an JSON string
  *
  * @return JSON string
  */
