...
public class AccountBalanceProperty6 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AccountBalanceProperty6() {
  }

  public AccountBalanceProperty6 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AccountBalanceProperty6 value(String value) {
  ...
  **/
   ...
   * @return the AccountBalanceProperty6 instance itself
   */
  public AccountBalanceProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountBalanceProperty6 accountBalanceProperty6 = (AccountBalanceProperty6) o;
    return Objects.equals(this.currency, accountBalanceProperty6.currency) &&
        Objects.equals(this.value, accountBalanceProperty6.value)&&
        Objects.equals(this.additionalProperties, accountBalanceProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountBalanceProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountBalanceProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalanceProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountBalanceProperty6 is not found in the empty JSON string", AccountBalanceProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountBalanceProperty6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountBalanceProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountBalanceProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountBalanceProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountBalanceProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountBalanceProperty6>() {
           @Override
           public void write(JsonWriter out, AccountBalanceProperty6 value) throws IOException {
           ...
           @Override
           public AccountBalanceProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountBalanceProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountBalanceProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountBalanceProperty6
  * @throws IOException if the JSON string is invalid with respect to AccountBalanceProperty6
  */
  public static AccountBalanceProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountBalanceProperty6.class);
  }

 /**
  * Convert an instance of AccountBalanceProperty6 to an JSON string
  *
  * @return JSON string
  */
