...
public class AnnualTurnoverProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AnnualTurnoverProperty1() {
  }

  public AnnualTurnoverProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AnnualTurnoverProperty1 value(String value) {
  ...
  **/
   ...
   * @return the AnnualTurnoverProperty1 instance itself
   */
  public AnnualTurnoverProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AnnualTurnoverProperty1 annualTurnoverProperty1 = (AnnualTurnoverProperty1) o;
    return Objects.equals(this.currency, annualTurnoverProperty1.currency) &&
        Objects.equals(this.value, annualTurnoverProperty1.value)&&
        Objects.equals(this.additionalProperties, annualTurnoverProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnualTurnoverProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnnualTurnoverProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AnnualTurnoverProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnualTurnoverProperty1 is not found in the empty JSON string", AnnualTurnoverProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnnualTurnoverProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnualTurnoverProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnualTurnoverProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnualTurnoverProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnualTurnoverProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnualTurnoverProperty1>() {
           @Override
           public void write(JsonWriter out, AnnualTurnoverProperty1 value) throws IOException {
           ...
           @Override
           public AnnualTurnoverProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AnnualTurnoverProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AnnualTurnoverProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnnualTurnoverProperty1
  * @throws IOException if the JSON string is invalid with respect to AnnualTurnoverProperty1
  */
  public static AnnualTurnoverProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnualTurnoverProperty1.class);
  }

 /**
  * Convert an instance of AnnualTurnoverProperty1 to an JSON string
  *
  * @return JSON string
  */
