...
public class Admission {
 ...
 public enum AdmissionStatusEnum {
  ...
  public Admission admissionStatus(AdmissionStatusEnum admissionStatus) {
  ...
  **/
  ...
  public Admission admissionSchemeInformation(FpsProperty admissionSchemeInformation) {
  ...
  **/
  ...
  public Admission paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public Admission createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Admission admissionUrl(String admissionUrl) {
  ...
  **/
   ...
   * @return the Admission instance itself
   */
  public Admission putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.admissionStatus, admission.admissionStatus) &&
        Objects.equals(this.admissionSchemeInformation, admission.admissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, admission.paymentUrl) &&
        Objects.equals(this.createdAt, admission.createdAt) &&
        Objects.equals(this.admissionUrl, admission.admissionUrl)&&
        Objects.equals(this.additionalProperties, admission.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Admission
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Admission.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Admission.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Admission>() {
           ...
           public Admission read(JsonReader in) throws IOException {
             ...
             Admission instance = thisAdapter.fromJsonTree(jsonObj);
