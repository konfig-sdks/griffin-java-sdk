 ...
 */
@ApiModel(description = "Compound value representing both the currency and amount of money being sent.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PaymentAmountProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public PaymentAmountProperty1() {
  }

  public PaymentAmountProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public PaymentAmountProperty1 value(String value) {
  ...
  **/
   ...
   * @return the PaymentAmountProperty1 instance itself
   */
  public PaymentAmountProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentAmountProperty1 paymentAmountProperty1 = (PaymentAmountProperty1) o;
    return Objects.equals(this.currency, paymentAmountProperty1.currency) &&
        Objects.equals(this.value, paymentAmountProperty1.value)&&
        Objects.equals(this.additionalProperties, paymentAmountProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAmountProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAmountProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAmountProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountProperty1 is not found in the empty JSON string", PaymentAmountProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountProperty1>() {
           @Override
           public void write(JsonWriter out, PaymentAmountProperty1 value) throws IOException {
           ...
           @Override
           public PaymentAmountProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentAmountProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentAmountProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAmountProperty1
  * @throws IOException if the JSON string is invalid with respect to PaymentAmountProperty1
  */
  public static PaymentAmountProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountProperty1.class);
  }

 /**
  * Convert an instance of PaymentAmountProperty1 to an JSON string
  *
  * @return JSON string
  */
