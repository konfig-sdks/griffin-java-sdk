...
import com.konfigthis.client.model.LatestDecisionProperty5;
...
public class LegalPersonsCreateNewLegalPersonResponse {
 ...
 public enum ApplicationStatusEnum {
  ...
  public LegalPersonsCreateNewLegalPersonResponse() {
  }

  public LegalPersonsCreateNewLegalPersonResponse latestDecision(LatestDecisionProperty5 latestDecision) {
  ...
  **/
  ...
  public LatestDecisionProperty5 getLatestDecision() {
    return latestDecision;
  }


  public void setLatestDecision(LatestDecisionProperty5 latestDecision) {
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse latestRiskRatingUrl(String latestRiskRatingUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse displayName(String displayName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Company name", required = true, value = "The mutable display name for the Legal-Person")
  ...
  public LegalPersonsCreateNewLegalPersonResponse applicationStatus(ApplicationStatusEnum applicationStatus) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonDecisionsUrl(String legalPersonDecisionsUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse statusChangedAt(OffsetDateTime statusChangedAt) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonClaimsUrl(String legalPersonClaimsUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonBankPayeesUrl(String legalPersonBankPayeesUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonVerificationsUrl(String legalPersonVerificationsUrl) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonResponse legalPersonDocumentsUrl(String legalPersonDocumentsUrl) {
  ...
  **/
   ...
   * @return the LegalPersonsCreateNewLegalPersonResponse instance itself
   */
  public LegalPersonsCreateNewLegalPersonResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonsCreateNewLegalPersonResponse legalPersonsCreateNewLegalPersonResponse = (LegalPersonsCreateNewLegalPersonResponse) o;
    return Objects.equals(this.latestDecision, legalPersonsCreateNewLegalPersonResponse.latestDecision) &&
        Objects.equals(this.legalPersonType, legalPersonsCreateNewLegalPersonResponse.legalPersonType) &&
        Objects.equals(this.latestRiskRatingUrl, legalPersonsCreateNewLegalPersonResponse.latestRiskRatingUrl) &&
        Objects.equals(this.displayName, legalPersonsCreateNewLegalPersonResponse.displayName) &&
        Objects.equals(this.applicationStatus, legalPersonsCreateNewLegalPersonResponse.applicationStatus) &&
        Objects.equals(this.legalPersonUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonUrl) &&
        Objects.equals(this.legalPersonDecisionsUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonDecisionsUrl) &&
        Objects.equals(this.statusChangedAt, legalPersonsCreateNewLegalPersonResponse.statusChangedAt) &&
        Objects.equals(this.createdAt, legalPersonsCreateNewLegalPersonResponse.createdAt) &&
        Objects.equals(this.legalPersonClaimsUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonClaimsUrl) &&
        Objects.equals(this.legalPersonBankPayeesUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonBankPayeesUrl) &&
        Objects.equals(this.legalPersonVerificationsUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonVerificationsUrl) &&
        Objects.equals(this.legalPersonDocumentsUrl, legalPersonsCreateNewLegalPersonResponse.legalPersonDocumentsUrl)&&
        Objects.equals(this.additionalProperties, legalPersonsCreateNewLegalPersonResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegalPersonsCreateNewLegalPersonResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonsCreateNewLegalPersonResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonsCreateNewLegalPersonResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonsCreateNewLegalPersonResponse is not found in the empty JSON string", LegalPersonsCreateNewLegalPersonResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonsCreateNewLegalPersonResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("latest-decision") != null && !jsonObj.get("latest-decision").isJsonNull()) {
        LatestDecisionProperty5.validateJsonObject(jsonObj.getAsJsonObject("latest-decision"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonsCreateNewLegalPersonResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonsCreateNewLegalPersonResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonsCreateNewLegalPersonResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonsCreateNewLegalPersonResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonsCreateNewLegalPersonResponse>() {
           @Override
           public void write(JsonWriter out, LegalPersonsCreateNewLegalPersonResponse value) throws IOException {
           ...
           @Override
           public LegalPersonsCreateNewLegalPersonResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonsCreateNewLegalPersonResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonsCreateNewLegalPersonResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonsCreateNewLegalPersonResponse
  * @throws IOException if the JSON string is invalid with respect to LegalPersonsCreateNewLegalPersonResponse
  */
  public static LegalPersonsCreateNewLegalPersonResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonsCreateNewLegalPersonResponse.class);
  }

 /**
  * Convert an instance of LegalPersonsCreateNewLegalPersonResponse to an JSON string
  *
  * @return JSON string
  */
