...
public class Role2 {
  ...
  public Role2 description(String description) {
  ...
  **/
  ...
  public Role2 displayName(String displayName) {
  ...
  **/
  ...
  public Role2 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role2 instance itself
   */
  public Role2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role2 role2 = (Role2) o;
    return Objects.equals(this.description, role2.description) &&
        Objects.equals(this.displayName, role2.displayName) &&
        Objects.equals(this.roleUrl, role2.roleUrl)&&
        Objects.equals(this.additionalProperties, role2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role2 is not found in the empty JSON string", Role2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role2.class));

       return (TypeAdapter<T>) new TypeAdapter<Role2>() {
           @Override
           public void write(JsonWriter out, Role2 value) throws IOException {
           ...
           @Override
           public Role2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role2
  * @throws IOException if the JSON string is invalid with respect to Role2
  */
  public static Role2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role2.class);
  }

 /**
  * Convert an instance of Role2 to an JSON string
  *
  * @return JSON string
  */
