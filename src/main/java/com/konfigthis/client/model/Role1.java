...
public class Role1 {
  ...
  public Role1 description(String description) {
  ...
  **/
  ...
  public Role1 displayName(String displayName) {
  ...
  **/
  ...
  public Role1 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role1 instance itself
   */
  public Role1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role1 role1 = (Role1) o;
    return Objects.equals(this.description, role1.description) &&
        Objects.equals(this.displayName, role1.displayName) &&
        Objects.equals(this.roleUrl, role1.roleUrl)&&
        Objects.equals(this.additionalProperties, role1.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Role1>() {
           ...
           public Role1 read(JsonReader in) throws IOException {
             ...
             Role1 instance = thisAdapter.fromJsonTree(jsonObj);
