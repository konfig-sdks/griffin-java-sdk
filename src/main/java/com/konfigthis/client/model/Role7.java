...
public class Role7 {
  ...
  public Role7 description(String description) {
  ...
  **/
  ...
  public Role7 displayName(String displayName) {
  ...
  **/
  ...
  public Role7 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role7 instance itself
   */
  public Role7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role7 role7 = (Role7) o;
    return Objects.equals(this.description, role7.description) &&
        Objects.equals(this.displayName, role7.displayName) &&
        Objects.equals(this.roleUrl, role7.roleUrl)&&
        Objects.equals(this.additionalProperties, role7.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role7 is not found in the empty JSON string", Role7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role7.class));

       return (TypeAdapter<T>) new TypeAdapter<Role7>() {
           @Override
           public void write(JsonWriter out, Role7 value) throws IOException {
           ...
           @Override
           public Role7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role7
  * @throws IOException if the JSON string is invalid with respect to Role7
  */
  public static Role7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role7.class);
  }

 /**
  * Convert an instance of Role7 to an JSON string
  *
  * @return JSON string
  */
