 ...
 */
@ApiModel(description = "Shows the associated [organization](http://docs.griffin.com).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrganizationProperty {
 ...
 public enum OrganizationModeEnum {
  ...
  public OrganizationProperty ownLegalPersonUrl(String ownLegalPersonUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationMode(OrganizationModeEnum organizationMode) {
  ...
  **/
  ...
  public OrganizationProperty organizationMembershipsUrl(String organizationMembershipsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationInvitationsUrl(String organizationInvitationsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationOnboardingApplicationsUrl(String organizationOnboardingApplicationsUrl) {
  ...
  **/
  ...
  public OrganizationProperty displayName(String displayName) {
  ...
  **/
  ...
  public OrganizationProperty organizationApiKeysUrl(String organizationApiKeysUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationLiveAccessUrl(String organizationLiveAccessUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationWebhooksUrl(String organizationWebhooksUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationWorkflowsUrl(String organizationWorkflowsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationBankAccountsUrl(String organizationBankAccountsUrl) {
  ...
  **/
  ...
  public OrganizationProperty availableRoles(List<Role> availableRoles) {
  ...
  public OrganizationProperty addAvailableRolesItem(Role availableRolesItem) {
  ...
  **/
  ...
  public OrganizationProperty canDecideOnVerificationsQuestionMark(Boolean canDecideOnVerificationsQuestionMark) {
  ...
  **/
  ...
  public OrganizationProperty organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationIndividualsUrl(String organizationIndividualsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationCorporationsUrl(String organizationCorporationsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationLegalPersonsUrl(String organizationLegalPersonsUrl) {
  ...
  **/
  ...
  public OrganizationProperty organizationEventsUrl(String organizationEventsUrl) {
  ...
  **/
   ...
   * @return the OrganizationProperty instance itself
   */
  public OrganizationProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationProperty organizationProperty = (OrganizationProperty) o;
    return Objects.equals(this.ownLegalPersonUrl, organizationProperty.ownLegalPersonUrl) &&
        Objects.equals(this.organizationMode, organizationProperty.organizationMode) &&
        Objects.equals(this.organizationMembershipsUrl, organizationProperty.organizationMembershipsUrl) &&
        Objects.equals(this.organizationInvitationsUrl, organizationProperty.organizationInvitationsUrl) &&
        Objects.equals(this.organizationOnboardingApplicationsUrl, organizationProperty.organizationOnboardingApplicationsUrl) &&
        Objects.equals(this.displayName, organizationProperty.displayName) &&
        Objects.equals(this.organizationApiKeysUrl, organizationProperty.organizationApiKeysUrl) &&
        Objects.equals(this.organizationLiveAccessUrl, organizationProperty.organizationLiveAccessUrl) &&
        Objects.equals(this.organizationWebhooksUrl, organizationProperty.organizationWebhooksUrl) &&
        Objects.equals(this.organizationWorkflowsUrl, organizationProperty.organizationWorkflowsUrl) &&
        Objects.equals(this.organizationBankAccountsUrl, organizationProperty.organizationBankAccountsUrl) &&
        Objects.equals(this.availableRoles, organizationProperty.availableRoles) &&
        Objects.equals(this.canDecideOnVerificationsQuestionMark, organizationProperty.canDecideOnVerificationsQuestionMark) &&
        Objects.equals(this.organizationUrl, organizationProperty.organizationUrl) &&
        Objects.equals(this.organizationIndividualsUrl, organizationProperty.organizationIndividualsUrl) &&
        Objects.equals(this.organizationCorporationsUrl, organizationProperty.organizationCorporationsUrl) &&
        Objects.equals(this.organizationLegalPersonsUrl, organizationProperty.organizationLegalPersonsUrl) &&
        Objects.equals(this.organizationEventsUrl, organizationProperty.organizationEventsUrl)&&
        Objects.equals(this.additionalProperties, organizationProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrganizationProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrganizationProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationProperty is not found in the empty JSON string", OrganizationProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrganizationProperty.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayavailableRoles.size(); i++) {
        Role.validateJsonObject(jsonArrayavailableRoles.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationProperty>() {
           @Override
           public void write(JsonWriter out, OrganizationProperty value) throws IOException {
           ...
           @Override
           public OrganizationProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrganizationProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrganizationProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationProperty
  * @throws IOException if the JSON string is invalid with respect to OrganizationProperty
  */
  public static OrganizationProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationProperty.class);
  }

 /**
  * Convert an instance of OrganizationProperty to an JSON string
  *
  * @return JSON string
  */
