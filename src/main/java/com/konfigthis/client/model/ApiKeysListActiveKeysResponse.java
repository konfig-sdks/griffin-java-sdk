...
public class ApiKeysListActiveKeysResponse {
  ...
  public ApiKeysListActiveKeysResponse() {
  }

  public ApiKeysListActiveKeysResponse apiKeys(List<ApiKey> apiKeys) {
  ...
  public ApiKeysListActiveKeysResponse addApiKeysItem(ApiKey apiKeysItem) {
  ...
  **/
  ...
  public ApiKeysListActiveKeysResponse links(LinksProperty links) {
  ...
  **/
   ...
   * @return the ApiKeysListActiveKeysResponse instance itself
   */
  public ApiKeysListActiveKeysResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeysListActiveKeysResponse apiKeysListActiveKeysResponse = (ApiKeysListActiveKeysResponse) o;
    return Objects.equals(this.apiKeys, apiKeysListActiveKeysResponse.apiKeys) &&
        Objects.equals(this.links, apiKeysListActiveKeysResponse.links)&&
        Objects.equals(this.additionalProperties, apiKeysListActiveKeysResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiKeysListActiveKeysResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKeysListActiveKeysResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeysListActiveKeysResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeysListActiveKeysResponse is not found in the empty JSON string", ApiKeysListActiveKeysResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeysListActiveKeysResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeysListActiveKeysResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeysListActiveKeysResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeysListActiveKeysResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeysListActiveKeysResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeysListActiveKeysResponse>() {
           @Override
           public void write(JsonWriter out, ApiKeysListActiveKeysResponse value) throws IOException {
           ...
           @Override
           public ApiKeysListActiveKeysResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKeysListActiveKeysResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKeysListActiveKeysResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKeysListActiveKeysResponse
  * @throws IOException if the JSON string is invalid with respect to ApiKeysListActiveKeysResponse
  */
  public static ApiKeysListActiveKeysResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeysListActiveKeysResponse.class);
  }

 /**
  * Convert an instance of ApiKeysListActiveKeysResponse to an JSON string
  *
  * @return JSON string
  */
