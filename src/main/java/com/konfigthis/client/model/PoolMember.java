...
public class PoolMember {
  ...
  public PoolMember createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PoolMember legalPersonUrl(String legalPersonUrl) {
  ...
  **/
   ...
   * @return the PoolMember instance itself
   */
  public PoolMember putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, poolMember.createdAt) &&
        Objects.equals(this.legalPersonUrl, poolMember.legalPersonUrl)&&
        Objects.equals(this.additionalProperties, poolMember.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, legalPersonUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PoolMember
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PoolMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PoolMember is not found in the empty JSON string", PoolMember.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PoolMember.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PoolMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PoolMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PoolMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PoolMember.class));

       return (TypeAdapter<T>) new TypeAdapter<PoolMember>() {
           @Override
           public void write(JsonWriter out, PoolMember value) throws IOException {
           ...
           @Override
           public PoolMember read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PoolMember instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PoolMember given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PoolMember
  * @throws IOException if the JSON string is invalid with respect to PoolMember
  */
  public static PoolMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PoolMember.class);
  }

 /**
  * Convert an instance of PoolMember to an JSON string
  *
  * @return JSON string
  */
