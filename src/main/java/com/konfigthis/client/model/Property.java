...
import com.konfigthis.client.model.LegalPerson;
import com.konfigthis.client.model.RiskRatingEntry;
import com.konfigthis.client.model.Verification;
...
public class Property {
  ...
  private List<RiskRatingEntry> riskRatingEntries = null;
  ...
  public Property verifications(List<Verification> verifications) {
  ...
  public Property addVerificationsItem(Verification verificationsItem) {
  ...
  **/
  ...
  public Property riskRatingEntries(List<RiskRatingEntry> riskRatingEntries) {
  ...
  public Property addRiskRatingEntriesItem(RiskRatingEntry riskRatingEntriesItem) {
  ...
  **/
  ...
  public List<RiskRatingEntry> getRiskRatingEntries() {
    return riskRatingEntries;
  }


  public void setRiskRatingEntries(List<RiskRatingEntry> riskRatingEntries) {
  ...
  public Property legalPersons(List<LegalPerson> legalPersons) {
  ...
  public Property addLegalPersonsItem(LegalPerson legalPersonsItem) {
    if (this.legalPersons == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.verifications, property.verifications) &&
        Objects.equals(this.riskRatingEntries, property.riskRatingEntries) &&
        Objects.equals(this.legalPersons, property.legalPersons)&&
        Objects.equals(this.additionalProperties, property.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verifications, riskRatingEntries, legalPersons, additionalProperties);
  }
      ...
      if (jsonObj.get("risk-rating-entries") != null && !jsonObj.get("risk-rating-entries").isJsonNull()) {
        ...
        if (jsonArrayriskRatingEntries != null) {
          ...
          for (int i = 0; i < jsonArrayriskRatingEntries.size(); i++) {
            RiskRatingEntry.validateJsonObject(jsonArrayriskRatingEntries.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("legal-persons") != null && !jsonObj.get("legal-persons").isJsonNull()) {
        JsonArray jsonArraylegalPersons = jsonObj.getAsJsonArray("legal-persons");
        if (jsonArraylegalPersons != null) {
          // ensure the json data is an array
          ...
          // validate the optional field `legal-persons` (array)
          for (int i = 0; i < jsonArraylegalPersons.size(); i++) {
            LegalPerson.validateJsonObject(jsonArraylegalPersons.get(i).getAsJsonObject());
          };
        }
      }
  }
