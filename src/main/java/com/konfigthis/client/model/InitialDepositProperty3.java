...
/**
 * InitialDepositProperty3
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InitialDepositProperty3 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty3() {
  }

  public InitialDepositProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty3 value(String value) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1000.00", required = true, value = "The unsigned value as a decimal-formatted string")
   ...
   * @return the InitialDepositProperty3 instance itself
   */
  public InitialDepositProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty3 initialDepositProperty3 = (InitialDepositProperty3) o;
    return Objects.equals(this.currency, initialDepositProperty3.currency) &&
        Objects.equals(this.value, initialDepositProperty3.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty3 is not found in the empty JSON string", InitialDepositProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty3>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty3 value) throws IOException {
           ...
           @Override
           public InitialDepositProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty3
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty3
  */
  public static InitialDepositProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty3.class);
  }

 /**
  * Convert an instance of InitialDepositProperty3 to an JSON string
  *
  * @return JSON string
  */
