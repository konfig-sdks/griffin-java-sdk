...
public class DebtorProperty2 {
 ...
 public enum BankIdCodeEnum {
  ...
  public DebtorProperty2() {
  }

  public DebtorProperty2 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public DebtorProperty2 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public DebtorProperty2 bankId(String bankId) {
  ...
  **/
  ...
  public DebtorProperty2 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public DebtorProperty2 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public DebtorProperty2 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the DebtorProperty2 instance itself
   */
  public DebtorProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DebtorProperty2 debtorProperty2 = (DebtorProperty2) o;
    return Objects.equals(this.accountNumber, debtorProperty2.accountNumber) &&
        Objects.equals(this.accountNumberCode, debtorProperty2.accountNumberCode) &&
        Objects.equals(this.bankId, debtorProperty2.bankId) &&
        Objects.equals(this.bankIdCode, debtorProperty2.bankIdCode) &&
        Objects.equals(this.accountHolder, debtorProperty2.accountHolder) &&
        Objects.equals(this.accountUrl, debtorProperty2.accountUrl)&&
        Objects.equals(this.additionalProperties, debtorProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtorProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DebtorProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DebtorProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DebtorProperty2 is not found in the empty JSON string", DebtorProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DebtorProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DebtorProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DebtorProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DebtorProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebtorProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<DebtorProperty2>() {
           @Override
           public void write(JsonWriter out, DebtorProperty2 value) throws IOException {
           ...
           @Override
           public DebtorProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DebtorProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DebtorProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DebtorProperty2
  * @throws IOException if the JSON string is invalid with respect to DebtorProperty2
  */
  public static DebtorProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DebtorProperty2.class);
  }

 /**
  * Convert an instance of DebtorProperty2 to an JSON string
  *
  * @return JSON string
  */
