...
public class IncomeProperty1 {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty1() {
  }

  public IncomeProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty1 value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty1 instance itself
   */
  public IncomeProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty1 incomeProperty1 = (IncomeProperty1) o;
    return Objects.equals(this.currency, incomeProperty1.currency) &&
        Objects.equals(this.value, incomeProperty1.value)&&
        Objects.equals(this.additionalProperties, incomeProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty1 is not found in the empty JSON string", IncomeProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty1>() {
           @Override
           public void write(JsonWriter out, IncomeProperty1 value) throws IOException {
           ...
           @Override
           public IncomeProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty1
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty1
  */
  public static IncomeProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty1.class);
  }

 /**
  * Convert an instance of IncomeProperty1 to an JSON string
  *
  * @return JSON string
  */
