...
public class LatestDecisionProperty3 {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public LatestDecisionProperty3() {
  }

  public LatestDecisionProperty3 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public LatestDecisionProperty3 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public LatestDecisionProperty3 decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the LatestDecisionProperty3 instance itself
   */
  public LatestDecisionProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LatestDecisionProperty3 latestDecisionProperty3 = (LatestDecisionProperty3) o;
    return Objects.equals(this.verificationUrl, latestDecisionProperty3.verificationUrl) &&
        Objects.equals(this.decisionOutcome, latestDecisionProperty3.decisionOutcome) &&
        Objects.equals(this.decisionMaker, latestDecisionProperty3.decisionMaker) &&
        Objects.equals(this.decisionNotes, latestDecisionProperty3.decisionNotes) &&
        Objects.equals(this.createdAt, latestDecisionProperty3.createdAt) &&
        Objects.equals(this.decisionUserUrl, latestDecisionProperty3.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, latestDecisionProperty3.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, latestDecisionProperty3.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, latestDecisionProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LatestDecisionProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LatestDecisionProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LatestDecisionProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatestDecisionProperty3 is not found in the empty JSON string", LatestDecisionProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LatestDecisionProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatestDecisionProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatestDecisionProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatestDecisionProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatestDecisionProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<LatestDecisionProperty3>() {
           @Override
           public void write(JsonWriter out, LatestDecisionProperty3 value) throws IOException {
           ...
           @Override
           public LatestDecisionProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LatestDecisionProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LatestDecisionProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LatestDecisionProperty3
  * @throws IOException if the JSON string is invalid with respect to LatestDecisionProperty3
  */
  public static LatestDecisionProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatestDecisionProperty3.class);
  }

 /**
  * Convert an instance of LatestDecisionProperty3 to an JSON string
  *
  * @return JSON string
  */
