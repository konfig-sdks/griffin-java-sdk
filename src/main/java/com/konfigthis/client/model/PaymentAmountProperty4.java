...
public class PaymentAmountProperty4 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public PaymentAmountProperty4() {
  }

  public PaymentAmountProperty4 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public PaymentAmountProperty4 value(String value) {
  ...
  **/
   ...
   * @return the PaymentAmountProperty4 instance itself
   */
  public PaymentAmountProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentAmountProperty4 paymentAmountProperty4 = (PaymentAmountProperty4) o;
    return Objects.equals(this.currency, paymentAmountProperty4.currency) &&
        Objects.equals(this.value, paymentAmountProperty4.value)&&
        Objects.equals(this.additionalProperties, paymentAmountProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAmountProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAmountProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAmountProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAmountProperty4 is not found in the empty JSON string", PaymentAmountProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentAmountProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAmountProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAmountProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAmountProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAmountProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAmountProperty4>() {
           @Override
           public void write(JsonWriter out, PaymentAmountProperty4 value) throws IOException {
           ...
           @Override
           public PaymentAmountProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentAmountProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentAmountProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAmountProperty4
  * @throws IOException if the JSON string is invalid with respect to PaymentAmountProperty4
  */
  public static PaymentAmountProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAmountProperty4.class);
  }

 /**
  * Convert an instance of PaymentAmountProperty4 to an JSON string
  *
  * @return JSON string
  */
