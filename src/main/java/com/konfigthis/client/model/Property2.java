...
import com.konfigthis.client.model.LegalPerson1;
...
public class Property2 {
  ...
  private List<LegalPerson1> legalPersons = new ArrayList<>();

  public Property2() {
  }

  public Property2 legalPersons(List<LegalPerson1> legalPersons) {
  ...
  public Property2 addLegalPersonsItem(LegalPerson1 legalPersonsItem) {
  ...
  **/
  ...
  public List<LegalPerson1> getLegalPersons() {
    return legalPersons;
  }


  public void setLegalPersons(List<LegalPerson1> legalPersons) {
   ...
   * @return the Property2 instance itself
   */
  public Property2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Property2 property2 = (Property2) o;
    return Objects.equals(this.legalPersons, property2.legalPersons)&&
        Objects.equals(this.additionalProperties, property2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(legalPersons, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Property2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Property2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Property2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Property2 is not found in the empty JSON string", Property2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Property2.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraylegalPersons.size(); i++) {
        LegalPerson1.validateJsonObject(jsonArraylegalPersons.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Property2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Property2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Property2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Property2.class));

       return (TypeAdapter<T>) new TypeAdapter<Property2>() {
           @Override
           public void write(JsonWriter out, Property2 value) throws IOException {
           ...
           @Override
           public Property2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Property2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Property2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Property2
  * @throws IOException if the JSON string is invalid with respect to Property2
  */
  public static Property2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Property2.class);
  }

 /**
  * Convert an instance of Property2 to an JSON string
  *
  * @return JSON string
  */
