...
public class ApiKeysCreateKeyResponse {
  public static final String SERIALIZED_NAME_API_KEY_URL = "api-key-url";
  @SerializedName(SERIALIZED_NAME_API_KEY_URL)
  private String apiKeyUrl;

  public static final String SERIALIZED_NAME_API_KEY_NAME = "api-key-name";
  @SerializedName(SERIALIZED_NAME_API_KEY_NAME)
  private Object apiKeyName = null;

  public static final String SERIALIZED_NAME_API_KEY_LIVE_QUESTION_MARK = "api-key-live?";
  @SerializedName(SERIALIZED_NAME_API_KEY_LIVE_QUESTION_MARK)
  private Boolean apiKeyLiveQuestionMark;
  ...
  public static final String SERIALIZED_NAME_API_KEY_SECRET = "api-key-secret";
  @SerializedName(SERIALIZED_NAME_API_KEY_SECRET)
  private String apiKeySecret;

  public ApiKeysCreateKeyResponse() {
  }

  public ApiKeysCreateKeyResponse apiKeyUrl(String apiKeyUrl) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/v0/api-keys/ak.ICAgICAgYXBpLWtleS1pZA", required = true, value = "The resource path for the API key")
  ...
  public ApiKeysCreateKeyResponse apiKeyName(Object apiKeyName) {
    
    
    if (apiKeyName != null && apiKeyName.length() < 1) {
      throw new IllegalArgumentException("Invalid value for apiKeyName. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "buildserver", required = true, value = "The immutable display name for the API key")
  ...
  public void setApiKeyName(Object apiKeyName) {
  ...
  public ApiKeysCreateKeyResponse apiKeyLiveQuestionMark(Boolean apiKeyLiveQuestionMark) {
    
    
    
    
    this.apiKeyLiveQuestionMark = apiKeyLiveQuestionMark;
    return this;
  }

   /**
   * Get apiKeyLiveQuestionMark
   * @return apiKeyLiveQuestionMark
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public Boolean getApiKeyLiveQuestionMark() {
    return apiKeyLiveQuestionMark;
  }


  public void setApiKeyLiveQuestionMark(Boolean apiKeyLiveQuestionMark) {
  ...
  public ApiKeysCreateKeyResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public ApiKeysCreateKeyResponse userUrl(String userUrl) {
  ...
  **/
  ...
  public ApiKeysCreateKeyResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ApiKeysCreateKeyResponse apiKeySecret(String apiKeySecret) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "g-test-buildserver-RrUZ5fUG4pSKwYVVG1C3Ft1xrMRxy1T7KUIyTva5bTk", required = true, value = "The API secret")
   ...
   * @return the ApiKeysCreateKeyResponse instance itself
   */
  public ApiKeysCreateKeyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeysCreateKeyResponse apiKeysCreateKeyResponse = (ApiKeysCreateKeyResponse) o;
    return Objects.equals(this.apiKeyUrl, apiKeysCreateKeyResponse.apiKeyUrl) &&
        Objects.equals(this.apiKeyName, apiKeysCreateKeyResponse.apiKeyName) &&
        Objects.equals(this.apiKeyLiveQuestionMark, apiKeysCreateKeyResponse.apiKeyLiveQuestionMark) &&
        Objects.equals(this.organizationUrl, apiKeysCreateKeyResponse.organizationUrl) &&
        Objects.equals(this.userUrl, apiKeysCreateKeyResponse.userUrl) &&
        Objects.equals(this.createdAt, apiKeysCreateKeyResponse.createdAt) &&
        Objects.equals(this.apiKeySecret, apiKeysCreateKeyResponse.apiKeySecret)&&
        Objects.equals(this.additionalProperties, apiKeysCreateKeyResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKeyUrl, apiKeyName, apiKeyLiveQuestionMark, organizationUrl, userUrl, createdAt, apiKeySecret, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiKeysCreateKeyResponse {\n");
    ...
    sb.append("    apiKeyLiveQuestionMark: ").append(toIndentedString(apiKeyLiveQuestionMark)).append("\n");
  ...
  static {
    ...
    openapiFields.add("api-key-name");
    openapiFields.add("api-key-live?");
    openapiFields.add("organization-url");
    openapiFields.add("user-url");
    openapiFields.add("created-at");
    openapiFields.add("api-key-secret");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("api-key-url");
    openapiRequiredFields.add("api-key-name");
    openapiRequiredFields.add("api-key-live?");
    openapiRequiredFields.add("organization-url");
    openapiRequiredFields.add("user-url");
    openapiRequiredFields.add("created-at");
    openapiRequiredFields.add("api-key-secret");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiKeysCreateKeyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiKeysCreateKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiKeysCreateKeyResponse is not found in the empty JSON string", ApiKeysCreateKeyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeysCreateKeyResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("api-key-url").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("api-key-secret").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `api-key-secret` to be a primitive type in the JSON string but got `%s`", jsonObj.get("api-key-secret").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeysCreateKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeysCreateKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeysCreateKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeysCreateKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeysCreateKeyResponse>() {
           @Override
           public void write(JsonWriter out, ApiKeysCreateKeyResponse value) throws IOException {
           ...
           @Override
           public ApiKeysCreateKeyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApiKeysCreateKeyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ApiKeysCreateKeyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ApiKeysCreateKeyResponse
  * @throws IOException if the JSON string is invalid with respect to ApiKeysCreateKeyResponse
  */
  public static ApiKeysCreateKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeysCreateKeyResponse.class);
  }

 /**
  * Convert an instance of ApiKeysCreateKeyResponse to an JSON string
  *
  * @return JSON string
  */
