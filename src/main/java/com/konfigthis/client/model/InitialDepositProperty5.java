...
/**
 * InitialDepositProperty5
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InitialDepositProperty5 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty5() {
  }

  public InitialDepositProperty5 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty5 value(String value) {
  ...
  **/
   ...
   * @return the InitialDepositProperty5 instance itself
   */
  public InitialDepositProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty5 initialDepositProperty5 = (InitialDepositProperty5) o;
    return Objects.equals(this.currency, initialDepositProperty5.currency) &&
        Objects.equals(this.value, initialDepositProperty5.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty5 is not found in the empty JSON string", InitialDepositProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty5>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty5 value) throws IOException {
           ...
           @Override
           public InitialDepositProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty5
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty5
  */
  public static InitialDepositProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty5.class);
  }

 /**
  * Convert an instance of InitialDepositProperty5 to an JSON string
  *
  * @return JSON string
  */
