...
public class WebhooksGetWebhookResponse {
  ...
  public WebhooksGetWebhookResponse() {
  }

  public WebhooksGetWebhookResponse organizationUrl(String organizationUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse webhookDestinationUrl(String webhookDestinationUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse testWebhookUrl(String testWebhookUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse activateWebhookUrl(String activateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse deactivateWebhookUrl(String deactivateWebhookUrl) {
  ...
  **/
  ...
  public WebhooksGetWebhookResponse webhookDescription(String webhookDescription) {
  ...
  **/
   ...
   * @return the WebhooksGetWebhookResponse instance itself
   */
  public WebhooksGetWebhookResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksGetWebhookResponse webhooksGetWebhookResponse = (WebhooksGetWebhookResponse) o;
    return Objects.equals(this.organizationUrl, webhooksGetWebhookResponse.organizationUrl) &&
        Objects.equals(this.webhookUrl, webhooksGetWebhookResponse.webhookUrl) &&
        Objects.equals(this.webhookDestinationUrl, webhooksGetWebhookResponse.webhookDestinationUrl) &&
        Objects.equals(this.testWebhookUrl, webhooksGetWebhookResponse.testWebhookUrl) &&
        Objects.equals(this.activateWebhookUrl, webhooksGetWebhookResponse.activateWebhookUrl) &&
        Objects.equals(this.deactivateWebhookUrl, webhooksGetWebhookResponse.deactivateWebhookUrl) &&
        Objects.equals(this.webhookDescription, webhooksGetWebhookResponse.webhookDescription)&&
        Objects.equals(this.additionalProperties, webhooksGetWebhookResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksGetWebhookResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhooksGetWebhookResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhooksGetWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhooksGetWebhookResponse is not found in the empty JSON string", WebhooksGetWebhookResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhooksGetWebhookResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhooksGetWebhookResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhooksGetWebhookResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhooksGetWebhookResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhooksGetWebhookResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhooksGetWebhookResponse>() {
           @Override
           public void write(JsonWriter out, WebhooksGetWebhookResponse value) throws IOException {
           ...
           @Override
           public WebhooksGetWebhookResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhooksGetWebhookResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhooksGetWebhookResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhooksGetWebhookResponse
  * @throws IOException if the JSON string is invalid with respect to WebhooksGetWebhookResponse
  */
  public static WebhooksGetWebhookResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhooksGetWebhookResponse.class);
  }

 /**
  * Convert an instance of WebhooksGetWebhookResponse to an JSON string
  *
  * @return JSON string
  */
