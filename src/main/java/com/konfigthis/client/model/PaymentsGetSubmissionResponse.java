...
public class PaymentsGetSubmissionResponse {
  /**
 ...
 public enum SubmissionStatusEnum {
  ...
  public PaymentsGetSubmissionResponse() {
  }

  public PaymentsGetSubmissionResponse submissionStatus(SubmissionStatusEnum submissionStatus) {
  ...
  **/
  ...
  public PaymentsGetSubmissionResponse submissionSchemeInformation(FpsProperty1 submissionSchemeInformation) {
  ...
  **/
  ...
  public PaymentsGetSubmissionResponse paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public PaymentsGetSubmissionResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PaymentsGetSubmissionResponse submissionUrl(String submissionUrl) {
  ...
  **/
   ...
   * @return the PaymentsGetSubmissionResponse instance itself
   */
  public PaymentsGetSubmissionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsGetSubmissionResponse paymentsGetSubmissionResponse = (PaymentsGetSubmissionResponse) o;
    return Objects.equals(this.submissionStatus, paymentsGetSubmissionResponse.submissionStatus) &&
        Objects.equals(this.submissionSchemeInformation, paymentsGetSubmissionResponse.submissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, paymentsGetSubmissionResponse.paymentUrl) &&
        Objects.equals(this.createdAt, paymentsGetSubmissionResponse.createdAt) &&
        Objects.equals(this.submissionUrl, paymentsGetSubmissionResponse.submissionUrl)&&
        Objects.equals(this.additionalProperties, paymentsGetSubmissionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsGetSubmissionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsGetSubmissionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsGetSubmissionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsGetSubmissionResponse is not found in the empty JSON string", PaymentsGetSubmissionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsGetSubmissionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsGetSubmissionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsGetSubmissionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsGetSubmissionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsGetSubmissionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsGetSubmissionResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsGetSubmissionResponse value) throws IOException {
           ...
           @Override
           public PaymentsGetSubmissionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsGetSubmissionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsGetSubmissionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsGetSubmissionResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsGetSubmissionResponse
  */
  public static PaymentsGetSubmissionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsGetSubmissionResponse.class);
  }

 /**
  * Convert an instance of PaymentsGetSubmissionResponse to an JSON string
  *
  * @return JSON string
  */
