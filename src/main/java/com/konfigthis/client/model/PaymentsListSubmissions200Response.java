...
import com.konfigthis.client.model.Submission1;
...
public class PaymentsListSubmissions200Response {
  public static final String SERIALIZED_NAME_SUBMISSIONS = "submissions";
  @SerializedName(SERIALIZED_NAME_SUBMISSIONS)
  private List<Submission1> submissions = new ArrayList<>();

  public PaymentsListSubmissions200Response() {
  }

  public PaymentsListSubmissions200Response submissions(List<Submission1> submissions) {
  ...
  public PaymentsListSubmissions200Response addSubmissionsItem(Submission1 submissionsItem) {
  ...
  **/
  ...
  public List<Submission1> getSubmissions() {
    return submissions;
  }


  public void setSubmissions(List<Submission1> submissions) {
   ...
   * @return the PaymentsListSubmissions200Response instance itself
   */
  public PaymentsListSubmissions200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsListSubmissions200Response paymentsListSubmissions200Response = (PaymentsListSubmissions200Response) o;
    return Objects.equals(this.submissions, paymentsListSubmissions200Response.submissions)&&
        Objects.equals(this.additionalProperties, paymentsListSubmissions200Response.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(submissions, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsListSubmissions200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsListSubmissions200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsListSubmissions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsListSubmissions200Response is not found in the empty JSON string", PaymentsListSubmissions200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsListSubmissions200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraysubmissions.size(); i++) {
        Submission1.validateJsonObject(jsonArraysubmissions.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsListSubmissions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsListSubmissions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsListSubmissions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsListSubmissions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsListSubmissions200Response>() {
           @Override
           public void write(JsonWriter out, PaymentsListSubmissions200Response value) throws IOException {
           ...
           @Override
           public PaymentsListSubmissions200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsListSubmissions200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsListSubmissions200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsListSubmissions200Response
  * @throws IOException if the JSON string is invalid with respect to PaymentsListSubmissions200Response
  */
  public static PaymentsListSubmissions200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsListSubmissions200Response.class);
  }

 /**
  * Convert an instance of PaymentsListSubmissions200Response to an JSON string
  *
  * @return JSON string
  */
