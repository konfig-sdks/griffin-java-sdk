...
import com.konfigthis.client.model.DebtorProperty1;
import com.konfigthis.client.model.PayeeProperty2;
import com.konfigthis.client.model.PaymentAmountProperty2;
import com.konfigthis.client.model.UltimateDebtorProperty1;
...
public class PaymentsCreateRequestResponse {
 ...
 public enum PaymentDirectionEnum {
  ...
  private DebtorProperty1 debtor;

  public PaymentsCreateRequestResponse() {
  }

  public PaymentsCreateRequestResponse creditor(PayeeProperty2 creditor) {
  ...
  **/
  ...
  public PayeeProperty2 getCreditor() {
    return creditor;
  }


  public void setCreditor(PayeeProperty2 creditor) {
  ...
  public PaymentsCreateRequestResponse paymentDirection(PaymentDirectionEnum paymentDirection) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse paymentReference(String paymentReference) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse paymentAmount(PaymentAmountProperty2 paymentAmount) {
  ...
  **/
  ...
  public PaymentAmountProperty2 getPaymentAmount() {
    return paymentAmount;
  }


  public void setPaymentAmount(PaymentAmountProperty2 paymentAmount) {
  ...
  public PaymentsCreateRequestResponse ultimateDebtor(UltimateDebtorProperty1 ultimateDebtor) {
  ...
  **/
  ...
  public UltimateDebtorProperty1 getUltimateDebtor() {
    return ultimateDebtor;
  }


  public void setUltimateDebtor(UltimateDebtorProperty1 ultimateDebtor) {
  ...
  public PaymentsCreateRequestResponse paymentAdmissionsUrl(String paymentAdmissionsUrl) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse paymentSubmissionsUrl(String paymentSubmissionsUrl) {
  ...
  **/
  ...
  public PaymentsCreateRequestResponse debtor(DebtorProperty1 debtor) {
  ...
  **/
  ...
  public DebtorProperty1 getDebtor() {
    return debtor;
  }


  public void setDebtor(DebtorProperty1 debtor) {
   ...
   * @return the PaymentsCreateRequestResponse instance itself
   */
  public PaymentsCreateRequestResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsCreateRequestResponse paymentsCreateRequestResponse = (PaymentsCreateRequestResponse) o;
    return Objects.equals(this.creditor, paymentsCreateRequestResponse.creditor) &&
        Objects.equals(this.paymentDirection, paymentsCreateRequestResponse.paymentDirection) &&
        Objects.equals(this.createdAt, paymentsCreateRequestResponse.createdAt) &&
        Objects.equals(this.paymentUrl, paymentsCreateRequestResponse.paymentUrl) &&
        Objects.equals(this.paymentReference, paymentsCreateRequestResponse.paymentReference) &&
        Objects.equals(this.paymentAmount, paymentsCreateRequestResponse.paymentAmount) &&
        Objects.equals(this.ultimateDebtor, paymentsCreateRequestResponse.ultimateDebtor) &&
        Objects.equals(this.paymentAdmissionsUrl, paymentsCreateRequestResponse.paymentAdmissionsUrl) &&
        Objects.equals(this.paymentSubmissionsUrl, paymentsCreateRequestResponse.paymentSubmissionsUrl) &&
        Objects.equals(this.debtor, paymentsCreateRequestResponse.debtor)&&
        Objects.equals(this.additionalProperties, paymentsCreateRequestResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsCreateRequestResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsCreateRequestResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsCreateRequestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsCreateRequestResponse is not found in the empty JSON string", PaymentsCreateRequestResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsCreateRequestResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `creditor`
      PayeeProperty2.validateJsonObject(jsonObj.getAsJsonObject("creditor"));
      ...
      PaymentAmountProperty2.validateJsonObject(jsonObj.getAsJsonObject("payment-amount"));
      // validate the optional field `ultimate-debtor`
      if (jsonObj.get("ultimate-debtor") != null && !jsonObj.get("ultimate-debtor").isJsonNull()) {
        UltimateDebtorProperty1.validateJsonObject(jsonObj.getAsJsonObject("ultimate-debtor"));
      }
      ...
      DebtorProperty1.validateJsonObject(jsonObj.getAsJsonObject("debtor"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsCreateRequestResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsCreateRequestResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsCreateRequestResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsCreateRequestResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsCreateRequestResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsCreateRequestResponse value) throws IOException {
           ...
           @Override
           public PaymentsCreateRequestResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsCreateRequestResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsCreateRequestResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsCreateRequestResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsCreateRequestResponse
  */
  public static PaymentsCreateRequestResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsCreateRequestResponse.class);
  }

 /**
  * Convert an instance of PaymentsCreateRequestResponse to an JSON string
  *
  * @return JSON string
  */
