...
public class Role6 {
  ...
  public Role6 description(String description) {
  ...
  **/
  ...
  public Role6 displayName(String displayName) {
  ...
  **/
  ...
  public Role6 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role6 instance itself
   */
  public Role6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role6 role6 = (Role6) o;
    return Objects.equals(this.description, role6.description) &&
        Objects.equals(this.displayName, role6.displayName) &&
        Objects.equals(this.roleUrl, role6.roleUrl)&&
        Objects.equals(this.additionalProperties, role6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role6 is not found in the empty JSON string", Role6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role6.class));

       return (TypeAdapter<T>) new TypeAdapter<Role6>() {
           @Override
           public void write(JsonWriter out, Role6 value) throws IOException {
           ...
           @Override
           public Role6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role6
  * @throws IOException if the JSON string is invalid with respect to Role6
  */
  public static Role6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role6.class);
  }

 /**
  * Convert an instance of Role6 to an JSON string
  *
  * @return JSON string
  */
