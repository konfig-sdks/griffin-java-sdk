...
public class VerificationsInitiateVerificationResponse {
  ...
  public static final String SERIALIZED_NAME_VERIFICATION_CHECKS_URL = "verification-checks-url";
  @SerializedName(SERIALIZED_NAME_VERIFICATION_CHECKS_URL)
  private String verificationChecksUrl;
 ...
 public enum VerificationStatusEnum {
  ...
  public static final String SERIALIZED_NAME_VERIFICATION_STATUS = "verification-status";
  @SerializedName(SERIALIZED_NAME_VERIFICATION_STATUS)
  private VerificationStatusEnum verificationStatus;

  public static final String SERIALIZED_NAME_VERIFICATION_RISK_ASSESSMENTS_URL = "verification-risk-assessments-url";
  @SerializedName(SERIALIZED_NAME_VERIFICATION_RISK_ASSESSMENTS_URL)
  private String verificationRiskAssessmentsUrl;

  public VerificationsInitiateVerificationResponse() {
  }

  public VerificationsInitiateVerificationResponse verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse workflowUrl(String workflowUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/v0/workflows/wf.ICAgICB3b3JrZmxvdy1pZA", value = "A link to the [workflow](http://docs.griffin.com).")
  ...
  public VerificationsInitiateVerificationResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse verificationChecksUrl(String verificationChecksUrl) {
    
    
    
    
    this.verificationChecksUrl = verificationChecksUrl;
    return this;
  }

   /**
   * Get verificationChecksUrl
   * @return verificationChecksUrl
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")

  public String getVerificationChecksUrl() {
    return verificationChecksUrl;
  }


  public void setVerificationChecksUrl(String verificationChecksUrl) {
  ...
  public VerificationsInitiateVerificationResponse riskRating(RiskRatingEnum riskRating) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse verificationStatus(VerificationStatusEnum verificationStatus) {
  ...
  **/
  ...
  public VerificationsInitiateVerificationResponse verificationRiskAssessmentsUrl(String verificationRiskAssessmentsUrl) {
    
    
    
    
    this.verificationRiskAssessmentsUrl = verificationRiskAssessmentsUrl;
    return this;
  }

   /**
   * Get verificationRiskAssessmentsUrl
   * @return verificationRiskAssessmentsUrl
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public String getVerificationRiskAssessmentsUrl() {
    return verificationRiskAssessmentsUrl;
  }


  public void setVerificationRiskAssessmentsUrl(String verificationRiskAssessmentsUrl) {
   ...
   * @return the VerificationsInitiateVerificationResponse instance itself
   */
  public VerificationsInitiateVerificationResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VerificationsInitiateVerificationResponse verificationsInitiateVerificationResponse = (VerificationsInitiateVerificationResponse) o;
    return Objects.equals(this.verificationUrl, verificationsInitiateVerificationResponse.verificationUrl) &&
        Objects.equals(this.updatedAt, verificationsInitiateVerificationResponse.updatedAt) &&
        Objects.equals(this.legalPersonUrl, verificationsInitiateVerificationResponse.legalPersonUrl) &&
        Objects.equals(this.workflowUrl, verificationsInitiateVerificationResponse.workflowUrl) &&
        Objects.equals(this.createdAt, verificationsInitiateVerificationResponse.createdAt) &&
        Objects.equals(this.verificationChecksUrl, verificationsInitiateVerificationResponse.verificationChecksUrl) &&
        Objects.equals(this.riskRating, verificationsInitiateVerificationResponse.riskRating) &&
        Objects.equals(this.verificationStatus, verificationsInitiateVerificationResponse.verificationStatus) &&
        Objects.equals(this.verificationRiskAssessmentsUrl, verificationsInitiateVerificationResponse.verificationRiskAssessmentsUrl)&&
        Objects.equals(this.additionalProperties, verificationsInitiateVerificationResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verificationUrl, updatedAt, legalPersonUrl, workflowUrl, createdAt, verificationChecksUrl, riskRating, verificationStatus, verificationRiskAssessmentsUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerificationsInitiateVerificationResponse {\n");
    ...
    sb.append("    verificationChecksUrl: ").append(toIndentedString(verificationChecksUrl)).append("\n");
    sb.append("    riskRating: ").append(toIndentedString(riskRating)).append("\n");
    sb.append("    verificationStatus: ").append(toIndentedString(verificationStatus)).append("\n");
    sb.append("    verificationRiskAssessmentsUrl: ").append(toIndentedString(verificationRiskAssessmentsUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("verification-checks-url");
    openapiFields.add("risk-rating");
    openapiFields.add("verification-status");
    openapiFields.add("verification-risk-assessments-url");
    ...
    openapiRequiredFields.add("verification-checks-url");
    openapiRequiredFields.add("verification-status");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VerificationsInitiateVerificationResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VerificationsInitiateVerificationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerificationsInitiateVerificationResponse is not found in the empty JSON string", VerificationsInitiateVerificationResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerificationsInitiateVerificationResponse.openapiRequiredFields) {
      ...
      if ((jsonObj.get("workflow-url") != null && !jsonObj.get("workflow-url").isJsonNull()) && !jsonObj.get("workflow-url").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("verification-checks-url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `verification-checks-url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("verification-checks-url").toString()));
      }
      ...
      if (!jsonObj.get("verification-status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `verification-status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("verification-status").toString()));
      }
      if ((jsonObj.get("verification-risk-assessments-url") != null && !jsonObj.get("verification-risk-assessments-url").isJsonNull()) && !jsonObj.get("verification-risk-assessments-url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `verification-risk-assessments-url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("verification-risk-assessments-url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerificationsInitiateVerificationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerificationsInitiateVerificationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerificationsInitiateVerificationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerificationsInitiateVerificationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VerificationsInitiateVerificationResponse>() {
           @Override
           public void write(JsonWriter out, VerificationsInitiateVerificationResponse value) throws IOException {
           ...
           @Override
           public VerificationsInitiateVerificationResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VerificationsInitiateVerificationResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VerificationsInitiateVerificationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VerificationsInitiateVerificationResponse
  * @throws IOException if the JSON string is invalid with respect to VerificationsInitiateVerificationResponse
  */
  public static VerificationsInitiateVerificationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerificationsInitiateVerificationResponse.class);
  }

 /**
  * Convert an instance of VerificationsInitiateVerificationResponse to an JSON string
  *
  * @return JSON string
  */
