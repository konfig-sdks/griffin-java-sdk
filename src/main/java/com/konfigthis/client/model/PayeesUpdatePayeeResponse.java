...
public class PayeesUpdatePayeeResponse {
 ...
 public enum PayeeStatusEnum {
  ...
  public PayeesUpdatePayeeResponse() {
  }

  public PayeesUpdatePayeeResponse payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse legalPersonUrl(String legalPersonUrl) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse bankId(String bankId) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse payeeStatus(PayeeStatusEnum payeeStatus) {
  ...
  **/
  ...
  public PayeesUpdatePayeeResponse countryCode(Object countryCode) {
  ...
  **/
   ...
   * @return the PayeesUpdatePayeeResponse instance itself
   */
  public PayeesUpdatePayeeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeesUpdatePayeeResponse payeesUpdatePayeeResponse = (PayeesUpdatePayeeResponse) o;
    return Objects.equals(this.payeeUrl, payeesUpdatePayeeResponse.payeeUrl) &&
        Objects.equals(this.accountNumber, payeesUpdatePayeeResponse.accountNumber) &&
        Objects.equals(this.accountHolder, payeesUpdatePayeeResponse.accountHolder) &&
        Objects.equals(this.legalPersonUrl, payeesUpdatePayeeResponse.legalPersonUrl) &&
        Objects.equals(this.bankId, payeesUpdatePayeeResponse.bankId) &&
        Objects.equals(this.createdAt, payeesUpdatePayeeResponse.createdAt) &&
        Objects.equals(this.accountUrl, payeesUpdatePayeeResponse.accountUrl) &&
        Objects.equals(this.payeeStatus, payeesUpdatePayeeResponse.payeeStatus) &&
        Objects.equals(this.countryCode, payeesUpdatePayeeResponse.countryCode)&&
        Objects.equals(this.additionalProperties, payeesUpdatePayeeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayeesUpdatePayeeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeesUpdatePayeeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeesUpdatePayeeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeesUpdatePayeeResponse is not found in the empty JSON string", PayeesUpdatePayeeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeesUpdatePayeeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeesUpdatePayeeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeesUpdatePayeeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeesUpdatePayeeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeesUpdatePayeeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeesUpdatePayeeResponse>() {
           @Override
           public void write(JsonWriter out, PayeesUpdatePayeeResponse value) throws IOException {
           ...
           @Override
           public PayeesUpdatePayeeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeesUpdatePayeeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeesUpdatePayeeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeesUpdatePayeeResponse
  * @throws IOException if the JSON string is invalid with respect to PayeesUpdatePayeeResponse
  */
  public static PayeesUpdatePayeeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeesUpdatePayeeResponse.class);
  }

 /**
  * Convert an instance of PayeesUpdatePayeeResponse to an JSON string
  *
  * @return JSON string
  */
