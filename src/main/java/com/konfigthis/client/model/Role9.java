...
public class Role9 {
  ...
  public static final String SERIALIZED_NAME_ROLE_URL = "role-url";
  @SerializedName(SERIALIZED_NAME_ROLE_URL)
  private String roleUrl;

  public Role9() {
  }

  public Role9 description(String description) {
  ...
  **/
  ...
  public Role9 displayName(String displayName) {
  ...
  **/
  ...
  public Role9 roleUrl(String roleUrl) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/v0/roles/re.ICAgICAgICAgcm9sZS1pZA", required = true, value = "Link to the [role](http://docs.griffin.com).")
   ...
   * @return the Role9 instance itself
   */
  public Role9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role9 role9 = (Role9) o;
    return Objects.equals(this.description, role9.description) &&
        Objects.equals(this.displayName, role9.displayName) &&
        Objects.equals(this.roleUrl, role9.roleUrl)&&
        Objects.equals(this.additionalProperties, role9.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, displayName, roleUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Role9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role9 is not found in the empty JSON string", Role9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role9.openapiRequiredFields) {
      ...
      if (!jsonObj.get("role-url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `role-url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("role-url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role9.class));

       return (TypeAdapter<T>) new TypeAdapter<Role9>() {
           @Override
           public void write(JsonWriter out, Role9 value) throws IOException {
           ...
           @Override
           public Role9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role9
  * @throws IOException if the JSON string is invalid with respect to Role9
  */
  public static Role9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role9.class);
  }

 /**
  * Convert an instance of Role9 to an JSON string
  *
  * @return JSON string
  */
