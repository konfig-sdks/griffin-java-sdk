...
public class LegalPersonsUpdateLegalPersonRequest {
  public static final String SERIALIZED_NAME_DISPLAY_NAME = "display-name";
  @SerializedName(SERIALIZED_NAME_DISPLAY_NAME)
  private String displayName;

  public LegalPersonsUpdateLegalPersonRequest() {
  }

  public LegalPersonsUpdateLegalPersonRequest displayName(String displayName) {
  ...
  **/
   ...
   * @return the LegalPersonsUpdateLegalPersonRequest instance itself
   */
  public LegalPersonsUpdateLegalPersonRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonsUpdateLegalPersonRequest legalPersonsUpdateLegalPersonRequest = (LegalPersonsUpdateLegalPersonRequest) o;
    return Objects.equals(this.displayName, legalPersonsUpdateLegalPersonRequest.displayName)&&
        Objects.equals(this.additionalProperties, legalPersonsUpdateLegalPersonRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LegalPersonsUpdateLegalPersonRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonsUpdateLegalPersonRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonsUpdateLegalPersonRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonsUpdateLegalPersonRequest is not found in the empty JSON string", LegalPersonsUpdateLegalPersonRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonsUpdateLegalPersonRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonsUpdateLegalPersonRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonsUpdateLegalPersonRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonsUpdateLegalPersonRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonsUpdateLegalPersonRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonsUpdateLegalPersonRequest>() {
           @Override
           public void write(JsonWriter out, LegalPersonsUpdateLegalPersonRequest value) throws IOException {
           ...
           @Override
           public LegalPersonsUpdateLegalPersonRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonsUpdateLegalPersonRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonsUpdateLegalPersonRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonsUpdateLegalPersonRequest
  * @throws IOException if the JSON string is invalid with respect to LegalPersonsUpdateLegalPersonRequest
  */
  public static LegalPersonsUpdateLegalPersonRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonsUpdateLegalPersonRequest.class);
  }

 /**
  * Convert an instance of LegalPersonsUpdateLegalPersonRequest to an JSON string
  *
  * @return JSON string
  */
