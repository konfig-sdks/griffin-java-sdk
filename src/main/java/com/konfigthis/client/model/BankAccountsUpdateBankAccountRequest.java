...
public class BankAccountsUpdateBankAccountRequest {
  public static final String SERIALIZED_NAME_DISPLAY_NAME = "display-name";
  @SerializedName(SERIALIZED_NAME_DISPLAY_NAME)
  private String displayName;

  public BankAccountsUpdateBankAccountRequest() {
  }

  public BankAccountsUpdateBankAccountRequest displayName(String displayName) {
  ...
  **/
   ...
   * @return the BankAccountsUpdateBankAccountRequest instance itself
   */
  public BankAccountsUpdateBankAccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsUpdateBankAccountRequest bankAccountsUpdateBankAccountRequest = (BankAccountsUpdateBankAccountRequest) o;
    return Objects.equals(this.displayName, bankAccountsUpdateBankAccountRequest.displayName)&&
        Objects.equals(this.additionalProperties, bankAccountsUpdateBankAccountRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankAccountsUpdateBankAccountRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsUpdateBankAccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsUpdateBankAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsUpdateBankAccountRequest is not found in the empty JSON string", BankAccountsUpdateBankAccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsUpdateBankAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsUpdateBankAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsUpdateBankAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsUpdateBankAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsUpdateBankAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsUpdateBankAccountRequest>() {
           @Override
           public void write(JsonWriter out, BankAccountsUpdateBankAccountRequest value) throws IOException {
           ...
           @Override
           public BankAccountsUpdateBankAccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsUpdateBankAccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsUpdateBankAccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsUpdateBankAccountRequest
  * @throws IOException if the JSON string is invalid with respect to BankAccountsUpdateBankAccountRequest
  */
  public static BankAccountsUpdateBankAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsUpdateBankAccountRequest.class);
  }

 /**
  * Convert an instance of BankAccountsUpdateBankAccountRequest to an JSON string
  *
  * @return JSON string
  */
