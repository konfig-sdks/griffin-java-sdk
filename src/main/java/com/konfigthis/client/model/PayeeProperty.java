...
public class PayeeProperty {
 ...
 public enum BankIdCodeEnum {
  ...
  public PayeeProperty() {
  }

  public PayeeProperty payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeeProperty creditorType(CreditorTypeEnum creditorType) {
  ...
  **/
  ...
  public PayeeProperty accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeeProperty accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeeProperty accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeeProperty accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public PayeeProperty bankId(String bankId) {
  ...
  **/
  ...
  public PayeeProperty bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
   ...
   * @return the PayeeProperty instance itself
   */
  public PayeeProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeeProperty payeeProperty = (PayeeProperty) o;
    return Objects.equals(this.payeeUrl, payeeProperty.payeeUrl) &&
        Objects.equals(this.creditorType, payeeProperty.creditorType) &&
        Objects.equals(this.accountUrl, payeeProperty.accountUrl) &&
        Objects.equals(this.accountHolder, payeeProperty.accountHolder) &&
        Objects.equals(this.accountNumber, payeeProperty.accountNumber) &&
        Objects.equals(this.accountNumberCode, payeeProperty.accountNumberCode) &&
        Objects.equals(this.bankId, payeeProperty.bankId) &&
        Objects.equals(this.bankIdCode, payeeProperty.bankIdCode)&&
        Objects.equals(this.additionalProperties, payeeProperty.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeeProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeeProperty is not found in the empty JSON string", PayeeProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeeProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeeProperty>() {
           @Override
           public void write(JsonWriter out, PayeeProperty value) throws IOException {
           ...
           @Override
           public PayeeProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeeProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeeProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeeProperty
  * @throws IOException if the JSON string is invalid with respect to PayeeProperty
  */
  public static PayeeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeeProperty.class);
  }

 /**
  * Convert an instance of PayeeProperty to an JSON string
  *
  * @return JSON string
  */
