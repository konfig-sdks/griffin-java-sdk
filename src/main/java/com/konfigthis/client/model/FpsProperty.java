...
public class FpsProperty {
 ...
 public enum PaymentSchemeEnum {
  ...
  public FpsProperty endToEndIdentification(String endToEndIdentification) {
  ...
  **/
  ...
  public FpsProperty paymentScheme(PaymentSchemeEnum paymentScheme) {
  ...
  **/
   ...
   * @return the FpsProperty instance itself
   */
  public FpsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FpsProperty fpsProperty = (FpsProperty) o;
    return Objects.equals(this.endToEndIdentification, fpsProperty.endToEndIdentification) &&
        Objects.equals(this.paymentScheme, fpsProperty.paymentScheme)&&
        Objects.equals(this.additionalProperties, fpsProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endToEndIdentification, paymentScheme, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FpsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FpsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FpsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FpsProperty is not found in the empty JSON string", FpsProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FpsProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FpsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FpsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FpsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FpsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<FpsProperty>() {
           @Override
           public void write(JsonWriter out, FpsProperty value) throws IOException {
           ...
           @Override
           public FpsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FpsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FpsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FpsProperty
  * @throws IOException if the JSON string is invalid with respect to FpsProperty
  */
  public static FpsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FpsProperty.class);
  }

 /**
  * Convert an instance of FpsProperty to an JSON string
  *
  * @return JSON string
  */
