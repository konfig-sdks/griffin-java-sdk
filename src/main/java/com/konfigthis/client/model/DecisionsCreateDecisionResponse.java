...
public class DecisionsCreateDecisionResponse {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public DecisionsCreateDecisionResponse() {
  }

  public DecisionsCreateDecisionResponse verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public DecisionsCreateDecisionResponse decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the DecisionsCreateDecisionResponse instance itself
   */
  public DecisionsCreateDecisionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DecisionsCreateDecisionResponse decisionsCreateDecisionResponse = (DecisionsCreateDecisionResponse) o;
    return Objects.equals(this.verificationUrl, decisionsCreateDecisionResponse.verificationUrl) &&
        Objects.equals(this.decisionOutcome, decisionsCreateDecisionResponse.decisionOutcome) &&
        Objects.equals(this.decisionMaker, decisionsCreateDecisionResponse.decisionMaker) &&
        Objects.equals(this.decisionNotes, decisionsCreateDecisionResponse.decisionNotes) &&
        Objects.equals(this.createdAt, decisionsCreateDecisionResponse.createdAt) &&
        Objects.equals(this.decisionUserUrl, decisionsCreateDecisionResponse.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, decisionsCreateDecisionResponse.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, decisionsCreateDecisionResponse.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, decisionsCreateDecisionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DecisionsCreateDecisionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DecisionsCreateDecisionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DecisionsCreateDecisionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DecisionsCreateDecisionResponse is not found in the empty JSON string", DecisionsCreateDecisionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DecisionsCreateDecisionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DecisionsCreateDecisionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DecisionsCreateDecisionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DecisionsCreateDecisionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DecisionsCreateDecisionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DecisionsCreateDecisionResponse>() {
           @Override
           public void write(JsonWriter out, DecisionsCreateDecisionResponse value) throws IOException {
           ...
           @Override
           public DecisionsCreateDecisionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DecisionsCreateDecisionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DecisionsCreateDecisionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DecisionsCreateDecisionResponse
  * @throws IOException if the JSON string is invalid with respect to DecisionsCreateDecisionResponse
  */
  public static DecisionsCreateDecisionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecisionsCreateDecisionResponse.class);
  }

 /**
  * Convert an instance of DecisionsCreateDecisionResponse to an JSON string
  *
  * @return JSON string
  */
