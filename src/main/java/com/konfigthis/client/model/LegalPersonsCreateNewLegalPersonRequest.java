...
public class LegalPersonsCreateNewLegalPersonRequest {
 ...
 public enum LegalPersonTypeEnum {
  ...
  private List<MobileNumber> claims = null;

  public LegalPersonsCreateNewLegalPersonRequest() {
  }

  public LegalPersonsCreateNewLegalPersonRequest displayName(String displayName) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonRequest legalPersonType(LegalPersonTypeEnum legalPersonType) {
  ...
  **/
  ...
  public LegalPersonsCreateNewLegalPersonRequest claims(List<MobileNumber> claims) {
  ...
  public LegalPersonsCreateNewLegalPersonRequest addClaimsItem(MobileNumber claimsItem) {
    if (this.claims == null) {
  ...
  **/
  ...
  public List<MobileNumber> getClaims() {
    return claims;
  }


  public void setClaims(List<MobileNumber> claims) {
   ...
   * @return the LegalPersonsCreateNewLegalPersonRequest instance itself
   */
  public LegalPersonsCreateNewLegalPersonRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LegalPersonsCreateNewLegalPersonRequest legalPersonsCreateNewLegalPersonRequest = (LegalPersonsCreateNewLegalPersonRequest) o;
    return Objects.equals(this.displayName, legalPersonsCreateNewLegalPersonRequest.displayName) &&
        Objects.equals(this.legalPersonType, legalPersonsCreateNewLegalPersonRequest.legalPersonType) &&
        Objects.equals(this.claims, legalPersonsCreateNewLegalPersonRequest.claims)&&
        Objects.equals(this.additionalProperties, legalPersonsCreateNewLegalPersonRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, legalPersonType, claims, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LegalPersonsCreateNewLegalPersonRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LegalPersonsCreateNewLegalPersonRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LegalPersonsCreateNewLegalPersonRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalPersonsCreateNewLegalPersonRequest is not found in the empty JSON string", LegalPersonsCreateNewLegalPersonRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LegalPersonsCreateNewLegalPersonRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("claims") != null && !jsonObj.get("claims").isJsonNull()) {
        ...
        if (jsonArrayclaims != null) {
          ...
          for (int i = 0; i < jsonArrayclaims.size(); i++) {
            MobileNumber.validateJsonObject(jsonArrayclaims.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalPersonsCreateNewLegalPersonRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalPersonsCreateNewLegalPersonRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalPersonsCreateNewLegalPersonRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalPersonsCreateNewLegalPersonRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalPersonsCreateNewLegalPersonRequest>() {
           @Override
           public void write(JsonWriter out, LegalPersonsCreateNewLegalPersonRequest value) throws IOException {
           ...
           @Override
           public LegalPersonsCreateNewLegalPersonRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LegalPersonsCreateNewLegalPersonRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LegalPersonsCreateNewLegalPersonRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LegalPersonsCreateNewLegalPersonRequest
  * @throws IOException if the JSON string is invalid with respect to LegalPersonsCreateNewLegalPersonRequest
  */
  public static LegalPersonsCreateNewLegalPersonRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalPersonsCreateNewLegalPersonRequest.class);
  }

 /**
  * Convert an instance of LegalPersonsCreateNewLegalPersonRequest to an JSON string
  *
  * @return JSON string
  */
