...
import com.konfigthis.client.model.PoolMember;
import com.konfigthis.client.model.Property;
...
public class PooledAccountMembershipListLegalPersonsResponse {
  public static final String SERIALIZED_NAME_POOL_MEMBERS = "pool-members";
  @SerializedName(SERIALIZED_NAME_POOL_MEMBERS)
  private List<PoolMember> poolMembers = new ArrayList<>();
  ...
  public PooledAccountMembershipListLegalPersonsResponse() {
  }

  public PooledAccountMembershipListLegalPersonsResponse poolMembers(List<PoolMember> poolMembers) {
  ...
  public PooledAccountMembershipListLegalPersonsResponse addPoolMembersItem(PoolMember poolMembersItem) {
  ...
  **/
  ...
  public PooledAccountMembershipListLegalPersonsResponse links(LinksProperty links) {
  ...
  **/
  ...
  public PooledAccountMembershipListLegalPersonsResponse meta(MetaProperty meta) {
  ...
  **/
  ...
  public PooledAccountMembershipListLegalPersonsResponse included(Property included) {
  ...
  **/
  ...
  public Property getIncluded() {
    return included;
  }


  public void setIncluded(Property included) {
   ...
   * @return the PooledAccountMembershipListLegalPersonsResponse instance itself
   */
  public PooledAccountMembershipListLegalPersonsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PooledAccountMembershipListLegalPersonsResponse pooledAccountMembershipListLegalPersonsResponse = (PooledAccountMembershipListLegalPersonsResponse) o;
    return Objects.equals(this.poolMembers, pooledAccountMembershipListLegalPersonsResponse.poolMembers) &&
        Objects.equals(this.links, pooledAccountMembershipListLegalPersonsResponse.links) &&
        Objects.equals(this.meta, pooledAccountMembershipListLegalPersonsResponse.meta) &&
        Objects.equals(this.included, pooledAccountMembershipListLegalPersonsResponse.included)&&
        Objects.equals(this.additionalProperties, pooledAccountMembershipListLegalPersonsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolMembers, links, meta, included, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PooledAccountMembershipListLegalPersonsResponse {\n");
  ...
  static {
    ...
    openapiFields.add("pool-members");
    ...
    openapiRequiredFields.add("pool-members");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PooledAccountMembershipListLegalPersonsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PooledAccountMembershipListLegalPersonsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PooledAccountMembershipListLegalPersonsResponse is not found in the empty JSON string", PooledAccountMembershipListLegalPersonsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PooledAccountMembershipListLegalPersonsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the json data is an array
      if (!jsonObj.get("pool-members").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `pool-members` to be an array in the JSON string but got `%s`", jsonObj.get("pool-members").toString()));
      }

      JsonArray jsonArraypoolMembers = jsonObj.getAsJsonArray("pool-members");
      // validate the required field `pool-members` (array)
      for (int i = 0; i < jsonArraypoolMembers.size(); i++) {
        PoolMember.validateJsonObject(jsonArraypoolMembers.get(i).getAsJsonObject());
      };
      ...
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        Property.validateJsonObject(jsonObj.getAsJsonObject("included"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PooledAccountMembershipListLegalPersonsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PooledAccountMembershipListLegalPersonsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PooledAccountMembershipListLegalPersonsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PooledAccountMembershipListLegalPersonsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PooledAccountMembershipListLegalPersonsResponse>() {
           @Override
           public void write(JsonWriter out, PooledAccountMembershipListLegalPersonsResponse value) throws IOException {
           ...
           @Override
           public PooledAccountMembershipListLegalPersonsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PooledAccountMembershipListLegalPersonsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PooledAccountMembershipListLegalPersonsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PooledAccountMembershipListLegalPersonsResponse
  * @throws IOException if the JSON string is invalid with respect to PooledAccountMembershipListLegalPersonsResponse
  */
  public static PooledAccountMembershipListLegalPersonsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PooledAccountMembershipListLegalPersonsResponse.class);
  }

 /**
  * Convert an instance of PooledAccountMembershipListLegalPersonsResponse to an JSON string
  *
  * @return JSON string
  */
