...
/**
 * InitialDepositProperty1
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InitialDepositProperty1 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public InitialDepositProperty1() {
  }

  public InitialDepositProperty1 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public InitialDepositProperty1 value(String value) {
  ...
  **/
   ...
   * @return the InitialDepositProperty1 instance itself
   */
  public InitialDepositProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InitialDepositProperty1 initialDepositProperty1 = (InitialDepositProperty1) o;
    return Objects.equals(this.currency, initialDepositProperty1.currency) &&
        Objects.equals(this.value, initialDepositProperty1.value)&&
        Objects.equals(this.additionalProperties, initialDepositProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitialDepositProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InitialDepositProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InitialDepositProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitialDepositProperty1 is not found in the empty JSON string", InitialDepositProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InitialDepositProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitialDepositProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitialDepositProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitialDepositProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitialDepositProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<InitialDepositProperty1>() {
           @Override
           public void write(JsonWriter out, InitialDepositProperty1 value) throws IOException {
           ...
           @Override
           public InitialDepositProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InitialDepositProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InitialDepositProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InitialDepositProperty1
  * @throws IOException if the JSON string is invalid with respect to InitialDepositProperty1
  */
  public static InitialDepositProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitialDepositProperty1.class);
  }

 /**
  * Convert an instance of InitialDepositProperty1 to an JSON string
  *
  * @return JSON string
  */
