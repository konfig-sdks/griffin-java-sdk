...
import com.konfigthis.client.model.AccountBalanceProperty;
import com.konfigthis.client.model.AvailableBalanceProperty;
...
public class BankAccountsGetAccountResponse {
 ...
 public enum ClientMoneyTypeEnum {
  ...
  private AvailableBalanceProperty availableBalance;
  ...
  private List<BankAddress> bankAddresses = null;
  ...
  private AccountBalanceProperty accountBalance;
 ...
 public enum SavingsTypeEnum {
  ...
  public BankAccountsGetAccountResponse() {
  }

  public BankAccountsGetAccountResponse accountSubmissionsUrl(String accountSubmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountRestricted(Boolean accountRestricted) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountPaymentsUrl(String accountPaymentsUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse pooledAccountMembershipsUrl(String pooledAccountMembershipsUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountAdmissionsUrl(String accountAdmissionsUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse bankProductType(BankProductTypeEnum bankProductType) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse displayName(String displayName) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse controllerUrl(String controllerUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse pooledFunds(Boolean pooledFunds) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountStatus(AccountStatusEnum accountStatus) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse clientMoneyType(ClientMoneyTypeEnum clientMoneyType) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse ownerUrl(String ownerUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse closeAccountUrl(String closeAccountUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse availableBalance(AvailableBalanceProperty availableBalance) {
  ...
  **/
  ...
  public AvailableBalanceProperty getAvailableBalance() {
    return availableBalance;
  }


  public void setAvailableBalance(AvailableBalanceProperty availableBalance) {
  ...
  public BankAccountsGetAccountResponse pooledAccountMembershipUpdatesUrl(String pooledAccountMembershipUpdatesUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse bankAddresses(List<BankAddress> bankAddresses) {
  ...
  public BankAccountsGetAccountResponse addBankAddressesItem(BankAddress bankAddressesItem) {
  ...
  **/
  ...
  public void setBankAddresses(List<BankAddress> bankAddresses) {
  ...
  public BankAccountsGetAccountResponse accountTransactionsUrl(String accountTransactionsUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountUrl(String accountUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse beneficiaryUrl(String beneficiaryUrl) {
  ...
  **/
  ...
  public BankAccountsGetAccountResponse accountBalance(AccountBalanceProperty accountBalance) {
  ...
  **/
  ...
  public AccountBalanceProperty getAccountBalance() {
    return accountBalance;
  }


  public void setAccountBalance(AccountBalanceProperty accountBalance) {
  ...
  public BankAccountsGetAccountResponse savingsType(SavingsTypeEnum savingsType) {
  ...
  **/
   ...
   * @return the BankAccountsGetAccountResponse instance itself
   */
  public BankAccountsGetAccountResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsGetAccountResponse bankAccountsGetAccountResponse = (BankAccountsGetAccountResponse) o;
    return Objects.equals(this.accountSubmissionsUrl, bankAccountsGetAccountResponse.accountSubmissionsUrl) &&
        Objects.equals(this.accountRestricted, bankAccountsGetAccountResponse.accountRestricted) &&
        Objects.equals(this.accountPaymentsUrl, bankAccountsGetAccountResponse.accountPaymentsUrl) &&
        Objects.equals(this.pooledAccountMembershipsUrl, bankAccountsGetAccountResponse.pooledAccountMembershipsUrl) &&
        Objects.equals(this.accountAdmissionsUrl, bankAccountsGetAccountResponse.accountAdmissionsUrl) &&
        Objects.equals(this.bankProductType, bankAccountsGetAccountResponse.bankProductType) &&
        Objects.equals(this.displayName, bankAccountsGetAccountResponse.displayName) &&
        Objects.equals(this.controllerUrl, bankAccountsGetAccountResponse.controllerUrl) &&
        Objects.equals(this.pooledFunds, bankAccountsGetAccountResponse.pooledFunds) &&
        Objects.equals(this.accountStatus, bankAccountsGetAccountResponse.accountStatus) &&
        Objects.equals(this.clientMoneyType, bankAccountsGetAccountResponse.clientMoneyType) &&
        Objects.equals(this.ownerUrl, bankAccountsGetAccountResponse.ownerUrl) &&
        Objects.equals(this.createdAt, bankAccountsGetAccountResponse.createdAt) &&
        Objects.equals(this.closeAccountUrl, bankAccountsGetAccountResponse.closeAccountUrl) &&
        Objects.equals(this.availableBalance, bankAccountsGetAccountResponse.availableBalance) &&
        Objects.equals(this.pooledAccountMembershipUpdatesUrl, bankAccountsGetAccountResponse.pooledAccountMembershipUpdatesUrl) &&
        Objects.equals(this.bankAddresses, bankAccountsGetAccountResponse.bankAddresses) &&
        Objects.equals(this.accountTransactionsUrl, bankAccountsGetAccountResponse.accountTransactionsUrl) &&
        Objects.equals(this.accountUrl, bankAccountsGetAccountResponse.accountUrl) &&
        Objects.equals(this.beneficiaryUrl, bankAccountsGetAccountResponse.beneficiaryUrl) &&
        Objects.equals(this.accountBalance, bankAccountsGetAccountResponse.accountBalance) &&
        Objects.equals(this.savingsType, bankAccountsGetAccountResponse.savingsType)&&
        Objects.equals(this.additionalProperties, bankAccountsGetAccountResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankAccountsGetAccountResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsGetAccountResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsGetAccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsGetAccountResponse is not found in the empty JSON string", BankAccountsGetAccountResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsGetAccountResponse.openapiRequiredFields) {
      ...
      AvailableBalanceProperty.validateJsonObject(jsonObj.getAsJsonObject("available-balance"));
      ...
      if (jsonObj.get("bank-addresses") != null && !jsonObj.get("bank-addresses").isJsonNull()) {
        ...
        if (jsonArraybankAddresses != null) {
          ...
          for (int i = 0; i < jsonArraybankAddresses.size(); i++) {
            BankAddress.validateJsonObject(jsonArraybankAddresses.get(i).getAsJsonObject());
          };
        }
      }
      ...
      AccountBalanceProperty.validateJsonObject(jsonObj.getAsJsonObject("account-balance"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsGetAccountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsGetAccountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsGetAccountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsGetAccountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsGetAccountResponse>() {
           @Override
           public void write(JsonWriter out, BankAccountsGetAccountResponse value) throws IOException {
           ...
           @Override
           public BankAccountsGetAccountResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsGetAccountResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsGetAccountResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsGetAccountResponse
  * @throws IOException if the JSON string is invalid with respect to BankAccountsGetAccountResponse
  */
  public static BankAccountsGetAccountResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsGetAccountResponse.class);
  }

 /**
  * Convert an instance of BankAccountsGetAccountResponse to an JSON string
  *
  * @return JSON string
  */
