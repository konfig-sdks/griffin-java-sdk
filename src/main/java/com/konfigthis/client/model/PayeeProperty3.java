...
public class PayeeProperty3 {
 ...
 public enum BankIdCodeEnum {
  ...
  public PayeeProperty3() {
  }

  public PayeeProperty3 payeeUrl(String payeeUrl) {
  ...
  **/
  ...
  public PayeeProperty3 creditorType(CreditorTypeEnum creditorType) {
  ...
  **/
  ...
  public PayeeProperty3 accountUrl(String accountUrl) {
  ...
  **/
  ...
  public PayeeProperty3 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public PayeeProperty3 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public PayeeProperty3 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public PayeeProperty3 bankId(String bankId) {
  ...
  **/
  ...
  public PayeeProperty3 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
   ...
   * @return the PayeeProperty3 instance itself
   */
  public PayeeProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeeProperty3 payeeProperty3 = (PayeeProperty3) o;
    return Objects.equals(this.payeeUrl, payeeProperty3.payeeUrl) &&
        Objects.equals(this.creditorType, payeeProperty3.creditorType) &&
        Objects.equals(this.accountUrl, payeeProperty3.accountUrl) &&
        Objects.equals(this.accountHolder, payeeProperty3.accountHolder) &&
        Objects.equals(this.accountNumber, payeeProperty3.accountNumber) &&
        Objects.equals(this.accountNumberCode, payeeProperty3.accountNumberCode) &&
        Objects.equals(this.bankId, payeeProperty3.bankId) &&
        Objects.equals(this.bankIdCode, payeeProperty3.bankIdCode)&&
        Objects.equals(this.additionalProperties, payeeProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayeeProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeeProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeeProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeeProperty3 is not found in the empty JSON string", PayeeProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeeProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeeProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeeProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeeProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeeProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeeProperty3>() {
           @Override
           public void write(JsonWriter out, PayeeProperty3 value) throws IOException {
           ...
           @Override
           public PayeeProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeeProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeeProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeeProperty3
  * @throws IOException if the JSON string is invalid with respect to PayeeProperty3
  */
  public static PayeeProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeeProperty3.class);
  }

 /**
  * Convert an instance of PayeeProperty3 to an JSON string
  *
  * @return JSON string
  */
