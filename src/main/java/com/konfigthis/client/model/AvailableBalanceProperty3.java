...
public class AvailableBalanceProperty3 {
  /**
 ...
 public enum CurrencyEnum {
  ...
  public AvailableBalanceProperty3() {
  }

  public AvailableBalanceProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public AvailableBalanceProperty3 value(String value) {
  ...
  **/
   ...
   * @return the AvailableBalanceProperty3 instance itself
   */
  public AvailableBalanceProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailableBalanceProperty3 availableBalanceProperty3 = (AvailableBalanceProperty3) o;
    return Objects.equals(this.currency, availableBalanceProperty3.currency) &&
        Objects.equals(this.value, availableBalanceProperty3.value)&&
        Objects.equals(this.additionalProperties, availableBalanceProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AvailableBalanceProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailableBalanceProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailableBalanceProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailableBalanceProperty3 is not found in the empty JSON string", AvailableBalanceProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailableBalanceProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailableBalanceProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailableBalanceProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailableBalanceProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailableBalanceProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailableBalanceProperty3>() {
           @Override
           public void write(JsonWriter out, AvailableBalanceProperty3 value) throws IOException {
           ...
           @Override
           public AvailableBalanceProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailableBalanceProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailableBalanceProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailableBalanceProperty3
  * @throws IOException if the JSON string is invalid with respect to AvailableBalanceProperty3
  */
  public static AvailableBalanceProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailableBalanceProperty3.class);
  }

 /**
  * Convert an instance of AvailableBalanceProperty3 to an JSON string
  *
  * @return JSON string
  */
