...
public class PaymentsSubmitPaymentSubmissionResponse {
  /**
 ...
 public enum SubmissionStatusEnum {
  ...
  public PaymentsSubmitPaymentSubmissionResponse() {
  }

  public PaymentsSubmitPaymentSubmissionResponse submissionStatus(SubmissionStatusEnum submissionStatus) {
  ...
  **/
  ...
  public PaymentsSubmitPaymentSubmissionResponse submissionSchemeInformation(FpsProperty1 submissionSchemeInformation) {
  ...
  **/
  ...
  public PaymentsSubmitPaymentSubmissionResponse paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public PaymentsSubmitPaymentSubmissionResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PaymentsSubmitPaymentSubmissionResponse submissionUrl(String submissionUrl) {
  ...
  **/
   ...
   * @return the PaymentsSubmitPaymentSubmissionResponse instance itself
   */
  public PaymentsSubmitPaymentSubmissionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsSubmitPaymentSubmissionResponse paymentsSubmitPaymentSubmissionResponse = (PaymentsSubmitPaymentSubmissionResponse) o;
    return Objects.equals(this.submissionStatus, paymentsSubmitPaymentSubmissionResponse.submissionStatus) &&
        Objects.equals(this.submissionSchemeInformation, paymentsSubmitPaymentSubmissionResponse.submissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, paymentsSubmitPaymentSubmissionResponse.paymentUrl) &&
        Objects.equals(this.createdAt, paymentsSubmitPaymentSubmissionResponse.createdAt) &&
        Objects.equals(this.submissionUrl, paymentsSubmitPaymentSubmissionResponse.submissionUrl)&&
        Objects.equals(this.additionalProperties, paymentsSubmitPaymentSubmissionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsSubmitPaymentSubmissionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsSubmitPaymentSubmissionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsSubmitPaymentSubmissionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsSubmitPaymentSubmissionResponse is not found in the empty JSON string", PaymentsSubmitPaymentSubmissionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentsSubmitPaymentSubmissionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsSubmitPaymentSubmissionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsSubmitPaymentSubmissionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsSubmitPaymentSubmissionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsSubmitPaymentSubmissionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsSubmitPaymentSubmissionResponse>() {
           @Override
           public void write(JsonWriter out, PaymentsSubmitPaymentSubmissionResponse value) throws IOException {
           ...
           @Override
           public PaymentsSubmitPaymentSubmissionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentsSubmitPaymentSubmissionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentsSubmitPaymentSubmissionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsSubmitPaymentSubmissionResponse
  * @throws IOException if the JSON string is invalid with respect to PaymentsSubmitPaymentSubmissionResponse
  */
  public static PaymentsSubmitPaymentSubmissionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsSubmitPaymentSubmissionResponse.class);
  }

 /**
  * Convert an instance of PaymentsSubmitPaymentSubmissionResponse to an JSON string
  *
  * @return JSON string
  */
