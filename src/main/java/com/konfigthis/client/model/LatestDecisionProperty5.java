...
public class LatestDecisionProperty5 {
 ...
 public enum DecisionOpsUserEnum {
  ...
  public LatestDecisionProperty5() {
  }

  public LatestDecisionProperty5 verificationUrl(String verificationUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionOutcome(DecisionOutcomeEnum decisionOutcome) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionMaker(DecisionMakerEnum decisionMaker) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionNotes(String decisionNotes) {
  ...
  **/
  ...
  public LatestDecisionProperty5 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionUserUrl(String decisionUserUrl) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionUserUsername(String decisionUserUsername) {
  ...
  **/
  ...
  public LatestDecisionProperty5 decisionOpsUser(DecisionOpsUserEnum decisionOpsUser) {
  ...
  **/
   ...
   * @return the LatestDecisionProperty5 instance itself
   */
  public LatestDecisionProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LatestDecisionProperty5 latestDecisionProperty5 = (LatestDecisionProperty5) o;
    return Objects.equals(this.verificationUrl, latestDecisionProperty5.verificationUrl) &&
        Objects.equals(this.decisionOutcome, latestDecisionProperty5.decisionOutcome) &&
        Objects.equals(this.decisionMaker, latestDecisionProperty5.decisionMaker) &&
        Objects.equals(this.decisionNotes, latestDecisionProperty5.decisionNotes) &&
        Objects.equals(this.createdAt, latestDecisionProperty5.createdAt) &&
        Objects.equals(this.decisionUserUrl, latestDecisionProperty5.decisionUserUrl) &&
        Objects.equals(this.decisionUserUsername, latestDecisionProperty5.decisionUserUsername) &&
        Objects.equals(this.decisionOpsUser, latestDecisionProperty5.decisionOpsUser)&&
        Objects.equals(this.additionalProperties, latestDecisionProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LatestDecisionProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LatestDecisionProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LatestDecisionProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatestDecisionProperty5 is not found in the empty JSON string", LatestDecisionProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LatestDecisionProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatestDecisionProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatestDecisionProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatestDecisionProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatestDecisionProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<LatestDecisionProperty5>() {
           @Override
           public void write(JsonWriter out, LatestDecisionProperty5 value) throws IOException {
           ...
           @Override
           public LatestDecisionProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LatestDecisionProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LatestDecisionProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LatestDecisionProperty5
  * @throws IOException if the JSON string is invalid with respect to LatestDecisionProperty5
  */
  public static LatestDecisionProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatestDecisionProperty5.class);
  }

 /**
  * Convert an instance of LatestDecisionProperty5 to an JSON string
  *
  * @return JSON string
  */
