...
public class DebtorProperty3 {
 ...
 public enum BankIdCodeEnum {
  ...
  public DebtorProperty3() {
  }

  public DebtorProperty3 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public DebtorProperty3 accountNumberCode(AccountNumberCodeEnum accountNumberCode) {
  ...
  **/
  ...
  public DebtorProperty3 bankId(String bankId) {
  ...
  **/
  ...
  public DebtorProperty3 bankIdCode(BankIdCodeEnum bankIdCode) {
  ...
  **/
  ...
  public DebtorProperty3 accountHolder(String accountHolder) {
  ...
  **/
  ...
  public DebtorProperty3 accountUrl(String accountUrl) {
  ...
  **/
   ...
   * @return the DebtorProperty3 instance itself
   */
  public DebtorProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DebtorProperty3 debtorProperty3 = (DebtorProperty3) o;
    return Objects.equals(this.accountNumber, debtorProperty3.accountNumber) &&
        Objects.equals(this.accountNumberCode, debtorProperty3.accountNumberCode) &&
        Objects.equals(this.bankId, debtorProperty3.bankId) &&
        Objects.equals(this.bankIdCode, debtorProperty3.bankIdCode) &&
        Objects.equals(this.accountHolder, debtorProperty3.accountHolder) &&
        Objects.equals(this.accountUrl, debtorProperty3.accountUrl)&&
        Objects.equals(this.additionalProperties, debtorProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DebtorProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DebtorProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DebtorProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DebtorProperty3 is not found in the empty JSON string", DebtorProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DebtorProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DebtorProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DebtorProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DebtorProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebtorProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<DebtorProperty3>() {
           @Override
           public void write(JsonWriter out, DebtorProperty3 value) throws IOException {
           ...
           @Override
           public DebtorProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DebtorProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DebtorProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DebtorProperty3
  * @throws IOException if the JSON string is invalid with respect to DebtorProperty3
  */
  public static DebtorProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DebtorProperty3.class);
  }

 /**
  * Convert an instance of DebtorProperty3 to an JSON string
  *
  * @return JSON string
  */
