...
public class BankAccountsCreateNewAccountRequest {
 ...
 public enum BankProductTypeEnum {
  ...
  public BankAccountsCreateNewAccountRequest() {
  }

  public BankAccountsCreateNewAccountRequest ownerUrl(String ownerUrl) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/v0/legal-persons/lp.IGxlZ2FsLXBlcnNvbi1pZA", value = "Link to the [legal person](http://docs.griffin.com) that represents the [owner](http://docs.griffin.com) of the account.")
  ...
  public BankAccountsCreateNewAccountRequest savingsType(SavingsTypeEnum savingsType) {
  ...
  **/
  ...
  public BankAccountsCreateNewAccountRequest displayName(String displayName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A human readable label for an entity")
  ...
  public BankAccountsCreateNewAccountRequest bankProductType(BankProductTypeEnum bankProductType) {
  ...
  **/
   ...
   * @return the BankAccountsCreateNewAccountRequest instance itself
   */
  public BankAccountsCreateNewAccountRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountsCreateNewAccountRequest bankAccountsCreateNewAccountRequest = (BankAccountsCreateNewAccountRequest) o;
    return Objects.equals(this.ownerUrl, bankAccountsCreateNewAccountRequest.ownerUrl) &&
        Objects.equals(this.savingsType, bankAccountsCreateNewAccountRequest.savingsType) &&
        Objects.equals(this.displayName, bankAccountsCreateNewAccountRequest.displayName) &&
        Objects.equals(this.bankProductType, bankAccountsCreateNewAccountRequest.bankProductType)&&
        Objects.equals(this.additionalProperties, bankAccountsCreateNewAccountRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ownerUrl, savingsType, displayName, bankProductType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BankAccountsCreateNewAccountRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountsCreateNewAccountRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountsCreateNewAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountsCreateNewAccountRequest is not found in the empty JSON string", BankAccountsCreateNewAccountRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountsCreateNewAccountRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if ((jsonObj.get("owner-url") != null && !jsonObj.get("owner-url").isJsonNull()) && !jsonObj.get("owner-url").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("display-name") != null && !jsonObj.get("display-name").isJsonNull()) && !jsonObj.get("display-name").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountsCreateNewAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountsCreateNewAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountsCreateNewAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountsCreateNewAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountsCreateNewAccountRequest>() {
           @Override
           public void write(JsonWriter out, BankAccountsCreateNewAccountRequest value) throws IOException {
           ...
           @Override
           public BankAccountsCreateNewAccountRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountsCreateNewAccountRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountsCreateNewAccountRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountsCreateNewAccountRequest
  * @throws IOException if the JSON string is invalid with respect to BankAccountsCreateNewAccountRequest
  */
  public static BankAccountsCreateNewAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountsCreateNewAccountRequest.class);
  }

 /**
  * Convert an instance of BankAccountsCreateNewAccountRequest to an JSON string
  *
  * @return JSON string
  */
