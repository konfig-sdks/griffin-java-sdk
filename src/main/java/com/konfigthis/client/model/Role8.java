...
public class Role8 {
  ...
  public Role8 description(String description) {
  ...
  **/
  ...
  public Role8 displayName(String displayName) {
  ...
  **/
  ...
  public Role8 roleUrl(String roleUrl) {
  ...
  **/
   ...
   * @return the Role8 instance itself
   */
  public Role8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Role8 role8 = (Role8) o;
    return Objects.equals(this.description, role8.description) &&
        Objects.equals(this.displayName, role8.displayName) &&
        Objects.equals(this.roleUrl, role8.roleUrl)&&
        Objects.equals(this.additionalProperties, role8.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Role8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Role8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Role8 is not found in the empty JSON string", Role8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Role8.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Role8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Role8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Role8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Role8.class));

       return (TypeAdapter<T>) new TypeAdapter<Role8>() {
           @Override
           public void write(JsonWriter out, Role8 value) throws IOException {
           ...
           @Override
           public Role8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Role8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Role8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Role8
  * @throws IOException if the JSON string is invalid with respect to Role8
  */
  public static Role8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Role8.class);
  }

 /**
  * Convert an instance of Role8 to an JSON string
  *
  * @return JSON string
  */
