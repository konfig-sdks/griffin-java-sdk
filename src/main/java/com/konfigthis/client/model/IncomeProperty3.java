...
public class IncomeProperty3 {
 ...
 public enum CurrencyEnum {
  ...
  public IncomeProperty3() {
  }

  public IncomeProperty3 currency(CurrencyEnum currency) {
  ...
  **/
  ...
  public IncomeProperty3 value(String value) {
  ...
  **/
   ...
   * @return the IncomeProperty3 instance itself
   */
  public IncomeProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncomeProperty3 incomeProperty3 = (IncomeProperty3) o;
    return Objects.equals(this.currency, incomeProperty3.currency) &&
        Objects.equals(this.value, incomeProperty3.value)&&
        Objects.equals(this.additionalProperties, incomeProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IncomeProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomeProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomeProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomeProperty3 is not found in the empty JSON string", IncomeProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IncomeProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomeProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomeProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomeProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomeProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomeProperty3>() {
           @Override
           public void write(JsonWriter out, IncomeProperty3 value) throws IOException {
           ...
           @Override
           public IncomeProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomeProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomeProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomeProperty3
  * @throws IOException if the JSON string is invalid with respect to IncomeProperty3
  */
  public static IncomeProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomeProperty3.class);
  }

 /**
  * Convert an instance of IncomeProperty3 to an JSON string
  *
  * @return JSON string
  */
