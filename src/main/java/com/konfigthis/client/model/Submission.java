...
public class Submission {
 ...
 public enum SubmissionStatusEnum {
  ...
  public Submission submissionStatus(SubmissionStatusEnum submissionStatus) {
  ...
  **/
  ...
  public Submission submissionSchemeInformation(FpsProperty1 submissionSchemeInformation) {
  ...
  **/
  ...
  public Submission paymentUrl(String paymentUrl) {
  ...
  **/
  ...
  public Submission submissionUrl(String submissionUrl) {
  ...
  **/
   ...
   * @return the Submission instance itself
   */
  public Submission putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.submissionStatus, submission.submissionStatus) &&
        Objects.equals(this.submissionSchemeInformation, submission.submissionSchemeInformation) &&
        Objects.equals(this.paymentUrl, submission.paymentUrl) &&
        Objects.equals(this.createdAt, submission.createdAt) &&
        Objects.equals(this.submissionUrl, submission.submissionUrl)&&
        Objects.equals(this.additionalProperties, submission.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Submission>() {
           ...
           public Submission read(JsonReader in) throws IOException {
             ...
             Submission instance = thisAdapter.fromJsonTree(jsonObj);
