...
public class PayeesUpdatePayeeRequest {
  /**
   * Gets or Sets payeeStatus
   */
 ...
 public enum PayeeStatusEnum {
  ...
  public PayeesUpdatePayeeRequest() {
  }

  public PayeesUpdatePayeeRequest payeeStatus(PayeeStatusEnum payeeStatus) {
  ...
  **/
   ...
   * @return the PayeesUpdatePayeeRequest instance itself
   */
  public PayeesUpdatePayeeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayeesUpdatePayeeRequest payeesUpdatePayeeRequest = (PayeesUpdatePayeeRequest) o;
    return Objects.equals(this.payeeStatus, payeesUpdatePayeeRequest.payeeStatus)&&
        Objects.equals(this.additionalProperties, payeesUpdatePayeeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(payeeStatus, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PayeesUpdatePayeeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayeesUpdatePayeeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayeesUpdatePayeeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayeesUpdatePayeeRequest is not found in the empty JSON string", PayeesUpdatePayeeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayeesUpdatePayeeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayeesUpdatePayeeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayeesUpdatePayeeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayeesUpdatePayeeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayeesUpdatePayeeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PayeesUpdatePayeeRequest>() {
           @Override
           public void write(JsonWriter out, PayeesUpdatePayeeRequest value) throws IOException {
           ...
           @Override
           public PayeesUpdatePayeeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayeesUpdatePayeeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayeesUpdatePayeeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayeesUpdatePayeeRequest
  * @throws IOException if the JSON string is invalid with respect to PayeesUpdatePayeeRequest
  */
  public static PayeesUpdatePayeeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayeesUpdatePayeeRequest.class);
  }

 /**
  * Convert an instance of PayeesUpdatePayeeRequest to an JSON string
  *
  * @return JSON string
  */
