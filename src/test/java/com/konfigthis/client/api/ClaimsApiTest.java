...
public class ClaimsApiTest {
     ...
     */
    @Test
    public void createNewClaimTest() throws ApiException {
        ...
        BothBuildingNameAndBuildingNumberProperty tradingAddress = null;
        ...
        String entityRegistrationNumber = null;
        IncomeProperty income = null;
        InitialDepositProperty initialDeposit = null;
        List<Object> internationalPaymentsCountries = null;
        String legalPersonUrl = null;
        String ownershipPercent = null;
        String companiesHouseUrl = null;
        Boolean seniorManagerQuestionMark = null;
        Object taxResidency = null;
        List<String> ukRegulatoryPermissions = null;
        String businessDescription = null;
        Set<String> individualSourcesOfFunds = null;
        BothBuildingNameAndBuildingNumberProperty businessAddress = null;
        AnnualTurnoverProperty annualTurnover = null;
        Set<String> purposesOfAccount = null;
        List<String> sicCodes = null;
        List<Object> internationalOperationsCountries = null;
        Set<String> sourcesOfFunds = null;
        Set<String> relianceVerificationMethods = null;
        String relianceVerificationStandard = null;
        String businessName = null;
        Set<String> individualPurposesOfAccount = null;
        Object nationality = null;
        String socialMedia = null;
        String websiteUrl = null;
        String taxIdentificationNumber = null;
        ClaimsCreateNewClaimResponse response = api.createNewClaim(claimType, legalPersonId)
    ...
    public void getAllClaimsTest() throws ApiException {
        ...
        ClaimsGetAllClaimsResponse response = api.getAllClaims(legalPersonId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
