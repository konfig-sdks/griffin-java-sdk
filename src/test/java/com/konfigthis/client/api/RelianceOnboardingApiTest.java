...
/**
 * API tests for RelianceOnboardingApi
 */
@Disabled
public class RelianceOnboardingApiTest {

    private static RelianceOnboardingApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new RelianceOnboardingApi(apiClient);
    }
    ...
    public void createApplicationTest() throws ApiException {
        ...
        SubjectProfileProperty subjectProfile = null;
        String organizationId = null;
        List<RelatedProfile> relatedProfiles = null;
        RelianceOnboardingCreateApplicationResponse response = api.createApplication(workflowUrl, subjectProfile, organizationId)
    ...
    public void getApplicationTest() throws ApiException {
        String onboardingApplicationId = null;
        RelianceOnboardingGetApplicationResponse response = api.getApplication(onboardingApplicationId)
                .execute();
        // TODO: test validations
    }
