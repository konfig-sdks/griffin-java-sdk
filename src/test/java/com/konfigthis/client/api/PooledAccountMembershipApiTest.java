...
/**
 * API tests for PooledAccountMembershipApi
 */
@Disabled
public class PooledAccountMembershipApiTest {

    private static PooledAccountMembershipApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PooledAccountMembershipApi(apiClient);
    }
    ...
    public void listLegalPersonsTest() throws ApiException {
        ...
        PooledAccountMembershipListLegalPersonsResponse response = api.listLegalPersons(bankAccountId)
                .include(include)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
     ...
     */
    @Test
    public void manageLegalPersonsTest() throws ApiException {
        List<String> additions = null;
        List<String> deletions = null;
        String bankAccountId = null;
        PooledAccountMembershipManageLegalPersonsResponse response = api.manageLegalPersons(additions, deletions, bankAccountId)
                .execute();
        // TODO: test validations
    }
