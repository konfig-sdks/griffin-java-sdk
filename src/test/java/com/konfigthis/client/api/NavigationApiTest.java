...
/**
 * API tests for NavigationApi
 */
@Disabled
public class NavigationApiTest {

    private static NavigationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new NavigationApi(apiClient);
    }
     ...
     */
    @Test
    public void globalPathsFetchTest() throws ApiException {
        NavigationGlobalPathsFetchResponse response = api.globalPathsFetch()
                .execute();
