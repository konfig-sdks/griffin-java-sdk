...
public class WorkflowsApiTest {
    ...
    public void getWorkflowTest() throws ApiException {
        ...
        WorkflowsGetWorkflowResponse response = api.getWorkflow(workflowId)
                .execute();
     ...
     */
    @Test
    public void listOrganizationWorkflowsTest() throws ApiException {
        String organizationId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        WorkflowsListOrganizationWorkflowsResponse response = api.listOrganizationWorkflows(organizationId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
