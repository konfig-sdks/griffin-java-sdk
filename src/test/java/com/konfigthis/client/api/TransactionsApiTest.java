...
public class TransactionsApiTest {
    ...
    public void getTransactionByIdTest() throws ApiException {
        ...
        TransactionsGetTransactionByIdResponse response = api.getTransactionById(transactionId)
                .execute();
    ...
    public void listBalanceChangesTest() throws ApiException {
        ...
        byte[] pageAfter = null;
        String include = null;
        OffsetDateTime filterPostDatetimeLte = null;
        OffsetDateTime filterPostDatetimeLt = null;
        OffsetDateTime filterPostDatetimeGte = null;
        OffsetDateTime filterPostDatetimeGt = null;
        TransactionsListBalanceChangesResponse response = api.listBalanceChanges(bankAccountId)
                .sort(sort)
                .pageSize(pageSize)
