...
public class WebhooksApiTest {
     ...
     */
    @Test
    public void activateActionTest() throws ApiException {
        String webhookId = null;
        WebhooksActivateActionResponse response = api.activateAction(webhookId)
                .execute();
    ...
    public void createWebhookTest() throws ApiException {
        String webhookDestinationUrl = null;
        String organizationId = null;
        String webhookDescription = null;
        WebhooksCreateWebhookResponse response = api.createWebhook(webhookDestinationUrl, organizationId)
     ...
     */
    @Test
    public void deactivateActionTest() throws ApiException {
        String webhookId = null;
        WebhooksDeactivateActionResponse response = api.deactivateAction(webhookId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTest() throws ApiException {
        String organizationId = null;
        WebhooksGetAllResponse response = api.getAll(organizationId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getLatestTestStatusTest() throws ApiException {
        String webhookId = null;
        WebhooksGetLatestTestStatusResponse response = api.getLatestTestStatus(webhookId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getWebhookTest() throws ApiException {
        String webhookId = null;
        WebhooksGetWebhookResponse response = api.getWebhook(webhookId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void sendTestEventTest() throws ApiException {
        String webhookId = null;
        WebhooksSendTestEventResponse response = api.sendTestEvent(webhookId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateWebhookTest() throws ApiException {
        String webhookId = null;
        String webhookDescription = null;
        WebhooksUpdateWebhookResponse response = api.updateWebhook(webhookId)
                .webhookDescription(webhookDescription)
                .execute();
        // TODO: test validations
    }
