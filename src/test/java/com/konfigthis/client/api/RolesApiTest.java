...
public class RolesApiTest {
     ...
     */
    @Test
    public void assignMembershipRolesTest() throws ApiException {
        List<String> roleUrls = null;
        String membershipId = null;
        RolesAssignMembershipRolesResponse response = api.assignMembershipRoles(roleUrls, membershipId)
                .execute();
     ...
     */
    @Test
    public void getMembershipRolesTest() throws ApiException {
        String membershipId = null;
        RolesGetMembershipRolesResponse response = api.getMembershipRoles(membershipId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getRoleTest() throws ApiException {
        String roleId = null;
        RolesGetRoleResponse response = api.getRole(roleId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllRolesTest() throws ApiException {
        RolesListAllRolesResponse response = api.listAllRoles()
                .execute();
        // TODO: test validations
    }
