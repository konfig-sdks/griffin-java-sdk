...
/**
 * API tests for DecisionsApi
 */
@Disabled
public class DecisionsApiTest {

    private static DecisionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new DecisionsApi(apiClient);
    }
     ...
     */
    @Test
    public void createDecisionTest() throws ApiException {
        String verificationUrl = null;
        String decisionOutcome = null;
        String decisionNotes = null;
        String legalPersonId = null;
        DecisionsCreateDecisionResponse response = api.createDecision(verificationUrl, decisionOutcome, decisionNotes, legalPersonId)
                .execute();
    ...
    public void listForLegalPersonTest() throws ApiException {
        ...
        DecisionsListForLegalPersonResponse response = api.listForLegalPerson(legalPersonId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
