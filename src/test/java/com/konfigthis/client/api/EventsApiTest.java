...
public class EventsApiTest {
     ...
     */
    @Test
    public void getAllOrganizationEventsTest() throws ApiException {
        String organizationId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageBefore = null;
        byte[] pageAfter = null;
        String filterEventTypeEq = null;
        ...
        EventsGetAllOrganizationEventsResponse response = api.getAllOrganizationEvents(organizationId)
                .sort(sort)
                .pageSize(pageSize)
    ...
    public void getEventTest() throws ApiException {
        String eventId = null;
        EventsGetEventResponse response = api.getEvent(eventId)
                .execute();
        // TODO: test validations
    }
