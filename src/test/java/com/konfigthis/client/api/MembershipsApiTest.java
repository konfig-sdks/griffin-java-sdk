...
public class MembershipsApiTest {
     ...
     */
    @Test
    public void getMembershipInfoTest() throws ApiException {
        String membershipId = null;
        MembershipsGetMembershipInfoResponse response = api.getMembershipInfo(membershipId)
                .execute();
     ...
     */
    @Test
    public void listOrganizationMembershipsTest() throws ApiException {
        String organizationId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        MembershipsListOrganizationMembershipsResponse response = api.listOrganizationMemberships(organizationId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
     ...
     */
    @Test
    public void listUserMembershipsTest() throws ApiException {
        String userId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        MembershipsListUserMembershipsResponse response = api.listUserMemberships(userId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
                .pageBefore(pageBefore)
