...
/**
 * API tests for LegalPersonHistoryApi
 */
@Disabled
public class LegalPersonHistoryApiTest {

    private static LegalPersonHistoryApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LegalPersonHistoryApi(apiClient);
    }
    ...
    public void listEventsTest() throws ApiException {
        ...
        LegalPersonHistoryListEventsResponse response = api.listEvents(legalPersonId)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
