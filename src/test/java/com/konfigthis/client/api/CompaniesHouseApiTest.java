...
/**
 * API tests for CompaniesHouseApi
 */
@Disabled
public class CompaniesHouseApiTest {

    private static CompaniesHouseApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CompaniesHouseApi(apiClient);
    }
    ...
    public void getCompanyDetailsTest() throws ApiException {
        ...
        CompaniesHouseGetCompanyDetailsResponse response = api.getCompanyDetails(companyNumber)
                .execute();
