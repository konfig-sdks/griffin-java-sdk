...
public class PayeesApiTest {
    ...
    public void getDetailsTest() throws ApiException {
        String payeeId = null;
        PayeesGetDetailsResponse response = api.getDetails(payeeId)
                .execute();
     ...
     */
    @Test
    public void listLegalPersonPayeesTest() throws ApiException {
        String legalPersonId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        PayeesListLegalPersonPayeesResponse response = api.listLegalPersonPayees(legalPersonId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
     ...
     */
    @Test
    public void registerNewPayeeTest() throws ApiException {
        String accountHolder = null;
        String accountNumber = null;
        String bankId = null;
        String legalPersonId = null;
        PayeesRegisterNewPayeeResponse response = api.registerNewPayee(accountHolder, accountNumber, bankId, legalPersonId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updatePayeeTest() throws ApiException {
        ...
        String payeeId = null;
        PayeesUpdatePayeeResponse response = api.updatePayee(payeeStatus, payeeId)
                .execute();
        // TODO: test validations
    }
