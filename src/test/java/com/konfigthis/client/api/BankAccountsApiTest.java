...
public class BankAccountsApiTest {
    ...
    public void closeAccountTest() throws ApiException {
        ...
        BankAccountsCloseAccountResponse response = api.closeAccount(bankAccountId)
                .execute();
    ...
    public void createNewAccountTest() throws ApiException {
        String bankProductType = null;
        String organizationId = null;
        String ownerUrl = null;
        String savingsType = null;
        String displayName = null;
        BankAccountsCreateNewAccountResponse response = api.createNewAccount(bankProductType, organizationId)
                .ownerUrl(ownerUrl)
    ...
    public void getAccountTest() throws ApiException {
        String bankAccountId = null;
        BankAccountsGetAccountResponse response = api.getAccount(bankAccountId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        String organizationId = null;
        String filterBeneficiaryEq = null;
        String filterOwnerEq = null;
        Long pageSize = null;
        List<String> include = null;
        List<String> filterAccountStatusIn = null;
        String sort = null;
        byte[] pageAfter = null;
        Boolean filterAccountRestrictedIn = null;
        Boolean filterPooledFundsEq = null;
        List<String> filterBankProductTypeIn = null;
        byte[] pageBefore = null;
        BankAccountsListResponse response = api.list(organizationId)
    ...
    public void updateBankAccountTest() throws ApiException {
        String displayName = null;
        String bankAccountId = null;
        BankAccountsUpdateBankAccountResponse response = api.updateBankAccount(displayName, bankAccountId)
                .execute();
        // TODO: test validations
    }
