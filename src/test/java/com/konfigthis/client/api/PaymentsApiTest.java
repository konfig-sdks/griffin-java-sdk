...
public class PaymentsApiTest {
    ...
    public void createRequestTest() throws ApiException {
        PayeeProperty creditor = null;
        PaymentAmountProperty paymentAmount = null;
        String bankAccountId = null;
        String paymentReference = null;
        PaymentsCreateRequestResponse response = api.createRequest(creditor, paymentAmount, bankAccountId)
     ...
     */
    @Test
    public void getAdmissionTest() throws ApiException {
        String admissionId = null;
        PaymentsGetAdmissionResponse response = api.getAdmission(admissionId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getBankAccountPaymentsTest() throws ApiException {
        String bankAccountId = null;
        String sort = null;
        Long pageSize = null;
        ...
        PaymentsGetBankAccountPaymentsResponse response = api.getBankAccountPayments(bankAccountId)
                .sort(sort)
                .pageSize(pageSize)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        PaymentsGetDetailsResponse response = api.getDetails(paymentId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getSubmissionTest() throws ApiException {
        ...
        PaymentsGetSubmissionResponse response = api.getSubmission(submissionId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listAdmissionsTest() throws ApiException {
        String paymentId = null;
        PaymentsListAdmissionsResponse response = api.listAdmissions(paymentId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listBankAccountAdmissionsTest() throws ApiException {
        String bankAccountId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageBefore = null;
        ...
        OffsetDateTime filterCreatedAtGte = null;
        OffsetDateTime filterCreatedAtGt = null;
        List<String> filterAdmissionStatusIn = null;
        PaymentsListBankAccountAdmissionsResponse response = api.listBankAccountAdmissions(bankAccountId)
                .sort(sort)
                .pageSize(pageSize)
                .pageBefore(pageBefore)
                .pageAfter(pageAfter)
    ...
    public void listSubmissionsTest() throws ApiException {
        ...
        byte[] pageBefore = null;
        byte[] pageAfter = null;
        List<String> filterSubmissionStatusIn = null;
        OffsetDateTime filterCreatedAtLte = null;
        OffsetDateTime filterCreatedAtLt = null;
        OffsetDateTime filterCreatedAtGte = null;
        OffsetDateTime filterCreatedAtGt = null;
        PaymentsListSubmissionsResponse response = api.listSubmissions(bankAccountId)
                .sort(sort)
                .pageSize(pageSize)
                .pageBefore(pageBefore)
                .pageAfter(pageAfter)
     ...
     */
    @Test
    public void listSubmissions_0Test() throws ApiException {
        String paymentId = null;
        PaymentsListSubmissions200Response response = api.listSubmissions_0(paymentId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void submitPaymentSubmissionTest() throws ApiException {
        String paymentId = null;
        String paymentScheme = null;
        PaymentsSubmitPaymentSubmissionResponse response = api.submitPaymentSubmission(paymentId)
