...
public class ApiKeysApiTest {
    ...
    public void createKeyTest() throws ApiException {
        Object apiKeyName = null;
        String organizationId = null;
        ApiKeysCreateKeyResponse response = api.createKey(apiKeyName, organizationId)
                .execute();
    ...
    public void getKeyDetailsTest() throws ApiException {
        ...
        ApiKeysGetKeyDetailsResponse response = api.getKeyDetails(apiKeyId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listActiveKeysTest() throws ApiException {
        String organizationId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        ApiKeysListActiveKeysResponse response = api.listActiveKeys(organizationId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
     ...
     */
    @Test
    public void listActiveKeys_0Test() throws ApiException {
        String userId = null;
        String sort = null;
        Long pageSize = null;
        byte[] pageAfter = null;
        byte[] pageBefore = null;
        ApiKeysListActiveKeys200Response response = api.listActiveKeys_0(userId)
                .sort(sort)
                .pageSize(pageSize)
                .pageAfter(pageAfter)
                .pageBefore(pageBefore)
     ...
     */
    @Test
    public void removeApiKeyTest() throws ApiException {
        String apiKeyId = null;
        api.removeApiKey(apiKeyId)
                .execute();
        // TODO: test validations
    }
